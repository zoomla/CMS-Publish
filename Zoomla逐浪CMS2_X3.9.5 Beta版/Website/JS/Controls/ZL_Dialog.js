...
ZL_Dialog.prototype = {
    ShowModal: function (_url,_title) {
        ...
        var bodyTlp = "<div class='modal' id=" + ref.id + " @backdrop><div class='modal-dialog @width'><div class='modal-content'><div class='modal-header'><span class='modal-title'>@Title</span> @header </div><div style='height:auto;overflow-y:auto;' class='modal-body'>@body</div>@Foot</div></div></div>";
        var header =  "<button type='button' class='close' data-dismiss='modal'>@close</button>@Opion";
