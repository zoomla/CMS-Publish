...
<asp:Content runat="server" ContentPlaceHolderID="Content">
      <div class="input-group" style="width: 510px;float:left;">
    ...
    <div class="input-group" style="width: 380px;float:left;margin-left:10px;">
        ...
        <span class="input-group-btn">
            <input type="button" value="精确定位" onclick="doSearchByPos();" class="btn btn-primary">
        </span>
    </div>
    <div id="allmap"></div>
