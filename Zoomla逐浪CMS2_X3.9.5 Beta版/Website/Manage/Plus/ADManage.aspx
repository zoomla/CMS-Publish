...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <ZL:ExGridView ID="Egv" runat="server" AutoGenerateColumns="False" DataKeyNames="ADID" PageSize="20" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="ADID" HeaderText="序号" ItemStyle-CssClass="td_s"/>
            ...
            <asp:TemplateField HeaderText="点击数" ItemStyle-CssClass="td_s">
                <ItemTemplate><%#(bool)(Eval("countclick"))?Eval("clicks"):"不统计"%> </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="浏览数" ItemStyle-CssClass="td_s">
                <ItemTemplate><%#(bool)(Eval("countview"))?Eval("views"):"不统计"%> </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="剩余天数" ItemStyle-CssClass="td_m">
                <ItemTemplate><%#( (DateTime)(Eval("OverdueDate")) - DateTime.Now).Days%> </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="已审核" ItemStyle-CssClass="td_s">
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="td_l">
                <ItemTemplate>
                    ...
                    <asp:LinkButton runat="server" CommandName="Del" OnClientClick="return confirm('确定要删除此广告?');" CommandArgument='<%# Eval("ADID") %>' CssClass="option_style"><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton> 
                    <asp:LinkButton runat="server" CommandName="Copy" CommandArgument='<%# Eval("ADID") %>' CssClass="option_style"><i class="fa fa-copy" title="复制"></i>复制</asp:LinkButton>
