...
function EmptyZoneAD(_id) {
  ...
  /* Define Functions */
  this.AddAD       = EmptyZoneAD_AddAD;
  this.GetShowAD   = EmptyZoneAD_GetShowAD;
  this.Show        = EmptyZoneAD_Show;
  this.LoopShow    = EmptyZoneAD_LoopShow;

}

function EmptyZoneAD_AddAD(_AD) {
  var date = new Date();
...
function EmptyZoneAD_GetShowAD() {
  if (this.ShowType > 1) {
...
function EmptyZoneAD_Show() {
  ...
  //this.DivName = "EmptyZoneAD_Div" + this.ZoneID;
...
function AD_Content(o) {
  ...
  imgurl = o.ImgUrl .toLowerCase()
    ...
    if (imgurl.indexOf(".swf") !=  - 1) {
      ...
      str += "<img alt='"+o.ADName+"'";
      str += " name='AD_" + o.ADID + "' id='AD_" + o.ADID + "'";
      if (o.style) str += " style='" + o.style + "'";
      if (o.extfunc) str += " " + o.extfunc + " ";
      str += " src='" + imgurl + "'";
      if (o.ImgWidth) str += " max-width='" + o.ImgWidth + "'";
