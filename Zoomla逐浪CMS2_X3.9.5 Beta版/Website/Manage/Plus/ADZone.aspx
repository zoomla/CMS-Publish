...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-bordered table-striped">
        <tr>
            ...
            <td>
                <ZL:TextBox ID="TxtZoneName" AllowEmpty="false" class="form-control text_300" runat="server" MaxLength="100"/>
                <span class="rd_red">*</span>
            </td>
        </tr>
        <tr>
            <td><strong>生成JS文件名：</strong></td>
            <td>
                <ZL:TextBox ID="TxtZoneJSName" AllowEmpty="false" class="form-control text_300" runat="server" EnableViewState="False" MaxLength="100"/><span class="rd_red">*</span>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtZoneIntro" class="form-control text_300" runat="server" EnableViewState="False" Height="63px" MaxLength="255" TextMode="multiline" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <div class="input-group" style="width:650px;">
                    ...
                    <asp:TextBox ID="TxtZoneWidth"  runat="server" CssClass="form-control text_s" MaxLength="4" Text="468"/>
                    <span class="input-group-addon">高度</span>
                    <asp:TextBox ID="TxtZoneHeight" runat="server" CssClass="form-control text_s" MaxLength="4" Text="60"/>
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="ADZoneManage.aspx" class="btn btn-default">返回列表</a>
            </td>
        </tr>
    </table>
</asp:Content>
