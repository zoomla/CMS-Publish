    ...
    <div>
        ...
        <%--    <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="remindT" CssClass="form-control m715-50" TextMode="MultiLine" Height="60px" />
                </td>
            </tr>
            <tr style="background-color:#31b0d5;color:#fff;"><td colspan="2" class="text-center"><strong>起草管理</strong></td></tr>
            <tr>
                <td>使用角色：</td>
                <td>
     ...
     <%--       <tr><td>主办人别名</td>
                <td><asp:TextBox runat="server" ID="ReferUser_Alias" class="form-control text_300" /></td>
            </tr>
            <tr><td>协办人别名</td>
                <td><asp:TextBox runat="server" ID="CCUser_Alias" class="form-control text_300" />
                    <asp:CheckBox runat="server" ID="CCUser_Allow_Chk" Checked="true" Text="允许协办" /></td>
            </tr>
            <tr>
                <td>辅办人别名</td>
                <td>
                    <asp:TextBox runat="server" ID="HelpUser_Alias" class="form-control text_300" />
