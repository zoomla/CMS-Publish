            ...
            <div class="modal-content">
                ...
                <div class="text-center" style="padding: 10px;">
                    ...
                    <div style="margin: 5px;">
                        ...
                        <button type="button" onclick="CloseAddMenu()" class="btn btn-default ">取消</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="text-center" style="padding: 10px;">
                    ...
                    <div style="margin: 5px;">
                        ...
                        <button type="button" onclick="$('#SetLink').modal('hide');" class="btn btn-default margin_t5">取消</button>
                    </div>
                </div>
            </div>
        </div>
