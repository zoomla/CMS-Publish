...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div id="MainApp" class="wxapp_box">
        ...
        <div class="wxapp">
            <a href="LuckDraw/Default.aspx"><i class="fa fa-history center-block" style="background: #ff006e;"></i>刮刮卡</a>
        </div>
        <div class="wxapp">
            <a href="LuckDraw/Default.aspx"><i class="fa fa-futbol-o center-block" style="background: #ff006e;"></i>大转盘</a>
        </div>
        <div class="wxapp">
