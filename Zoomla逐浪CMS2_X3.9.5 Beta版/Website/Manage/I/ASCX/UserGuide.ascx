...
<button class="input-group-text" type="button" onclick="ASCX.Search('<%:CustomerPageAction.customPath2+"User/UserManage.aspx?keyWord=" %>','keyWord');"><span class="fa fa-search"></span></button>
