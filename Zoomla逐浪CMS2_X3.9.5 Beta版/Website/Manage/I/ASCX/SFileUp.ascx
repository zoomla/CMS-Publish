...
<div class="sfile_updiv" >
    <div class="input-group">
        <asp:TextBox runat="server" ID="FVPath_T" CssClass="form-control max20rem sfile_t" />
        <div class="input-group-append">
		   <a href="javascript:;" class="btn btn-info sfile_selbtn rounded-right"><i class="fa fa-picture-o" aria-hidden="true"></i></a>
           <a href="javascript:;" class="btn btn-secondary sfile_clsbtn" style="display:none;"><i class="fa fa-trash-o"></i> 清除</a>
        </div>
    </div>
