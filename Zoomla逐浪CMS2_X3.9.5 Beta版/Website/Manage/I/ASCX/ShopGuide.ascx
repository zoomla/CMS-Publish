...
<div class="tvNavDiv">
    <div class="input-group">
        ...
        <div class="input-group-append">
            <button class="input-group-text" type="button" onclick="ASCX.Search('<%:CustomerPageAction.customPath2+"Shop/ProductManage.aspx?keyWord=" %>','keyWord');"><span class="fa fa-search"></span></button>
        </div>
    </div>
    <div class="left_ul">
        <ul>
