...
<nav class="navbar-expand-md navbar-dark mb_nav旧 sysMenu ">
<button class="navbar-toggler collapsed d-block d-sm-none" type="button" data-toggle="collapse" data-target="#navbarsExampleDefault" aria-controls="navbarsExampleDefault" aria-expanded="false" aria-label="Toggle navigation">
<span class="navbar-toggler-icon"></span>
</button>
	<div class="navbar-collapse collaps" id="navbarsExampleDefault">
...
<div class="float-left" id="sysSearch">
<div class="input-group input-group-sm"><asp:TextBox runat="server" ID="keyText" class="form-control" placeholder="快速检索" onkeydown="return IsEnter(this);" style="color:#fff;"/><i class="fa fa-search"></i> </div>
</div>
...
<a href="javascript:;" onClick="ShowManageLeft();"><i class="fa z01-icon106"></i> </a>
</div>
</div>
<!--主菜单end-->


<div class="m_top_bottom">
	<ul class="menu1 open">
		<li class="menu1_1 "><a onclick="showleft('menu1_1','{$path}Profile/Worktable.aspx')"><%=Resources.L.版本信息 %></a></li>
	...
	<ul class="menu2">
		<li class="menu2_1 "><a onclick="ShowMain('NodeTree.ascx','Content/ContentManage.aspx');"><%=Resources.L.按栏目管理 %></a></li>
	...
	<ul class="menu3">
		<li class="menu3_1"><a onclick="ShowMain('ShopNodeTree.ascx','Shop/ProductManage.aspx');"><%=Resources.L.商品管理 %></a></li>
	...
	<ul class="menu6">
		<li class="menu6_1"><a onclick="ShowMain('UserGuide.ascx','User/UserManage.aspx');"><%=Resources.L.会员管理 %></a></li>
	...
	<li id="menu3_8_8"><a href="javascript:;" data-url="Boss/PromoBonus.aspx">推广佣金</a></li>--%>
		...
		<ul>
			...
			<div id="menu6" class="m_left_ul">
				<ul class="m_left_ulin" id="menu6_1">111</ul>
	...
	<li id="menu9_2_4"><a href="javascript:;" data-url="AddOn/StructAnalysis.aspx"><%=Resources.L.分析结构%></a></li>--%>
			...
			<div id="menu10" class="m_left_ul">
				...
				<ul class="m_left_ulin" id="menu10_3">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i>智能硬件</li>
					<li>
