...
<asp:Content  ContentPlaceHolderID="Content" Runat="Server">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td style="width: 100px;" class="text-right"><strong>ID</strong></td>
            <td>
                <asp:Label ID="ID_L" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="text-right"><strong>发贴人</strong></td>
            <td>
                <asp:Literal ID="CUser_LB" runat="server"></asp:Literal>
            </td>
        </tr>
        <tr>
            <td class="text-right"><strong>贴子标题</strong></td>
            <td>
        ...
        <tr>
            <td class="text-right" style="vertical-align:middle;"><strong>贴子内容</strong></td>
            <td>
        ...
        <tr>
            <td class="text-right"><strong>IP地址</strong></td>
            <td>
        ...
        <tr>
            <td class="text-right"><strong>所得勋章</strong></td>
            <td>
                <asp:Literal ID="Medals_Li" runat="server" EnableViewState="false"></asp:Literal>
            </td>
        </tr>
        <tr>
            <td class="text-right" style="vertical-align:middle;"><strong>操作</strong></td>
            <td>
                <input type="button" id="edit_btn" onclick="EditFunc('edit');" data-show="onlyread" value="修改信息" class="btn btn-info" />
                <asp:Button ID="Save_Btn" Style="display:none" CssClass="btn btn-info" data-show="edit" OnClientClick="SaveTxtStyle()" runat="server" OnClick="Save_Btn_Click" Text="保存信息" />
                ...
                <asp:Button ID="AddMedal_Btn" runat="server" CssClass="btn btn-info" Text="颁发勋章" OnClick="AddMedal_Btn_Click" />
            </td>
        </tr>
    </table>
    ...
    <table class="table table-bordered" id="sleall">
        <tr>
            <td class="text-center">
                ...
                <asp:Button ID="Button1" runat="server" Text="返回" CssClass="btn btn-info" OnClick="Button1_Click" />
