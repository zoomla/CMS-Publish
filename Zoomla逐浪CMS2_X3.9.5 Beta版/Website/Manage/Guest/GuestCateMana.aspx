...
<asp:Content  ContentPlaceHolderID="Content" Runat="Server">
	...
	<tr>
		<td style="height: 21px">
            <asp:Button ID="Dels_Btn" runat="server" CssClass="btn btn-info" Text="批量删除" OnClientClick="return confirm('是否确认删除选中栏目?')" OnClick="Dels_Btn_Click" />                 
            <asp:Button ID="BtnSetRecomPosation" runat="server" CssClass="btn btn-info" Text="批量推荐" OnClick="BtnSetRecomPosation_Click" />
            <asp:Button ID="BtnSetChanlnePosation" runat="server" CssClass="btn btn-info" Text="取消推荐" OnClick="BtnSetChanlnePosation_Click" />
		</td>
	</tr>                
</table>
