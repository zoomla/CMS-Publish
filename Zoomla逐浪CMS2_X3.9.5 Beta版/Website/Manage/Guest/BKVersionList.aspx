...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="panel panel-default" style="padding: 0px;">
        ...
        <div class="panel panel-footer" style="padding: 3px; margin: 0px;">
            <asp:Button runat="server" ID="BatAudit_Btn" CssClass="btn btn-info" Text="审核并应用" OnClick="BatAudit_Btn_Click" OnClientClick="return confirm('审核后,将会使用该版本词条');" />
            <asp:Button runat="server" ID="BatUnAudit_Btn" CssClass="btn btn-info" Text="取消审核" OnClick="BatUnAudit_Btn_Click" />
