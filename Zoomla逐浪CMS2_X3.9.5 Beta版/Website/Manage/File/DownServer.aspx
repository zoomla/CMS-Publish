...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr >
            ...
            <td>
                <asp:DropDownList ID="Encrypttype" CssClass="form-control text_300" runat="server">
        ...
        <tr  id="Encrypt" runat="server" visible="false" >
            ...
            <td>
                <asp:TextBox ID="EncryptKey" class="form-control text_300" runat="server" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="button" class="btn btn-default" onclick="javascript: window.location.href = 'DownServerManage.aspx'" value="返回列表 " />
            </td>
        </tr>
    </table>
</asp:Content>
