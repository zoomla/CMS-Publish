...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li id="tab-100" class="active"><a href="<%=ParamUrl %>" role="tab">所有记录</a></li>
        <li id="tab3"><a href="<%=ParamUrl+"status=3" %>" role="tab">成功记录</a></li>
        <li id="tab1"><a href="<%=ParamUrl+"status=1" %>" role="tab">未完成</a></li>
