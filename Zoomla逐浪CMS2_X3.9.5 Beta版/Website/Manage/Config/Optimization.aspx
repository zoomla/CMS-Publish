...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div id="maindiv" runat="server" visible="false">
        <table class="table table-striped table-bordered">
            <tr>
                <td class="td_m"><strong>请选择表：</strong></td>
                <td>
                    <asp:DropDownList ID="DbTableDownList" runat="server" AutoPostBack="True" CssClass="form-control text_300" OnSelectedIndexChanged="DbTableDownList_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td><strong>是否创建唯一索引</strong></td>
                <td>
                    <input runat="server" type="checkbox" id="IsUnique" class="switchChk" />
                </td>
            </tr>
            <tr>
                <td><strong>创建索引的类型</strong></td>
                <td>
                    <asp:DropDownList runat="server" CssClass="form-control text_300" ID="IndexType">
            ...
            <tr>
                <td><strong>请输入索引名称：</strong></td>
                <td>
                    <input type="text" id="IndexName" class="form-control text_300" runat="server" value="Zoomla_index" /></td>
            </tr>
            <tr>
                <td><strong>创建索引的字段：</strong></td>
                <td>
