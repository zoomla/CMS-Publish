   ...
   <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="20" EnableTheming="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="td_l">
                    <ItemTemplate>
                        <a href="EditDataList.aspx?ID=<%#Eval("ID") %>" class="option_style"><i class="fa fa-pencil" title="修改"></i></a>
                        <a href="DBTools/Default.aspx" class="option_style"><i class="fa fa-table" title="表结构"></i>表结构</a>
                        <a href="DataListView.aspx?ID=<%#Eval("ID") %>" class="option_style"><i class="fa fa-reorder" title="表数据"></i>表数据</a>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </ZL:ExGridView>
