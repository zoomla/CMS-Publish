            ...
            <ZL:ExGridView ID="Egv" runat="server" AutoGenerateColumns="False" DataKeyNames="GeneralID" PageSize="20" OnRowCommand="EGV_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <HeaderStyle Width="7%" />
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1" CommandName="ReStore" CommandArgument='<%# Eval("GeneralID") %>' runat="server" CssClass="option_style"><i class="fa fa-recycle" title="还原"></i></asp:LinkButton>
                            <asp:LinkButton ID="LinkButton2" CommandName="Del1" CommandArgument='<%# Eval("GeneralID") %>' OnClientClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');" runat="server" CssClass="option_style"><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
