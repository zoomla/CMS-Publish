            ...
            <table class="table table-striped table-bordered table-hover">
                <tbody>
                    ...
                    <tr >
                        ...
                        <td>
                            <asp:TextBox ID="TxtNodeName" class="form-control text_300" runat="server" />
                    ...
                    <tr >
                        ...
                        <td>
                            <asp:TextBox ID="TxtNodeDir"  CssClass="form-control text_300" MaxLength="20" runat="server" Columns="20"></asp:TextBox>
