...
<asp:Button ID="Button3" class="btn btn-outline-info" runat="server" OnClientClick="return chkDel();" Text="<%$Resources:L,批量删除 %>" OnClick="Button3_Click"/>
</div>
</asp:Content>
