...
<table class="table table-bordered table-striped">
    ...
    <tr><td id="conTr">任务内容</td><td>
        ...
        <br />
        <span class="info sqlinfo hidden" style="color:#0094ff;">*可执行sql脚本(脚本路径须为以'/'开头的虚拟路径)，脚本不能以GO开头,内中脚本必须以GO切割</span>
        <span class="info pageinfo hidden" style="color:#0094ff;">请填入方法名称,目标方法必须在ZoomLa.Sns.TaskCode中</span>
        </td></tr>
