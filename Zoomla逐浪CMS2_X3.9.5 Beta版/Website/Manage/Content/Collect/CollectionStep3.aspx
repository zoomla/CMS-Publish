...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-bordered table-striped" style="margin-bottom:30px;">
        <tr><td colspan="4" class="text-center"><strong>系统字段</strong></td></tr>
        <tr><td class="td_l">字段别名</td><td class="td_m">字段名称</td><td class="td_m">字段类型</td><td>赋值规则</td></tr>
    ...
    <table class="table table-bordered table-striped">
        <tr><td colspan="4" class="text-center"><strong>扩展字段</strong></td></tr>
        <tr><td class="td_l">字段别名</td><td class="td_m">字段名称</td><td class="td_m">字段类型</td><td>赋值规则</td></tr>
    ...
    <div class="text-center Conent_fix">
        <div class="btn-group cmds pull-left margin_l5">
            <span class="btn btn-info"><i class="fa fa-comment"></i> 指令</span>
            <button type="button" class="btn btn-default cmd">{当前管理员名}</button>
            <button type="button" class="btn btn-default cmd">{当前日期}</button>
        </div>
