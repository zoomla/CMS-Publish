  ...
  <div class="Creat_tips">
    <div class="alert alert-danger fade in margin_b2px">
      ...
      <p style="padding-left: 50px; line-height: 40px;"> <strong> <span class='fa fa-warning' style='color: #f00; font-size: 18px;'></span>
        ...
        <p><%=Resources.L.对应栏目页需在 %><a style="color:#428bca;" href="<%=CustomerPageAction.customPath2%>Config/SiteInfo.aspx">[<%=Resources.L.系统设置 %>]</a>-<a style="color: #428bca;" href="<%=CustomerPageAction.customPath2%>Content/Node/NodeManage.aspx">[<%=Resources.L.节点管理 %>]</a><%=Resources.L.对相应节点生成选项进行设置 %>，<%=Resources.L.aspx为不生成静态页 %><br />
