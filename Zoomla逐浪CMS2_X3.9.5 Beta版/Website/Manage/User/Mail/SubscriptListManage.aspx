...
<asp:Button runat="server" ID="BatRe_Btn" class="btn btn-info" Text="恢复正常" OnClick="BatOperation_Btn_Click" CommandName="normal"/>
<asp:Button runat="server" ID="BatBack_Btn" class="btn btn-info" Text="批量退订" OnClick="BatOperation_Btn_Click" CommandName="back"/>
<asp:Button runat="server" ID="BatStop_Btn" class="btn btn-info" Text="批量停用" OnClick="BatOperation_Btn_Click" CommandName="stop" />
