...
<div class="margin_t10">
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td class="tdRight">
                <asp:Label ID="LblIncept" runat="server"></asp:Label></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <a runat="server" id="reply_a" class="btn btn-primary">回复信息</a>
                <a href="Message.aspx" class="btn btn-default">返回列表</a>
            </td>
        </tr>
    </table>
</div>
