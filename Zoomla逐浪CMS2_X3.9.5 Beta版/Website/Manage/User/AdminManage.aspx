...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <ul class="nav nav-tabs">
        <li data-tag="-100"><a href="AdminManage.aspx">全部</a></li>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    ...
                    <asp:LinkButton runat="server" CommandName="del2" OnClientClick="return confirm('确实删除此管理员?');" CommandArgument='<%# Eval("AdminId")%>' CssClass="option_style"><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton>
