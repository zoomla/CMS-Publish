            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <a href="UserExp.aspx?UserID=<%=uinfo.UserID %>&type=4" class="btn btn-default" title="管理点券">点券：<%=uinfo.UserPoint %></a>
                ...
                <tr>
                    <td class="text-right">会员等级</td>
                    <td colspan="3">
                        <asp:Repeater runat="server" ID="Level_RPT">
                            <ItemTemplate>
                                <label class="btn btn-default" style="margin-right:3px;">
