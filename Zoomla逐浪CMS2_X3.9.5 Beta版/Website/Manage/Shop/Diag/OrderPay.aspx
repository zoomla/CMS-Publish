...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-bordered table-hover">
        ...
        <tr><td>优惠金额:</td><td><ZL:TextBox runat="server" ID="ArriveMoney_T"  class="form-control text_x" AllowEmpty="false" Text="0" ValidType="FloatZeroPostive"/></td></tr>
        <tr>
            <td>支付金额:</td>
            <td><ZL:TextBox runat="server" class="form-control text_x" ID="Money_T" AllowEmpty="false" Text="0" ValidType="FloatZeroPostive" /></td>
        </tr>
        <tr>
            <td>同步扣除</td>
            <td>
