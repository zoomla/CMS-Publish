...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td>字段别名：</td>
            <td>
                <asp:TextBox class="form-control text_300" ID="Alias" runat="server" MaxLength="20"></asp:TextBox>
        ...
        <tr>
            <td>字段名称：</td>
            <td>
                <asp:TextBox CssClass="form-control text_300" ID="Name" MaxLength="50" runat="server"></asp:TextBox><font color="#ff0066">*</font><span class="tips">字段名由字母、数字、下划线组成，不接受空格</span>
            </td>
        </tr>
        ...
        <tr>
            <td>字段提示：</td>
            <td>
                <asp:TextBox class="form-control text_300" ID="Tips" MaxLength="50" runat="server"></asp:TextBox><span class="tips">显示在字段别名下方作为重要提示的文字</span>
            </td>
        </tr>
        <tr>
            <td>字段描述：</td>
            <td>
                <asp:TextBox class="form-control text_300" ID="Description" runat="server" Columns="40" Rows="6" TextMode="MultiLine"></asp:TextBox></td>
        </tr>
        ...
        <tbody id="DivTextType" runat="server">
            <tr>
                <td>文本框长度：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox></td>
            </tr>
            <tr>
                <td>是否为密码：</td>
                <td>
            ...
            <tr>
                <td>默认值：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="TextType_DefaultValue" runat="server" Columns="10"></asp:TextBox></td>
            </tr>
        </tbody>
        <!--  多行文本(不支持Html)    -->
        <tbody id="DivMultipleTextType" style="display: none" runat="server">
            <tr>
                <td>显示的宽度：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="MultipleTextType_Width" runat="server" Columns="10" MaxLength="4">500</asp:TextBox>px</td>
            </tr>
            <tr>
                <td>显示的高度：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="MultipleTextType_Height" runat="server" Columns="10" MaxLength="4">200</asp:TextBox>px</td>
            </tr>
        </tbody>
        <!--  多行文本(支持Html)    -->
        <tbody id="DivMultipleHtmlType" style="display: none" runat="server">
            ...
            <tr>
                <td>显示的宽度：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="MultipleHtmlType_Width" runat="server" Columns="10" MaxLength="4">715</asp:TextBox>px</td>
            </tr>
            <tr>
                <td>显示的高度：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="MultipleHtmlType_Height" runat="server" Columns="10" MaxLength="4">400</asp:TextBox>px</td>
            </tr>
        </tbody>
        <!--  单选项    -->
        <tbody id="DivOptionType" style="display: none" runat="server">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox class="form-control text_300"  ID="RadioType_Content" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox>
                    <span style="color: red">*</span></td>
            </tr>
            <tr>
                <td>默认值：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="RadioType_Default" runat="server"></asp:TextBox>
        ...
        <tbody id="DivListBoxType" style="display: none" runat="server">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox class="form-control text_300"  ID="ListBoxType_Content" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox>
                    <span style="color: red">*</span></td>
            </tr>
            <tr>
                <td>显示选项：</td>
            ...
            <tr>
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" class="text-center">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox class="form-control text_300"  ID="DateSearchRang" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox><br />
        ...
        <tbody id="DivPicType" style="display: none" runat="server">
            ...
            <tr>
                <td>允许上传的图片大小：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="TxtSPicSize" runat="server" Columns="5">1024</asp:TextBox>KB <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span></td>
            </tr>
            <tr>
                <td>允许上传的图片类型：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="TxtPicExt" runat="server" Columns="30"></asp:TextBox><span style="color: red">*</span>
        ...
        <tbody id="DivMultiPicType" style="display: none" runat="server">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox class="form-control text_300"  ID="TxtThumb" runat="server" Columns="20"></asp:TextBox><span style="color: Red; display: none;">保存缩略图地址字段名不能与主字段名重复！</span></td>
            </tr>
            <tr>
                <td>图片是否加水印：</td>
                <td>
            ...
            <tr>
                <td>允许上传的图片大小：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="TxtPicSize" runat="server" Columns="5">1024</asp:TextBox>KB <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span></td>
            </tr>
            <tr>
                <td>允许上传的图片类型：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="TextImageType" runat="server" Columns="30"></asp:TextBox>
        ...
        <tbody id="DivSmallFileType" style="display: none" runat="server">
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_300"  ID="TxtMaxFileSizes" runat="server" Columns="5">1024</asp:TextBox>KB <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr>
                <td>允许上传的文件类型：    
                ...
                <td>
                    <asp:TextBox class="form-control text_300"  ID="TxtUploadFileTypes" runat="server" Columns="30"></asp:TextBox>
        ...
        <tbody id="DivFileType" style="display: none" runat="server">
            <tr>
                ...
                <td>
                    ...
                    保存文件大小字段名：
                    <asp:TextBox class="form-control text_300"  ID="TxtFileSizeField" runat="server" Columns="20"></asp:TextBox><br />
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_300"  ID="TxtMaxFileSize" runat="server" Columns="5">1024</asp:TextBox>KB <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr>
                <td>允许上传的文件类型：
                ...
                <td>
                    <asp:TextBox class="form-control text_300"  ID="TxtUploadFileType" runat="server" Columns="30"></asp:TextBox>
        ...
        <tbody id="DivOperatingType" style="display: none" runat="server">
            <tr>
                <td>分行键入&nbsp;&nbsp;<br />
                    每个平台选项：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="TxtOperatingOption" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox>
                    <span style="color: red">*</span> <span style="color: blue">注：一行一个默认项</span></td>
            </tr>
            <tr>
                <td>文本框长度：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="OperatingType_TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox><span style="color: red">*</span></td>
            </tr>
            <tr>
                <td>默认值：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="OperatingType_DefaultValue" runat="server" Columns="30"></asp:TextBox><span style="color: green">例：Win2000/XP/Win2003</span> </td>
            </tr>
        </tbody>
        <!--  超链接    -->
        <tbody id="DivSuperLinkType" style="display: none" runat="server">
            <tr>
                <td>文本框长度：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="SuperLinkType_TitleSize" runat="server" Columns="10" MaxLength="4">50</asp:TextBox></td>
            </tr>
            <tr>
                <td>默认值：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="SuperLinkType_DefaultValue" runat="server" Columns="30"></asp:TextBox><span style="color: green">例：http://127.0.0.1/</span></td>
            </tr>
        </tbody>
        <!--  多级选项    -->
        ...
        <tbody id="DivNumType" style="display: none" runat="server">
            <tr>
                <td>文本框长度：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="NumberType_TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox></td>
            </tr>
            <tr>
                <td>数字类型：</td>
                <td>
            ...
            <tr id="showdec" style="display: none">
                ...
                <td>
                    <asp:TextBox class="form-control text_300"  ID="txtdecimal" runat="server" Text="0"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                <td>默认值：</td>
                <td>
                    <asp:TextBox class="form-control text_300"  ID="NumberType_DefaultValue" runat="server" Columns="10"></asp:TextBox></td>
            </tr>
            <tr>
                <td>搜索设置：
                </td>
            ...
            <tr>
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" class="text-center">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox class="form-control text_300"  ID="NumSearchRange" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox><br />
                            </td>
                            <td>
