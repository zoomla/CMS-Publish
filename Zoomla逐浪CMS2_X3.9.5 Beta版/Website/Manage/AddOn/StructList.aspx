...
<asp:Content ContentPlaceHolderID="Content" runat="Server">
    <div>
        ...
        <div>
            <asp:Button ID="Button1" class="btn btn-primary" Text="批量排除" runat="server" OnClientClick="if(!IsSelectedId()){alert('请选择内容');return false;}else{return confirm('不可恢复性数据,你确定将该成员从此结构中排除吗？');}" OnClick="Button1_Click" />
            <input type="button" value="组织结构图" onclick="showStructPic();" class="btn btn-primary" />
        </div>
