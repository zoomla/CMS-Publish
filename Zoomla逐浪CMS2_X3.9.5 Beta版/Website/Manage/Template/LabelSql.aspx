	...
	<table class="table table-striped table-bordered">
	  ...
	  <tr>
          ...
          <td style="padding:0px;">
              <table class="table table-striped table-bordered" style="width:1024px;margin:0px;">
                  <tr>
                      <td class="text-right" style="width: 120px;">请选择数据库： </td>
                      <td>
                          <asp:DropDownList ID="DBList_DP" CssClass="form-control text_300" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DBList_DP_SelectedIndexChanged" /></td>
                      <td class="text-right" style="width: 120px;">请选择数据库： </td>
                      <td><asp:DropDownList ID="DBList2_DP" CssClass="form-control text_300" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DBList2_DP_SelectedIndexChanged" /></td>
                  </tr>
                  <tr>
                        <td class="text-right">主表： </td>
                      <td>
                          <asp:DropDownList ID="TableList_DP" DataTextField="Name" DataValueField="Name" CssClass="form-control text_300" runat="server" AutoPostBack="True" OnSelectedIndexChanged="TableList_DP_SelectedIndexChanged" /></td>
                      <td class="text-right">从表： </td>
                      <td>
                          <asp:DropDownList ID="TableList2_DP" DataTextField="Name" DataValueField="Name" CssClass="form-control text_300" runat="server" AutoPostBack="True" OnSelectedIndexChanged="TableList2_DP_SelectedIndexChanged" /></td>
                  </tr>
                  <tr>
                         <td class="text-right">输出字段： </td>
                      <td>
                          <asp:ListBox ID="FieldList_DP" DataTextField="Name" DataValueField="Name" CssClass="form-control text_300" runat="server" Height="220px" SelectionMode="Multiple" /></td>
                      <td class="text-right">输出字段： </td>
                      <td>
                          <asp:ListBox ID="FieldList2_DP" DataTextField="Name" DataValueField="Name" CssClass="form-control text_300" runat="server" Height="220px" SelectionMode="Multiple" /></td>
                  </tr>
                  <tr><td colspan="4"> <div class="rd_red">先取数据表后再选择输出字段，支持Ctrl或Shift选取操作</div></td></tr>
              </table>
          </td>
	  </tr>
