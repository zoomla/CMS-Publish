<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="ZoomLaCMS.Manage.Search" MasterPageFile="~/Manage/I/Default.Master" %>
...
<li class="active"><a href="<%=Request.RawUrl %>" style="margin-right:30px;">功能检索</a>
    <a href="<%=customPath2 %>Main.aspx" class="btn btn-info">从此开始</a>
    <a href="<%=customPath2 %>Workload/FuncList.aspx" class="btn btn-warning">功能列表</a>
</li>
</ol>
<ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" EnableTheming="False"  AllowPaging="true" OnPageIndexChanging="EGV_PageIndexChanging" PageSize="15"
    EmptyDataText="没有匹配的页面，建议更换关键词!!" style="margin-top:10px;"  class="table table-striped table-bordered table-hover">
  <Columns>
