...
<div>
  ...
  <ul class="content_nav_ul">
	...
	<li class="hidden-xs" onclick="location='<%:GetUrl("?msgtype=1&liop=2") %>';"><a href="javascript:;">通知</a></li>
	<li onclick="location='<%:GetUrl("?msgtype=2&liop=3") %>';"><a href="javascript:;">投票</a></li>
	<li class="hidden-xs" onclick="location='<%:GetUrl("?msgtype=1&liop=4") %>';"><a href="javascript:;">文章</a></li>
