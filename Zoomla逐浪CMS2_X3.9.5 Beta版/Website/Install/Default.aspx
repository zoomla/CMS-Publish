...
<div class="input-group">
  <div class="input-group-prepend">
    <span class="input-group-text" id="basic-addon8"><%=Resources.L.电子邮箱 %></span>
  </div>
<asp:TextBox ID="TxtEmail" runat="server" data-enter="3" class="form-control" Text="web@z01.com" />
</div>
<small class="text-muted">用于收发平台邮件<asp:RequiredFieldValidator ID="RS4" runat="server" ForeColor="Red" ControlToValidate="TxtEmail" ErrorMessage="<%$Resources:L,Email不能为空 %>" Display="Dynamic" />
...
<small  class="text-muted"><%=Resources.L.如库中已有此管理员 %></small>
<div class="input-group">
  <div class="input-group-prepend">
