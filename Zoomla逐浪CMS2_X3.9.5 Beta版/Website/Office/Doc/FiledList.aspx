...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <ol id="BreadNav" class="breadcrumb navbar-fixed-top">
        ...
        <li><a href="/Office//Flow/ApplyList.aspx?view=3">我的公文</a></li>
    ...
    <ZL:ExGridView ID="SEGV" runat="server" AutoGenerateColumns="False" PageSize="10"
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="档号" DataField="No" ItemStyle-CssClass="td_m"/>
            <asp:TemplateField HeaderText="标题">
                <ItemTemplate><!--点击进入审核界面,用于浏览-->
                    <a href="/Office/FreeFlow/FlowView.aspx?AppID=<%#Eval("ID") %>&Action=filed"><%#Eval("Title") %></a>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField HeaderText="部门" DataField="Branch" ItemStyle-CssClass="td_m" />
            <asp:BoundField HeaderText="发起人" DataField="UserName" ItemStyle-CssClass="td_m" />
