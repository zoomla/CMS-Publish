...
<li id="Message1"><a href="javascript:;" data-target="/Office/Mail/Message.aspx"><i class="fa fa-envelope-square"></i>收信</a></li>
...
<ul class="Messge_nav"> 
<li><a href="javascript:;" data-target="/Office/Mail/Message.aspx">收件箱<span style="color:red;">(<%=GetUnreadMsg()%>)</span></a></li> 
