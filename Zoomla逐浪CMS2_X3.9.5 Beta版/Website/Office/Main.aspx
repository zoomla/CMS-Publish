                            ...
                            <div class="inContent executive">
                                <table class="myTable threeTr">
                                    <tr class="hover_hander">
                                        <td><a href="javascript:;" onclick="ShowMain('#draftdoc_ul','/Office/Flow/FlowApply.aspx?proid=1')">
                                        ...
                                        <td><a href="javascript:;" onclick="ShowMain('#office_ul','/Office/Flow/ApplyList.aspx?view=2')">
                                            <img src="Images/Main/done.gif" /><div>已办事务</div>
                                        </a></td>
                                    </tr>
                                    <tr class="hover_hander">
                                        <td><a href="javascript:;" onclick="ShowMain('#senddoc_ul','/Office/Flow/ApplyList.aspx?view=3&proid=2')">
                                            <img src="Images/Main/post.gif" /><div>发文管理</div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('#userinfo_ul','/Office/Flow/ApplyList.aspx?view=3')">
                                            <img src="Images/Main/Receipt.gif" /><div>收文管理</div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('#userinfo_ul','/Office/Doc/FiledList.aspx')">
