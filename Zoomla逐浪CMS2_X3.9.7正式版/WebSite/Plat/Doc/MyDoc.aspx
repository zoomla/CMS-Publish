                        ...
                        <tr id="file_tr_<%#Eval("ID") %>" onmouseover="$(this).find('.hoverDiv').show();" onmouseout="$(this).find('.hoverDiv').hide();">
                            <td>
                                ...
                                <%#GetFileName() %> <span class="hoverDiv" style="display: none;">
                                    ...
                                    <%#GetOP() %> <a><span class='zi zi_syncalt' title='重命名' onclick="ShowReName(<%#Eval("ID") %>);"></span></a><a><span class='zi zi_trashalt' title='删除' onclick="PostDel(<%#Eval("ID")%>);"></span></a></span></td>
