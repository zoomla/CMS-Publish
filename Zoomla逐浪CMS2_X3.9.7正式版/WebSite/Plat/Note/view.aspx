...
<img src="" style="width:140px;height:180px;" onerror="this.src='/UploadFiles/nopic.svg'"/>
</div>--%>
                    ...
                    <div class="msg_item" ng-repeat="item in msg.list|orderBy:'-ID'">
                        ...
                        <div class="content">
                            <div class="content_head">
                                <a href="#" ng-bind="item.UserName"></a><span><i class="zi zi_home margin-l" style="font-size: 1.3em;"></i>{{item.GroupName}}</span>
            ...
            <div class="note_steps" id="note_steps">
                <div class="note_steps_c">
                    <div class="steps_title">
                        <h2>步骤列表</h2>
                        <div class="margin-top"><span><a class="note_steps_a" id="note_steps_a" href="javascript:;"><i class="zi zi_tasks"></i>步骤大纲</a></span></div>
                    </div>
                    ...
                    <div class="text-center">
                        <span id="Edit_Span" visible="false" runat="server"><a href="Note.aspx?id=<%=Mid %>"><i class="zi zi_pencilalt"></i>返回编辑</a></span>
                    </div>
                </div>
            </div>
            <div class="note_sbody"></div>
            <div class="note_steps_info" id="note_steps_info">
                <div class="step_info_close"><i class="zi zi_times"></i></div>
    ...
    var scope = null, note = {
        Video: {
            getvideo: function (model) {
                ...
                return '<video width="600" height="400" src="' + model.content + '" poster="/Template/V4/style/Images/l_logo.jpg" class="edui-upload-video vjs-default-skin video-js" preload="none" controls=""><source src="' + model.content + '" type="video/mp4"></video>';
            },
