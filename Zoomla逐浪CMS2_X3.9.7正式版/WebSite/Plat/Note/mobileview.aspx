        ...
        <div ng-controller="NoteCtrl">
            <div class="mnote_head">
                <div class="mnote_head_back">
                    <div class="pull-left">
                    <a href="mobilelist.aspx"><i class="zi zi_doubleLeft"></i></a>
                    </div>
                    <div class="pull-right">
                    <a href="mobilenote.aspx?id=<%=Mid %>"><i class="zi zi_edit"></i></a>
                    </div>
                </div>
            ...
            <div class="mnote_top">
                <div class="mnote_top_c">
                    <div class="mnote_top_t" ng-style="{'background':'url({{comMod.topimg}}) center no-repeat','background-size':'cover'}"><div  ng-if="comMod.topimg==''" class="mnote_top_ti"><i class="zi zi_image"></i><br />背景图片</div></div>
