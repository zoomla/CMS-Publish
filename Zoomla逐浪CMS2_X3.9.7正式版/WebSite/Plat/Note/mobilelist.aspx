            ...
            <ItemTemplate>
                <div class="proitem">
                    ...
                    <div class="pro_option">
                        <a href="mobilenote.aspx?id=<%#Eval("ID") %>" class="pro_option_edit"><i class="zi zi_pencilalt"></i></a>
                        <asp:LinkButton CommandName="del" CssClass="pro_option_del" CommandArgument='<%#Eval("ID") %>' runat="server"><i class="zi zi_trashalt"></i></asp:LinkButton>
                    </div>
                </div>
            </ItemTemplate>
        </asp:Repeater>
