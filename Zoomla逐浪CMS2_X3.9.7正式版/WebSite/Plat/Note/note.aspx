...
<div class="note-head-ls"><a href="/Plat/"><i class="zi zi_home zi_2x"></i></a><span>项目管理</span></div>
<div class="cp_num">
<i ng-repeat="item in complete.nums" ng-class="complete.getclass(item);"></i>
<strong ng-bind="complete.getcomplete()+'%'"></strong>
</div>
<a href="javascript:;" onclick="setProgress();" title="查看详情" class="note-head-ld">完成度详情 <i class="zi zi_doubleDown"></i></a>
</div>
...
<a class="a_set" title="设置头图"><i class="zi zi_cog"></i><span>设置头图</span></a>
<ul>
<li><a title="重新上传头图" onclick="selTopimg();"><i class="zi zi_image"></i><span>重新上传头图</span></a></li>
</ul>
</div>
...
<a href="javascript:;"><i class="zi zi_times bar-btn" ng-click="bar.toggle(item);"></i></a>
<a href="javascript:;" ng-click="note.showText(item);"><i class="zi zi_textbook bar-btn"></i>添加文字</a>
<a href="javascript:;" onclick="note.preAddcom('image');"><i class="zi zi_image bar-btn"></i>添加图片</a>
<a href="javascript:;" onclick="showUPVideo(this);"><i class="zi zi_video bar-btn"></i>添加视频</a>
<a href="javascript:;" onclick="note.preAddcom('para');"><i class="zi zi_textwidth bar-btn"></i>添加段落</a>
<a href="javascript:;" ng-click="note.delcom(item);" ng-if="$index!=0"><i class="zi zi_times bar-btn"></i>移除节点</a>
</div>
<div ng-show="bar.active==item.id" class="toolbar_c">
<a href="javascript:;"><i class="zi zi_plus bar-btn" ng-click="bar.toggle(item);"></i></a>
</div>
</div>
...
<i class="zi zi_smileyFace fabtn" title="选择表情" onclick="selemotion(this);" ng-click="setcur(item);"></i>
...
<i class="zi zi_pencilalt" title="修改段落" ng-click="note.Para.edit(item);"></i>
<i class="zi zi_trashalt" title="删除段落" ng-click="note.delcom(item);"></i>
</span>
</h2>
</div>
</div>
...
<a title="展开" class="pu_items pu_open" onclick="drag.open();"><i class="zi zi_doubleLeft"></i><strong>顺序编辑器</strong> <span>项目文字及照片</span></a>
...
<div class="pu_items pu_close" onclick="drag.close();"><i class="zi zi_doubleRight"></i></div>    
...
<a class="go_rise" title="返回顶部" onclick="Control.Scroll.ToTop();"><i class="zi zi_doubleUp"></i>顶部</a>
<a class="go_down" title="返回底部"  onclick="Control.Scroll.ToBottom();">底部<i class="zi zi_doubleDown"></i></a>
</div>
</div>
<div hidden>
<div class="tool-upvideo" id="upvideo_div" style="position: absolute;">
<a href="javascript:;" onclick="hideUPVideo();" class="upvideo-close" title="关闭"><i class="zi zi_times"></i></a>
<div class="upvideo-head">
<a href="javascript:;" data-pane="upvideo-file" class="vt_btn active"><i class="zi zi_upload"></i>本地上传</a>
<a href="javascript:;" data-pane="upvideo-online" class="vt_btn"><i class="zi zi_playcircle"></i>在线视频</a>
<div class="clearfix"></div>
</div>
