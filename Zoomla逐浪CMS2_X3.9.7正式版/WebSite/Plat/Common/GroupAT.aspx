...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div>
        <div style="background-color: #FAFAFA; padding: 0 0 10px 10px; border-bottom: 1px solid #ddd;">
            <span class="zi zi_times" style="cursor:pointer;margin-right:10px;" title="关闭" onclick="parent.DisGroupAT();"></span>
            ...
            <div class="input-group input-group-sm" style="width: 220px;display:inline-block;margin-left:20px;position:relative;top:10px;">
                ...
                <span class="input-group-btn">
                    <button class="btn btn-default" type="button" onclick="SearchKey();"><span class="zi zi_search"></span></button>
                </span>
            </div>
        </div>
