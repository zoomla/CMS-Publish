            ...
            <div class="row">
                    ...
                    <div class="selgroup_content m-1 row">
                        ...
                        <div class="userlist_div mt-2 col-12">
                            <div class="text-right" id="backgroup_div" style="padding:5px;display:none;">
                                <a href="javascript:;" onclick="B_Groups.Show()"><i class="zi zi_userfriends"></i> 返回用户组</a>
                            </div>
                            ...
                            <div class="mt-2">
                                ...
                                <div id="wait_div" class="text-center"><i class="zi zi_spinner zi_pulse zi_2x" ></i></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-5 adduser_div">
                    ...
                    <div class="center_div">
                        <span class="zi zi_doubleRight"></span>
                    </div>
                </div>
            </div>
