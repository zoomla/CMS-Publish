...
<asp:LinkButton runat="server" ID="Del_Btn" OnClick="Del_Btn_Click" OnClientClick="return confirm('确定要删除吗!!');"> <span class="zi zi_trashalt" title="删除" style="margin-left:10px;"></span> </asp:LinkButton>
</div>
...
<tr>
  <td colspan="2"><span class="zi zi_userfriends"></span> <a href="javascript:;" target="_blank">
	<asp:Label runat="server" ID="CUser_T"></asp:Label>
	</a> <span style="margin-left:10px;">创建</span></td>
</tr>
<tr>
  <td><span class="zi zi_useralt"></span> <span>主负责人：</span> <a href="#"><span class="zi zi_pluscircle" title="添加" onclick="selRuser();"></span></a>
	<asp:HiddenField runat="server" ID="LeaderIDS_Hid" /></td>
  <td><asp:Label runat="server" ID="LeaderIDS_L"></asp:Label></td>
</tr>
<tr>
  <td><span class="zi zi_useralt"></span> <span>任务成员：</span> <a href="#"><span class="zi zi_pluscircle" title="添加" onclick="selCuser();"></span></a>
	<asp:HiddenField runat="server" ID="ParterIDS_Hid" /></td>
  <td><asp:Label runat="server" ID="ParterIDS_L"></asp:Label></td>
</tr>
<tr>
  <td><span class="zi zi_listalt"></span><span>项目详情：</span></td>
...
<tr>
  <td><span class="zi zi_bookmark"></span><span>是否公开：</span></td>
...
<tr>
  <td><span class="zi zi_bookmark"></span><span>是否完成：</span></td>
...
<tr>
  <td><span class="zi zi_paperclip" onclick="openUpfile()"></span><span>附件：</span></td>
