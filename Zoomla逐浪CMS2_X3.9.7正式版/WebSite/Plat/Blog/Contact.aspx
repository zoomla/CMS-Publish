...
<div class="container platcontainer">
    ...
    <div class="input-group">
        <input runat="server" id="skey_t" class="form-control max20rem" placeholder="请输入搜索内容" type="text" />
        <span class="input-group-append">
            <asp:Button runat="server" ID="Skey_Btn" Text="搜索" OnClick="Skey_Btn_Click" CssClass="btn btn-info" />
        </span>
    </div>
  <div class="mt-1 table-responsive-md">
    <Zl:ExGridview ID="EGV" AutoGenerateColumns="false" AllowPaging="true" EnableTheming="false" Width="98%" CssClass="table table-bordered table-hover" EmptyDataText="当前没有信息！" OnPageIndexChanging="EGV_PageIndexChanging"  OnRowCommand="EGV_RowCommand" PageSize="10" runat="server">
      ...
      <asp:TemplateField HeaderText="二维码">
        <ItemTemplate> <span class="zi zi_qrcode" style="font-size:1.3em;color:gray;" title="获取二维码" onclick="GetQrCode(<%#Eval("UserID") %>);"></span>
    ...
    <table  class="TableWrap"  border="0" cellpadding="0" cellspacing="0" width="100%" id="sleall">
      <tr>
        <td><asp:Button ID="BtnSetTopPosation" runat="server" CssClass="btn btn-outline-info" OnClick="BtnSetTopPosation_Click" Text="批量发邮件"  />
