...
.zi { cursor: pointer; color: black; }
.zi:hover { color: #0066cc; }
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
  <div id="TaskDetail_Div" style="font-family:'Microsoft YaHei';">
    <div class="task_top_div">
      ...
      <div class="col-xs-3"><span class="zi zi_road"></span><span style="margin-left: 5px;">进行中</span></div>
      ...
      <div class="col-xs-3" style="text-align: right;"> <span class='zi zi_times' title='关闭' onclick="parent.HideTaskDiv();"></span>
        <%-- <asp:LinkButton runat="server" ID="Del_Link" ToolTip="删除" OnClientClick="reutrn confirm('确定要删除吗?');" OnClick="Del_Link_Click">
				<span class='zi zi_trashalt'></span></asp:LinkButton>--%>
      </div>
    </div>
    <div class="task_info_div">
      <div style="padding-top: 5px; padding-bottom: 5px;">
        ...
        <span class="zi zi_lock" title="公开该任务" style="float: right;"></span> </div>
      <div>
    ...
    <div class="task_info_detail_div">
      ...
      <asp:LinkButton runat="server" ID="upfilebt" OnClientClick="return openUpfile(false)"><span class="zi zi_paperclip" style="font-size:1em;">附件</span></asp:LinkButton>
      <div id="showfilelist">
