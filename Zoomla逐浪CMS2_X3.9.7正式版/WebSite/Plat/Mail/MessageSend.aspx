...
<table class="table table-border table-hover sys_table  mt-2">
	<tr>
	  <th class="w12rem_lg">收件人</th>
	  <td class="tdRight">
    ...
    <tr id="hasFileTR" runat="server" visible="true">
        <th>已上传文件<asp:HiddenField runat="server" ID="hasFileData" /></th>
	...
	<tr>
	  <th></th><td>
          <asp:Button ID="Send_Btn" runat="server" Text="发送邮件" OnClick="Send_Btn_Click" OnClientClick="return SendConfirm();" class="btn btn-outline-info" />
          <asp:Button ID="Draft_Btn" runat="server" Text="存为草稿" OnClick="Draft_Btn_Click" class="btn btn-outline-info" />
      </td>
	</tr>
  </table>
  </div>
