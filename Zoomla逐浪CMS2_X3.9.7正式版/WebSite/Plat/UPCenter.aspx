    ...
    <div id="admin_div">
      <table class="table table-bordered table-hover table-striped sys_table">
        <tr>
          ...
          <td class="tdcontent"><asp:TextBox ID="UserName_T2" CssClass="form-control max20rem" ReadOnly="true" runat="server" /></td>
        </tr>
        <tr>
          <th>用户组</th>
          <td class="tdcontent"><asp:TextBox ID="Plat_Group_T2" onkeydown="return GetEnterCode('focus','Status_T2');" CssClass="form-control max20rem" Enabled="false" runat="server" /></td>
        </tr>
        <tr>
          <th>状态</th>
          <td class="tdcontent"><asp:TextBox ID="Status_T2" onkeydown="return GetEnterCode('focus','TrueName_T2');" CssClass="form-control max20rem" runat="server" Enabled="false" Text="正常" /></td>
        </tr>
        <tr>
          <th>昵称</th>
          <td class="tdcontent"><asp:TextBox ID="TrueName_T2" onkeydown="return GetEnterCode('focus','Mobile_T2');" CssClass="form-control max20rem" runat="server" />
        ...
        <tr>
          <th>移动电话</th>
          <td class="tdcontent"><asp:TextBox ID="Mobile_T2" onkeydown="return GetEnterCode('focus','Post_T2');" CssClass="form-control max20rem" runat="server" /></td>
        </tr>
        <tr>
          <th>工作岗位</th>
          <td class="tdcontent"><asp:TextBox ID="Post_T2" onkeydown="return GetEnterCode('click','Save_Btn');" CssClass="form-control max20rem" runat="server" /></td>
        </tr>
        <tr>
          <th>个人头像</th>
            <td>
        ...
        <tr>
          <th>操作</th>
          <td><asp:Button runat="server" CssClass="btn btn-outline-info" ID="AdminSave_Btn" OnClick="AdminSave_Btn_Click" Text="提交修改" ValidationGroup="Add" Visible="false" />
            <asp:Button runat="server" CssClass="btn btn-outline-info" ID="Save_Btn" OnClick="Save_Btn_Click" Text="提交修改" ValidationGroup="Add" Visible="false" /></td>
        </tr>
      </table>
    </div>
