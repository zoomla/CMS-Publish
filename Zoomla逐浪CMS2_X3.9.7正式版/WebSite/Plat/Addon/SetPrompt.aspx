                    ...
                    <ZL:ExRepeater runat="server" ID="RPT" PageSize="10" PagePre="<tr><td colspan='5' class='text-center'>" PageEnd="</td></tr>" OnItemCommand="RPT_ItemCommand">
                        <ItemTemplate>
                            <tr>
                              ...
                              <%--  <td><%#GetStatus() %></td>--%>
                                <td>
                                    <a href="SetPrompt.aspx?ID=<%#Eval("ID") %>"><i class="zi zi_pencilalt"></i></a>
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="del" OnClientClick="return confirm('确定要删除吗?');"><i class="zi zi_trashalt"></i></asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
