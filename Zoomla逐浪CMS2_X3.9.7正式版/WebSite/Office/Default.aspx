...
<div class="m_OAtop d-flex" id="OAtop">
	...
	<ul>
	<li><a href="/Plat/Blog/" target="_blank"><i class="zi zi_universalaccess"></i>工作流</a></li>
	<li><a href="/User/Cloud/" target="_blank"><i class="zi zi_clouduploadalt"></i>网络云盘</a></li>
	<li><a href="#"><i class="zi zi_speaker"></i>会议通知</a></li>
	<li><a href="javascript:;" onclick="ShowMain('','/Office/Flow/ApplyList.aspx')"><i class="zi zi_listalt "></i>信息管理</a></li>
