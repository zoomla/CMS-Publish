...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server"><title>选择支付平台_<%:Call.SiteName %></title></asp:Content>
...
<div class="pay_select card">
	...
	<div class="PayPlat_s card-body">
		...
		<asp:Button CssClass="btn btn-info btn-lg ml-2 NextStep_btn" runat="server" id="cartpay_btn" OnClick="BtnSubmit_Click" Text="确定支付方式" />
		<div class="clear"></div>
	</div>
</div>
</div>
