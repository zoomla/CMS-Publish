...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * });
         ...
         <script>
            var vip_content = document.getElementById('diag_div').innerHTML;
            document.getElementById('diag_div').remove();
            function showVip() {
                var diag = weui.dialog({
                    content: vip_content,
                    className: '',
                    buttons: [
                        { label: '确定购买', type: 'primary', onClick: function () { $("#Save_Btn").click(); } },
                        { label: '关闭弹窗', type: 'primary' }
                    ]
                });
            }
        </script>
