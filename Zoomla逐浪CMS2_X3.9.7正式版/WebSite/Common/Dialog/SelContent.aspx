...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="input-group" style="margin-bottom:5px;">
        ...
        <span class="input-group-append">
            <asp:LinkButton ID="Search_L" runat="server" CssClass="btn btn-info" OnClick="Search_L_Click"><i class="zi zi_search"></i></asp:LinkButton>
        </span>
    </div>
<table id="EGV" class="table table-striped table-bordered table-hover content_list">
    ...
    <ZL:Repeater ID="RPT" runat="server" PageSize="10" PagePre="<tr><td colspan='6'><div class='text-center'>"
        PageEnd="</div></td></tr>">
        <ItemTemplate>
            <tr ondblclick="$('#SelContent_B').click();">
                <td class="td_s">
...
<div class="text-center">
    <asp:Button ID="SelContent_B" runat="server" CssClass="btn btn-outline-info" Text="选择" OnClick="SelContent_B_Click" />
