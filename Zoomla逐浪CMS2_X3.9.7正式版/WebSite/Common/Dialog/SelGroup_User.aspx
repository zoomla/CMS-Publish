...
<span class="btn btn-info"><a id="search_b" href="javascript:;"><i class="zi zi_search"></i></a</span>
</div>
</div>
</div>
			...
			<div class="selgroup_content" >
				<div class="userlist_div">
					...
					<div class="">
						...
						<div id="wait_div" class="text-center"><i class="zi zi_spinner fa-spin" style="font-size: 40px;"></i></div>
					</div>
				</div>
			</div>
		</div>
...
<%--			<div class="center_div">
				<span class="zi zi_forRight"></span>
			</div>--%>
		</div>
	</div>
