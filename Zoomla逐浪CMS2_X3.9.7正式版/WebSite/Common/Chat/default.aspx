<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ZoomLaCMS.Common.Chat.chat1" ValidateRequest="false" MasterPageFile="~/Common/Chat/chat.master" %>
...
<span class="chat_top_r margin_r5" data-toggle="tooltip" data-placement="left" title="点击查看历史记录"><a href="javascript:;" onclick="ShowHistory();"><i class="zi zi_listalt"></i> 历史记录</a></span>
</div>
<div class="chat_main">
...
<button type="button" id="sendbtn" class="btn btn-info pull-right" disabled="disabled" onclick="SendMsg();">发送</button>
...
欢迎[<asp:Label runat="server" ID="UserName_L" />]，您可以通过UID来指定聊天对象，如：/Common/Chat/?uid=1[<a href="javascript:;" onclick="ShowModal();">退出系统</a>]
