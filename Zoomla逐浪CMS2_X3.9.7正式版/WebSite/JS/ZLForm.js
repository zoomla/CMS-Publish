...
ZLForm.Select.prototype = {
    addTlp: "<span class='zi zi_plus opbtn'>",
    radTlp: "<li data-sort='@sort'><input type='radio' name='@id_rad'/><input type='text' value='@value' /><span class='zi zi_minus opbtn'></span></li>",
    chkTlp: "<li data-sort='@sort'><input type='checkbox' name='@id_chk'/><input type='text' value='@value' /><span class='zi zi_minus opbtn'></span></li>",
    //前后台独有更新
    GetMaxSort: function () {
        var max = 1;
