(function ($) {
    $.fn.ZL_NavTab = function (option) {
        var tlphtml = "<ul class='nav nav-tabs' id='@rid_navtabs_ul'>@li</ul>"
                    + "<a id='@rid_hid_right' class='hid_right'><i class='zi zi_pathLeft'></i></a>"
                    + "<a id='@rid_hid_left' class='hid_left'><i class='zi zi_pathRight'></i></a>";;
        var defconfig = {
            hid: "",//存放数据的hidden
            curid: 0,//当前选中项id
        ...
        for (var i = 0; i < datas.length; i++) {
            var litlp = "<li class='nav-item' role='presentation'><a class='@rid_tab_a @class nav-link' data-id='@id' href='javascript:;'>@name</a></li>";
