...
info.editTlp += '<td style="width:150px;"><a href="javascript:;" class="btn btn-default" onclick="info.upRow(this)"><i class="zi zi_arrowUp"></i></a> <a href="javascript:;" class="btn btn-default" onclick="info.downRow(this)"><i class="zi zi_arrowDown"></i></a> <a class="btn btn-danger" title="移除" onclick="info.delRow(this);"><i class="zi zi_times"></i></a></td></tr>';
...
refence.editTlp = "<div class=\"ref_item\"><div>"
            ...
            + "<a onclick=\"refence.del('@id');\"><i class=\"zi zi_times\"></i>删除</a>"
            + "</div></div>"
