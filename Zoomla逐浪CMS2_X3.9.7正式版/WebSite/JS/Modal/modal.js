...
Dialog.prototype = {
    ShowModal: function () {
        ...
        var header = "<button type='button' class='close' data-dismiss='modal'><span class='zi zi_times'>Close</span></button>@Opion<span class='modal-title'><strong id='title'>@Title</strong></span>";
        var body = "";
        var Opion = "";
        var foot = "";
        switch (this.Type) {
