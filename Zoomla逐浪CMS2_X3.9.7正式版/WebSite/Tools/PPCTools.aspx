...
<div class="container" ng-app="APP" ng-controller="ZLCtrl">
    <div class="class_box">
        <div class="sort_box">
            <button type="button" class="btn btn-info btn-sm" title="上移" ng-click="up('province');"><i class="zi zi_arrowUp" zico="指上长箭头"></i></button>
            <button type="button" class="btn btn-info btn-sm" title="下移" ng-click="down('province');"><i class="zi zi_arrowDown" zico="指下长箭头"></i></button>
            <button type="button" class="btn btn-info btn-sm" title="删除" ng-click="del('province');"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i></button>
        </div>
    ...
    <div class="class_box">
        <div class="sort_box">
            <button type="button" class="btn btn-info btn-sm" title="上移" ng-click="up('city');"><i class="zi zi_arrowUp" zico="指上长箭头"></i></button>
            <button type="button" class="btn btn-info btn-sm" title="下移" ng-click="down('city');"><i class="zi zi_arrowDown" zico="指下长箭头"></i></button>
            <button type="button" class="btn btn-info btn-sm" title="删除" ng-click="del('city');"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i></button>
        </div>
    ...
    <div class="class_box">
        <div class="sort_box">
            <button type="button" class="btn btn-info btn-sm" title="上移" ng-click="up('county');"><i class="zi zi_arrowUp" zico="指上长箭头"></i></button>
            <button type="button" class="btn btn-info btn-sm" title="下移" ng-click="down('county');"><i class="zi zi_arrowDown" zico="指下长箭头"></i></button>
            <button type="button" class="btn btn-info btn-sm" title="删除" ng-click="del('county');"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i></button>
        </div>
    ...
    <div class="text-center">
        <div class="input-group">
            <span class="input-group-prepend"><span class="input-group-text">当前省</span></span>
            <input type="text" class="form-control text_md" ng-model="seled.proMod.Name" />
            <span class="input-group-prepend"><span class="input-group-text">当前市</span></span>
            <input type="text" class="form-control text_md" ng-model="seled.cityMod.Name"  />
            <span class="input-group-prepend"><span class="input-group-text">当前县</span></span>
        ...
        <div class="input-group" style="margin-top:5px;margin-bottom:5px;">
            ...
            <span class="input-group-append">
                <input type="button" class="btn btn-outline-info" ng-click="add('province');" value="添加为省份" />
            <input type="button" class="btn btn-outline-info" ng-click="add('city');" value="添加为城市" />
            <input type="button" class="btn btn-outline-info" ng-click="add('county');" value="添加为县区" />
            <input type="button" class="btn btn-primary" ng-click="save();" value="保存至数据文件"/>
            </span>
        </div>
    </div>
<div class="alert alert-info alert-dismissible fade show" role="alert">
  <strong>提示</strong> PPC省市县三级数据字典读文件路径为<code>/JS/ICMS/area.js</code>，更改后请请注意更新缓存。
...
<style type="text/css">
.sort_box{width:40px;display:inline-block;position:absolute;top:30%;}
.sort_box .btn{margin-top:10px;}
.class_box { display: inline-block; width: 300px; margin-right: 60px;margin-top:10px;position:relative;}
