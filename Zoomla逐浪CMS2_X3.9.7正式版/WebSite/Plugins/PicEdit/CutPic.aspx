    ...
    <div class="cutbox">
            ...
            <div id="imgFunc">
                <div class="col-xs-2" id="imgSave">
                    <asp:LinkButton runat="server" ID="Save_Btn" CssClass="btn btn-primary margin_t5" OnClientClick="return PreSave();" OnClick="Save_Btn_Click"><i class="zi zi_save"></i>保存</asp:LinkButton>
                </div>
                <div class="col-xs-10" id="imgEdit">
                    <ul class="nav nav-tabs pull-right cut-option" role="tablist">
                        <li class="active"><a href="#imgCut" role="tab" data-toggle="tab"><i class="zi zi_crop"></i>裁剪</a></li>
                        <li><a href="#imgSmall" role="tab" data-toggle="tab"><i class="zi zi_table"></i>缩放</a></li>
                        <li><a href="#imgMark" role="tab" data-toggle="tab"><i class="zi zi_unlink"></i>水印</a></li>
                        <li><a href="#imgWord" role="tab" data-toggle="tab"><i class="zi zi_fonts"></i>文字</a></li>
                        <li><a href="javascript:;" onclick="RotateFunc(90);" role="tab" data-toggle="tab"><i class="zi zi_undo"></i>左旋转</a></li>
                        <li><a href="javascript:;" onclick="RotateFunc(-90);" role="tab" data-toggle="tab"><i class="zi zi_undoalt"></i>右旋转</a></li>
