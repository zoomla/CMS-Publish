...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="panel-footer sysBtline">
        <asp:Button runat="server" ID="GetPic_Btn" Text="确定" OnClick="GetPic_Btn_Click" OnClientClick="ShowWait();" CssClass="btn btn-outline-info" />
    </div>
