...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="container">
        <div class="panel panel-primary">
          <div class="panel-heading"><span class="zi zi_plane"></span><span class="margin_l5">旅游路线</span></div>
  ...
  <%--  <div><strong>保险数量:</strong><asp:TextBox runat="server" ID="Safenum_T" CssClass="form-control" /></div>--%>
    <div class="panel panel-primary">
        <div class="panel-heading"><span class="zi zi_user"></span><span class="margin_l5">旅客信息</span> <div class="pull-right"></div> <button type="button" class="btn btn-info" onclick="ShowSelCustomer()" style="color:#fff;"><span class="zi zi_plus"></span> 选择客户</button></div>
        <div class="panel-body">
            <ul id="user_ul">
        <li>
            <table class='table table-bordered'>
                <tr><td rowspan='2' class='r_green_mid min'>旅客<span class='num'>1</span></td><td><input type='text' class='form-control text_300 required' name='name_t_1' placeholder='姓名' />
                    <span class='btn btn-default zi zi_plus' onclick='AddGuest();'></span></td></tr>
     ...
     <div class="panel panel-primary">
          <div class="panel-heading"><span class="zi zi_user"></span><span class="margin_l5">联系人信息</span></div>
          <div class="panel-body">
              <table class="table table-bordered">
