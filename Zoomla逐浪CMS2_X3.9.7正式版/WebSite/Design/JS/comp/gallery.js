define(function (require, exports, module) {
   ...
   + '</div>'//item end;
   + '</div>'
        + '<a class="carousel-control left" href="#@id" data-slide="prev"><span class="zi zi_forLeft" style="font-size:3em;"></span></a>'
        + '<a class="carousel-control right" href="#@id" data-slide="next"><span class="zi zi_forRight" style="font-size:3em;"></span></a></div>';
