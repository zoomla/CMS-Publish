define(function (require, exports, module) {
  ...
  + "<img src=\"{{item.TopImg}}\" onerror=\"this.src='/UploadFiles/nopic.svg';\"; />"
  + "</a>"
  ...
  + "</div>";
    html.s2 = "<div class=\"list_s2\">"
            ...
            + "<a href=\"/Content?Gid={{item.GeneralID}}\" target=\"_blank\"><img src=\"{{item.TopImg}}\" onerror=\"this.src='/UploadFiles/nopic.svg';\"; /></a>"
            + "</div>"
            + "<div class=\"item_info\">"
        ...
        + "<a href=\"Content?Gid={{item.GeneralID}}\" class=\"detail_a\">查看详情 <i class=\"zi zi_forRight\"></i></a>"
            + "</div></div></div>";
    html.s3 = "";
