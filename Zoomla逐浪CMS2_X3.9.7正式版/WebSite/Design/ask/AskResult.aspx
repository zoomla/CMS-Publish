...
<div class="bar bar-header bar-balanced navbar-fixed-top visible-xs">
    <a href="default.aspx" class="button"><i class="zi zi_alignleft"></i></a>
    <span class="title" runat="server" id="title_sp"></span>
    <a href="default.aspx#/tab/ask_view/<%:Mid %>" class="button"><i class="zi zi_fly"></i></a>
</div>
                ...
                <ItemTemplate>
                    <div class="item" id="item_<%#Eval("ID") %>">
                        ...
                        <div class="chart_wrap text-center" <%#ShowChartWrap() %>>
                            <button type="button" class="button button-small button-calm" onclick="showchart('<%#Eval("ID") %>','pie')"><i class="zi zi_chartpie"></i>饼状</button>
                            <button type="button" class="button button-small button-calm" onclick="showchart('<%#Eval("ID") %>','circle')"><i class="zi zi_dotcircle"></i>圆环</button>
                            <button type="button" class="button button-small button-calm" onclick="showchart('<%#Eval("ID") %>','bar')"><i class="zi zi_hockeypuck"></i>柱状</button>
                            <button type="button" class="button button-small button-calm" onclick="showchart('<%#Eval("ID") %>','line')"><i class="zi zi_squarefull"></i>条形</button>
                            <button type="button" class="button button-small button-assertive" onclick="hidechart('<%#Eval("ID") %>')"><i class="zi zi_times"></i>关闭</button>
