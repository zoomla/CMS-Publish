...
<ol class="breadcrumb">
    <li><a href="/User/Default">会员中心</a></li>
    <li><a href="/Design/User/">动力模块</a></li>
    <li class="active">资源管理</li>
</ol>
<div class="padding10" style="font-size:12px;padding-top:0px;position:relative;top:-10px;">
<div id="bread_div" style="display:none;"><i class="zi zi_list"></i> <asp:Label runat="server" ID="Bread_L" EnableViewState="false"></asp:Label></div>
    ...
    <asp:Repeater runat="server" ID="RPT" OnItemCommand="RPT_ItemCommand">
        <ItemTemplate>
            <div class="coltr">
                ...
                <span class="col20">
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Name") %>' CommandName="del" OnClientClick="return confirm('确定要删除吗?');"><i class="zi zi_trashalt"></i> 删除</asp:LinkButton>
                    <a href="/Plat/Doc/DownFile.aspx?DType=design&fname=<%#Eval("Name") %>&siteID=<%:SiteID %>" target="_blank"><i class="zi zi_download"></i> 下载</a>
                </span>
            </div>
        </ItemTemplate>
    </asp:Repeater>
...
<a href="javascript:;" id="upfile_btn" class="btn btn-info"><i class="zi zi_upload"></i> 上传文件</a>
<%--<a href="javascript:;" id="newdir_btn" class="btn btn-info"><i class="zi zi_folders"></i> 新文件夹</a>--%>
</div>
</asp:Content>
