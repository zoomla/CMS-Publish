<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ZoomLaCMS.Design.User.mbsite.Default" MasterPageFile="~/Design/Master/Empty2.Master" %>
                        ...
                        <ItemTemplate>
                            <li class="card list_item">
                                <div class="card-header">
                                    <span><i class="zi zi_mobile"></i><%#Eval("SiteName") %></span>
                                ...
                                <div class="card-footer text-cen">
                                    <a href="/design/mobile/default.aspx?id=<%#Eval("ID") %>" class="btn btn-info"><i class="zi zi_paintbrush"></i> 设计</a>
                                    <a href="/design/mobile/addsite.aspx?id=<%#Eval("ID") %>" class="btn btn-info"><i class="zi zi_cog"></i> 配置</a>
                                </div>
                            </li>
                        </ItemTemplate>
                    </asp:Repeater>
