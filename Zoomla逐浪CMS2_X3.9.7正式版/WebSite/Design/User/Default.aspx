...
<li><a href="<%=ZoomLa.BLL.SafeSC.RawUrl %>">控制中心</a></li>
...
<a runat="server" id="sitecfg_a" href="#" class="btn btn-info"><i class="zi zi_cogs"></i>站点配置</a>
<div class="btn-group">
<button type="button" class="btn btn-info" onClick="ChangeSite();"><i class="zi zi_list"></i>切换站点</button>
...
<a href="Content/List.aspx?SiteID=<%:SiteID %>" class="btn btn-primary"><i class="zi zi_pencilalt"></i>内容管理</a>
<a href="#" class="btn btn-primary"><i class="zi zi_userplus"></i>用户升级</a>
<asp:LinkButton runat="server" ID="DownSite_Btn" class="btn btn-primary" OnClick="DownSite_Btn_Click" OnClientClick="return downSite();"><i class="zi zi_download"></i> 全站下载</asp:LinkButton>
</div>
</div>
...
<li class="pull-right"><a href="/design/"><i class="zi zi_eye"></i> 浏览</a></li>
<li class="pull-right"><a href="/design/"><i class="zi zi_pencilalt"></i> 设计</a></li>
</ul>
<!-- Tab panes -->
...
<ItemTemplate>
<a class="option_style" href="/Design/PreView.aspx?ID=<%#Eval("Guid") %>" target="_blank"><i class="zi zi_eye"></i>预览</a>
<a class="option_style" href="PageInfo.aspx?ID=<%#Eval("Guid") %>"><i class="zi zi_cog"></i>配置</a>
<a class="option_style" href="/Design/?ID=<%#Eval("Guid") %>" target="_blank"><i class="zi zi_paintbrush"></i>设计</a>
...
<div class="panel-heading">
    <i class="zi zi_tasks"></i> H5场景 
    <a href="/design/h5/" target="_blank" class="btn btn-sm btn-info"><i class="zi zi_pencilalt"></i> 前往设计</a>
    <a href="PubList.aspx" class="btn btn-sm btn-info"><i class="zi zi_clone" ></i> 互动信息</a>
</div>
...
<td><%#Eval("CDate","{0:yyyy年MM月dd日 HH:mm}") %></td>
<td>
<a class="option_style" href="/Design/h5/preview.aspx?id=<%#Eval("Guid") %>" target="_blank" ><i class="zi zi_eye"></i>预览</a>
<a class="option_style" href="/design/h5/?ID=<%#Eval("Guid") %>" target="_blank"><i class="zi zi_paintbrush"></i>设计</a>
<a class="option_style" href="PubList.aspx?H5ID=<%#Eval("Guid") %>" ><i class="zi zi_clone" ></i>互动</a>
<asp:LinkButton runat="server" CssClass="option_style" CommandName="del2" CommandArgument='<%#Eval("ID") %>' OnClientClick="return confirm('确定要删除吗');"><i class="zi zi_trashalt" title="删除"></i>删除</asp:LinkButton>
</td>
</tr>
</ItemTemplate>
...
<div class="panel panel-default">
<div class="panel-heading"><i class="zi zi_questioncircle"></i> 问卷之星 <a href="/design/ask/default.aspx#/tab/ask_add" target="_blank" class="btn btn-sm btn-info"><i class="zi zi_plus"></i> 新建问卷</a></div>
...
<td>
<a href="/design/ask/default.aspx#/tab/ask_view/<%#Eval("ID") %> " target="_blank"><i class="zi zi_eye"></i>预览</a>
<a href="/design/ask/default.aspx#/tab/ask_qlist/<%#Eval("ID") %>"><i class="zi zi_edit"></i> 编辑</a>
<a href="javascript:;" onclick="DelAskFun('<%#Eval("ID") %>');"><i class="zi zi_trashalt"></i> 删除</a>
</td>
<td></td>
</tr>
</ItemTemplate>
...
<div class="panel-heading"><i class="zi zi_thead"></i>快捷菜单</div>
<div class="panel-body padding0">
<ul class="list-unstyled" id="shortcut_ul">
<li onclick="location='/Design/?SiteID=<%:SiteID %>';"><i class="zi zi_paintbrush"></i>修改站点</li>
<li onclick="location='Content/List.aspx?SiteID=<%:SiteID %>'"><i class="zi zi_gift"></i>内容管理</li>
<li style="border-right: none;" onclick="location='ResList.aspx?SiteID=<%:SiteID %>';"><i class="zi zi_desktop"></i>资源管理</li>
<li onclick="location='Node/NodeList.aspx?SiteID=<%:SiteID %>';"><i class="zi zi_listol"></i>节点管理</li>
<li><i class="zi zi_eye"></i>站点信息</li>
<li style="border-right: none;"><i class="zi zi_lightbulb"></i>查看帮助</li>
</ul>
</div>
