        ...
        <div id="tools">
            ...
            <div id="context-menu">
                <ul id="context-ul" class="dropdown-menu" role="menu">
                    <li data-cmd="edit"><a><i class="zi zi_pencilalt"></i> 修改</a></li>
   <%--             <li data-cmd="cut"><a><i class="zi zi_cut"></i> 剪切</a></li>
                    <li data-cmd="paste"><a><i class="zi zi_paste"></i> 粘贴</a></li>--%>
                    <li data-cmd="copy"><a><i class="zi zi_copy"></i> 复制</a></li>
                    <li class="divider"></li>
                    <li data-cmd="common"><a tabindex="-1"><i class="zi zi_thead"></i> 通用属性</a></li>
                    <li class="divider" style="height:1px;"></li>
                    <li data-cmd="remove"><a><i class="zi zi_trashalt"></i> 移除</a></li>
                </ul>
            </div>
            <div id="toolsmenu_div" class="btn-group" style="position: absolute;display:none;">
                <a href="javascript:;" class="btn btn-default" title="增加层级" onclick="tools.up();"><i class="zi zi_arrowUp"></i></a>
                <a href="javascript:;" class="btn btn-default" title="降低导级" onclick="tools.down();"><i class="zi zi_arrowDown"></i></a>
                <a href="javascript:;" class="btn btn-default" title="绑定行为" onclick="tools.bind();"><i class="zi zi_link"></i></a>
                <a href="javascript:;" class="btn btn-danger"  title="移除组件" onclick="tools.del();"><i class="zi_trashalt"></i></a>
            </div>
            <div id="diagBody">
