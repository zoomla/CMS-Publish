<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ZoomLaCMS.Design.mobile._default" EnableViewState="false" ValidateRequest="false" MasterPageFile="~/Design/Master/Empty.Master" %>
...
<li><a href="/Class_13/Default.aspx"><i class="zi zi_shoppingbag"></i> 服务商城</a></li>
<li><a href="http://www.z01.com/mtv/"><i class="zi zi_film"></i> 免费教程</a></li>
<li><a href="/User/Default1.aspx"><i class="zi zi_useralt"></i> 会员中心</a></li>
<li><a href="/wxshare.aspx"><i class="zi zi_sitemap"></i> 分享推广</a></li>
</ul>
</div><!-- /.navbar-collapse -->
</div><!-- /.container-fluid -->
</nav>
...
<div runat="server" id="btns_wrap" visible="false" class="com_edit">
    <div id="view_btn" class="btnlink" onclick="tools.changeMode();"><i class="zi zi_eye"></i></div>
</div>
