          ...
          <ul>
            <li class="card list_item" ng-repeat="item in list track by $index">
              <div class="card-header">
                  ...
                  <a href="javascript:;" ng-click="del(item.id);" class="button button-fill button-danger"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i> 删除</a>
              </div>
              <div class="card-content">
                <div class="card-content-inner">
                    ...
                    <i class="zi zi_pencilalt zi_2x" zico="笔黑"></i>
                    <div>
                        <span>编辑</span>
                    </div>
                </div>
