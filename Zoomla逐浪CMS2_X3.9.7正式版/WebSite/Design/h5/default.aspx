<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ZoomLaCMS.Design.h5._default" MasterPageFile="~/Design/Master/Empty.Master" %>
...
<div id="slist_div" runat="server" visible="false">
    <div class="listbody">
        <div class="alert alert-info margin_b2px listbody_alert">
            ...
            <div class="btn-group">
                <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-expanded="false">创建场景 <i class="zi zi_caretsquaredown"></i></button>
    ...
    <script>
        $(function(){
            //插入新建场景按钮
            var addtlp ="<li title='点击新建场景' onclick='ShowComDiag(\"/Design/mbh5/AddScence.aspx?device=pc\", \"新建场景\");'><div class='imgdiv'><i class='zi zi_plusSquareblack'></i></div><span><strong>创建新场景</strong></span></li>";
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="/design/user/" target="_blank"><i class="zi zi_useralt"></i></a></li>
   <%--             <li class="active cmd_page"><a href="javascript:;"><i class="zi zi_paste"></i> 场景设置<span class="sr-only">(current)</span></a></li>--%>
                <li class="cmd_addpage">
                    <a href="javascript:;"><i class="zi zi_plus"></i> 新场景</a>
                    <ul class="create_ul">
                ...
                <li class="pop_title" data-pop="进入门户开发"><a href="/design"><i class="zi zi_desktop"></i></a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li><a href="javascript:;" onclick="if (confirm('要保存当前修改吗')) { PreSave(); }"><i class="zi zi_save"></i></a></li>
                <li><a href="/h5/<%:pageMod.ID %>" target="_blank"><i class="zi zi_laptop"></i> PC预览</a></li>
                <li><a href="javascript:;" id="preview_btn"><i class="zi zi_mobile"></i> 手机预览</a></li>
                <li><a href="http://doc.z01.com/help/" target="_blank"><i class="zi zi_questioncircle"></i></a></li>
            </ul>
        </div>
    </div>
</nav>
    ...
    <div class="mainpane">
        <div class="mobile" id="mobile_div">
             ...
             <div class="sidebar sidebar_left" style="left:-30px;" id="toolsmenu_div">
                <a href="javascript:;" class="btn btn-sm btn-default cmd_addcomp" title="增加组件"><i class="zi zi_objectungroup"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-default" title="组件靠前" onclick="tools.up();"><i class="zi zi_backward"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-default" title="组件置后" onclick="tools.down();"><i class="zi zi_forward"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-default" title="动画动作" onclick="tools.animate();"><i class="zi zi_fly"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-default" title="修改组件" onclick="tools.edit();"><i class="zi zi_pencilalt"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-default" title="通用属性" onclick="tools.common();"><i class="zi zi_thead"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-default" title="绑定行为" onclick="tools.bind();"><i class="zi zi_link"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-danger" title="移除组件" onclick="tools.del();"><i class="zi zi_trashalt"></i></a>
            </div>
            <iframe id="design_ifr" scrolling="no"></iframe>
            <div class="sidebar">
                <a href="javascript:;" class="btn btn-sm btn-default" title="上一页" onclick="scence.switch('pre');"><i class="zi zi_arrowUp"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-default" title="下一页" onclick="scence.switch('next');"><i class="zi zi_arrowDown"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-default" title="预览动画" onclick="scence.preview();"><i class="zi zi_eye"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-default" title="背景" onclick="diy_bk.set();"><i class="zi zi_image"></i></a>
                <div class="side_menu" id="diy_bk_body" style="display:none;">
                    <a href="javascript:;" class="item cmd_addbk"><i class="zi zi_sync"></i> <span>更换</span></a>
                    <a href="javascript:;" class="item cut" onclick="diy_bk.cut();"><i class="zi zi_cut"></i> <span>裁剪</span></a>
                    <a href="javascript:;" class="item" onclick="diy_bk.del();"><i class="zi zi_trashalt"></i> <span>删除</span></a>
                    <a href="javascript:;" class="item text-center" onclick="diy_bk.close();"><i class="zi zi_times"></i> <span>关闭</span></a>
                </div>
                <a href="javascript:;" class="btn btn-sm btn-default" title="资源" onclick="scence.setres();"><i class="zi zi_tmDelicious"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-default cmd_music" title="音乐"><i class="zi zi_music"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-default cmd_conf" title="场景设置"><i class="zi zi_cog"></i></a>
            <%--    <a href="javascript:;" title="特效"><i class="zi zi_magic"></i></a>--%>
            </div>
        </div>
    </div>
    <div class="rpane right">
        ...
        <div class="tab_pane">
            <div class="tab_head text-center">
                <a href="javascript:;" class="btn btn-sm btn-info" title="详情" onclick="scence.domonpage();"><i class="zi zi_tasks"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-primary" title="新建" onclick="scence.add();"><i class="zi zi_plus"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-warning" title="复制" onclick="scence.copy_page()"><i class="zi zi_copy"></i></a>
                <a href="javascript:;" class="btn btn-sm btn-danger" title="删除" onclick="scence.del();"><i class="zi zi_trashalt"></i></a>
<%--                <a href="javascripot:;" class="btn btn-sm btn-info disabled" title="复制"><i class="zi zi_copy"></i></a>--%>
            </div>
...
var scence={
    ...
    $body:$("#page_ul"),
    stlp:'<li data-id="@id" id="li_@id" onclick="scence.switch(@id);"><span class="page_num"><span>@_index</span></span><span class="page_handler"><i class="zi zi_arrowsalt"></i></span><input class="page_name" type="text" value="@title" onchange="scence.change(@id,this);"></li>',
