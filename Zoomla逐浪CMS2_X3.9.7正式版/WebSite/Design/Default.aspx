    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="cmd_labellist"><a href="javascript:;"><i class="zi zi_flag"></i> 组件</a></li>
                <li><a href="/Design/User/" target="_blank"><i class="zi zi_useralt"></i></a></li>
                <li class="active cmd_page"><a href="javascript:;"><i class="zi zi_paste"></i> 页面设置<span class="sr-only">(current)</span></a></li>
                <li class="cmd_addpage"><a href="javascript:;"><i class="zi zi_plus"></i> 新页面</a></li>
                <li><a href="/Design/h5/default.aspx" id="mobile_btn" target="_blank" title="进入手机制作"><i class="zi zi_mobile"></i></a></li>
                <li><a href="javascript:;" id="cfg_btn"><i class="zi zi_cog"></i></a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
			    <li><a href="javascript:;">当前方案:<asp:Label runat="server" ID="TlpName_L" ForeColor="Red"></asp:Label></a></li>
                <li><a href="#" title="访问站点" target="_blank" runat="server" id="domain_a"><i class="zi zi_link"></i></a></li>
                <li><a href="javascript:;" title="保存" onclick="if (confirm('要保存当前修改吗')) { PreSave(); }"><i class="zi zi_save"></i></a></li>
                <li><a href="javascript:;" onclick="PreView();"><i class="zi zi_laptop"></i>预览</a></li>
                <li><a href="http://doc.z01.com/help/" target="_blank" title="帮助"><i class="zi zi_questioncircle"></i></a></li>
            </ul>
        </div>
    </div>
</nav>
<div class="left-bar menu-collapsed-wrapper">
    <ul class="left-bar-items menu-collapsed">
        <li class="left-bar-item cmd_addbk" title="设置背景" data-cmd="addbk">
             <i class="zi zi_squareBook" style="color:#F8A239;padding-left:2px;"></i><span class="fontsp">设置背景</span>
        </li>
        <li class="left-bar-item cmd_addcomp" style="color:#3797EA;" title="添加组件" data-cmd="addcomp">
             <i class="zi zi_pluscircle" style="padding-left: 1px;"></i><span class="fontsp">添加组件</span>
        </li>
        <li class="left-bar-item cmd_addlabel"><i class="zi zi_flag"></i><span class="fontsp">引入功能</span></li>
        <li class="left-bar-item cmd_addhtml" data-cmd="addhtml" title="插入Html">
           <i class="zi zi_code" style="color: #60BC57; padding-left: 2px;"></i><span class="fontsp">Html</span>
        </li>
        <li class="left-bar-item cmd_tlpshop" data-cmd="tlpshop" title="模板市场">
            <i class="zi zi_shoppingcart" style="color:#D0427C;padding-right:1px;"></i><span class="fontsp">模板市场</span>
        </li>
        <li class="left-bar-item" title="模板市场">
            <a href="h5/"><i class="zi zi_mobilealt" style="color:#D0427C;padding-right:1px;"></i><span class="fontsp">微站场景</span></a>
        </li>
         <%-- <li class="left-bar-item disabled">
            <i class="zi zi_clouduploadalt"></i><span class="fontsp">上传资源</span>
        </li>--%>
    </ul>
    <div></div>
</div>
<div style="right: 84px; top: 72px;" class="candrag rootcomp-toolbar slide-right custom-position">
    <div class="header">
        <div class="drag-zone">
            <i class="zi zi_lightbulb" title="提示"></i>
            <i class="zi zi_bars" title="拖动"></i>
            <i class="zi zi_times" title="关闭" onclick="$('.rootcomp-toolbar').hide();"></i>
        </div>
    </div>
    <div class="sperator"></div>
    <div class="inner button-grid">
        <i class="button disabled zi zi_copy"></i>
        <i class="button disabled zi zi_paste"></i>
        <i class="button disabled zi zi_fileEdit"></i>
        <i class="button disabled zi zi_trashalt"></i>
    </div>
    <div class="sperator"></div>
    <div class="inner button-grid">
        <i class="button zi zi_indent" title="对齐"></i>
        <i class="button zi zi_alignleft" title="文字"></i>
    </div>
    <div class="sperator"></div>
    <div class="inner form">
        <i class="fontsp zi zi_fly" title="角度"></i>
...
function ShowIE()
{
    ...
    warndiag.title='<i class="zi zi_adjust"></i> 提示';
