        ...
        <ItemTemplate>
            <div class="mb_rlist">
                <div class="mb_rlist_t" style="max-height:200px;overflow-y:hidden;"><a href="/design/album/default.aspx?id=<%#Eval("ID") %>">
                    <img src="<%#Eval("photos","").Split('|')[0]%>" onerror="javascript:this.src='/UploadFiles/nopic.svg';"></a></div>
                <div class="mb_rlist_p">
                    <h3><a href="/design/album/default.aspx?id=<%#Eval("ID") %>"><%#Eval("AlbumName") %></a></h3>
                    <p class="text-center">
                        <span><i class="zi zi_clock"></i><%#Eval("CDate","{0:yyyy年MM月dd日 HH:mm}") %></span>
                    </p>
                    <p class="text-center">
                        <a class="btn btn-info" href="/design/album/default.aspx?id=<%#Eval("ID") %>"><i class="zi zi_paintbrush"></i> 设计</a>
                        <a class="btn btn-info" href="/design/album/mbview.aspx?id=<%#Eval("ID") %>"><i class="zi zi_globe"></i> 浏览</a>
                        <asp:LinkButton runat="server" CssClass="btn btn-warning" CommandName="del2" CommandArgument='<%#Eval("ID") %>' OnClientClick="return confirm('确定要删除吗');"><i class="zi zi_trashalt" title="删除"></i> 删除</asp:LinkButton>
                    </p>
                </div>
            </div>
        </ItemTemplate>
...
#shortcut_ul li .zi { padding-top:0;}
