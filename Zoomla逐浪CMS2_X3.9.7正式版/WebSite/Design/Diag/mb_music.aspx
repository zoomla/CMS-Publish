...
<div class="search">
    <div class="search_div">
        ...
        <i id="icon" class="zi zi_search"></i>
        ...
        <asp:Repeater runat="server" ID="RPT" EnableViewState="false">
            <ItemTemplate>
                <div class="music_item">
                    ...
                    <div class="choose"><i class="zi zi_check"></i></div>
                </div>
            </ItemTemplate>
        </asp:Repeater>
...
<%--<div class="btn_div">
    <a href="javascript:;"><i class="zi zi_times" onclick="CloseSelf();"></i></a>
    <a href="javascript:;"><i class="zi zi_check" onclick="setMusic();"></i></a>
</div>--%>
