...
<table class="table table-bordered table-striped">
    ...
    <tr><td>选项<br /><a href="javascript:;" class="btn btn-info" ng-click="add();"><i class="zi zi_plus"></i></a></td><td>
        <table class="table table-bordered">
            <tr ng-repeat="item in model.dataMod.list track by $index">
                ...
                <td><a href="javascript:;" title="删除" class="btn btn-info" ng-click="del(item);"><i class="zi zi_minus"></i></a></td>
            </tr>
        </table>
                   </td></tr>
