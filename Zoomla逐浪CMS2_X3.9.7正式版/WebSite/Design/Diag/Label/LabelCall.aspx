<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LabelCall.aspx.cs" Inherits="ZoomLaCMS.Design.Diag.Label.LabelCall" MasterPageFile="~/Common/Master/Empty2.master" ValidateRequest="false" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div>
        <ul class="nav nav-tabs top_opbar" style="margin-bottom:0px;border-bottom:none;">
            ...
            <li class="nav-item" style="padding-top:5px;padding-left:30px;">
                <asp:TextBox runat="server" ID="Alias_T" placeholder="请输入别名" CssClass="form-control text_md"></asp:TextBox>
                <asp:Button Visible="false" runat="server" ID="Design_Btn" Text="确定引入" OnClick="Design_Btn_Click" OnClientClick="return SubCheck();" CssClass="btn btn-outline-info" />
                <asp:Button Visible="false" runat="server" ID="Save_Btn" Text="保存修改" OnClick="Save_Btn_Click" OnClientClick="return SubCheck();" CssClass="btn btn-outline-info"/>
            </li>
        </ul>
