<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageDesign.aspx.cs" Inherits="ZoomLaCMS.Design.SPage.PageDesign" EnableViewState="false" ValidateRequest="false" MasterPageFile="~/Design/Master/Empty2.Master" %>
<asp:Content runat="server" ContentPlaceHolderID="head">
<title>智能设计-<%Call.Label("{$SiteName/}"); %></title>
<%=pageMod.PageRes %>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
<div class="btn-group-vertical" style="position: fixed; left: 20px; top: 20px; z-index: 9999;">
<a href="Default.aspx?id=<%:Mid %>" class="btn btn-default" title="返回布局"><i class="zi zi_pencilalt zi_2x"></i></a>
<a href="<%=pageMod.ViewUrl %>" class="btn btn-default" title="预览" target="_blank"><i class="zi zi_eye zi_2x"></i></a>
<a href="javascript:;" onclick="ShowComDiag('AddPage.aspx?ID=<%:Mid %>','页面配置');" class="btn btn-default" title="配置"><i class="zi zi_cog zi_2x"></i></a>
</div>
...
<script src="/JS/Controls/ZL_Array.js?version=<%:ZoomLa.BLL.BLLCommon.Version_JS %>"></script>
<script src="/JS/Controls/ZL_Dialog.js?version=<%:ZoomLa.BLL.BLLCommon.Version_JS %>"></script>
