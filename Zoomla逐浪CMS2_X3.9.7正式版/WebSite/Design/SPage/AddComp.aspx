<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddComp.aspx.cs" Inherits="ZoomLaCMS.Design.SPage.AddComp" MasterPageFile="~/Design/Master/Empty.Master" %>
...
.list-group-item .left .zi {color: #9C9C9C; font-size: 50px;}
