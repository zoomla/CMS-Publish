...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item"><a href="VersionList.aspx">教材列表</a></li>
...
<div class="input-group" >
	<div class="input-group">
	  ...
	  <asp:Label runat="server" ID="PNode_L" CssClass="form-control  disabled" Text="未指定" disabled="disabled" />
	  
	  <div class="input-group-prepend">
		<span class="input-group-text">上传人</span
	  </div>
	  <asp:Label runat="server" ID="Inputer_L" CssClass="form-control" disabled="disabled" />
	</div>
...
<table class="table table-bordered table-striped">
	<tr><td style="width:120px;">版本名称：</td><td>
		<asp:TextBox runat="server" ID="VName_T" CssClass="form-control" />
	...
	<tr><td>版本时间：</td><td><asp:TextBox runat="server" ID="VTime_T" CssClass="form-control" onfocus="WdatePicker({dateFmt:'yyyy'})"/></td></tr>
	<tr><td>册序：</td><td>
		
		
		
		<div class="input-group mb-3">
		  <asp:TextBox runat="server" ID="Volume_T" CssClass="form-control w_10rem" />
		  <div runat="server" id="btnlist" class="input-group-append">
	...
	<tr><td>标价：</td><td><asp:TextBox runat="server" ID="Price_T" CssClass="form-control float" Text="0.00"/></td></tr>
    <tr id="Chapter_Tr" runat="server"><td>章(单元)名称：</td><td><asp:TextBox runat="server" ID="Chapter_T" CssClass="form-control"/></td></tr>
    <tbody id="Section_Body" runat="server">
	    <tr><td>节名称：</td><td><asp:TextBox runat="server" ID="SectionName_T" CssClass="form-control"/></td></tr>
	    <tr><td>课名称：</td><td><asp:TextBox runat="server" ID="CourseName_T" CssClass="form-control"/></td></tr>
	    <tr><td>知识点：</td><td>
		    <div class="d-inline" id="Examkeyword"></div>
	...
	<tr><td></td><td>
		<asp:Button runat="server" ID="Save_Btn" CssClass="btn btn-info" Text="确定" OnClick="Save_Btn_Click" />
		<a href="VersionList.aspx" class="btn btn-outline-info">返回</a>
	</td></tr>
</table>
</div>
</asp:Content>
...
$(function () {
    ...
    //科目改变时初始化知识点
	var oNodeID = "";
	$("#NodeTree ul li").addClass("dropdown-item");
	$("#NodeTree ul").hide();
