...
<asp:Content runat="server" ContentPlaceHolderID="Content">
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="操作">
			<ItemTemplate>
                <a class="option_style" href="AddVersion.aspx?pid=<%#Eval("ID") %>"><i class="zi zi_plus"></i>添加</a>
                <a class="option_style" href="AddVersion.aspx?id=<%#Eval("ID") %>"><i class="zi zi_pencil" title="修改"></i>修改</a>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        ...
        var trTlp = '<tr data-id="@ID" data-pid="@Pid" data-child="@Child" data-layer="@layer" title="双击打开"><td class="VID">@ID</td><td><a href="AddVersion.aspx?id=@ID"><fun>getLayer("@layer","@Child")</fun>@VersionName</a></td><td>@VersionTime</td><td>@GradeName</td><td>@NodeName</td><td>@Volume</td><td>@Chapter</td><td>@SectionName</td><td>@CourseName</td>'
            ...
            + '<a class="option_style" href="AddVersion.aspx?pid=@ID"><i class="zi zi_plus"></i>添加</a><a class="option_style" href="AddVersion.aspx?id=@ID"><i class="zi zi_pencilalt" title="修改"></i>修改</a><a class="option_style" href="javacript:;" onclick="del(this);"><i class="zi zi_trashalt" title="删除"></i>删除</a></td></tr>';
        //获取数据
        var getlist = function (obj, pid, isappend) {//需要添加的行
            ...
            $.post("VersionList.aspx", { "action": "getlist", "pid": pid }, function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    var tlp = "";
                    if (data[i].Pid == 0) {
                        tlp = '<tr data-id="@ID" data-pid="@Pid" data-child="@Child" data-layer="@layer" title="双击打开"><td class="VID">@ID</td><td>@VersionName</td><td></td><td></td><td></td><td></td><td></td><td><a class="option_style" href="AddVersion.aspx?pid=@ID"><i class="zi zi_plus"></i>添加</a><a class="option_style" href="AddVersion.aspx?id=@ID"><i class="zi zi_pencilalt" title="修改"></i>修改</a><a class="option_style" href="javacript:;" onclick="del(this);"><i class="zi zi_trashalt" title="删除"></i>删除</a></td></tr>';
                    }
                    else
                    {
                        if (data[i].PPid == 0)
                        {
                            tlp = '<tr data-id="@ID" data-pid="@Pid" data-child="@Child" data-layer="@layer" title="双击打开"><td class="VID">@ID</td><td></td><td>@Chapter</td><fun>getMove(@Pid,@OrderID)</fun></td><td></td><td></td><td></td><td></td><td><a class="option_style" href="AddVersion.aspx?pid=@ID"><i class="zi zi_plus"></i>添加</a><a class="option_style" href="AddVersion.aspx?id=@ID"><i class="zi zi_pencilalt" title="修改"></i>修改</a><a class="option_style" href="javacript:;" onclick="del(this);"><i class="zi zi_trashalt" title="删除"></i>删除</a></td></tr>';
                        }
                        else
                        {
                            tlp = '<tr data-id="@ID" data-pid="@Pid" data-child="@Child" data-layer="@layer" title="双击打开"><td class="VID">@ID</td><td></td><td></td><td>@SectionName</td><td>@CourseName</td><td>@Knows</td><td><fun>getMove(@Pid,@OrderID)</fun></td><td><a class="option_style" href="AddVersion.aspx?id=@ID"><i class="zi zi_pencilalt" title="修改"></i>修改</a><a class="option_style" href="javacript:;" onclick="del(this);"><i class="zi zi_trashalt" title="删除"></i>删除</a></td></tr>';
                        }
                    }
    ...
    function MoveUp(data) {
        ...
        $.post('', { action: "move", oid: $(tr).find(".VID").text() + "," + oldid, nid: $(prev).find(".VID").text() + "," + noid }, function (data) {
	        if (data == "true") {
    ...
    function MoveDown(data) {
        ...
        $.post('', { action: "move", oid: $(tr).find(".VID").text() + "," + $(tr).find("[name=Order_hid]").val(), nid: $(next).find(".VID").text() + "," + noid }, function (data) {
            if (data == "true") {
                $(tr).find("[name=Order_hid]").val(noid);
