        ...
        <ItemTemplate>
            <div class="panel panel-default" style="margin-bottom: 10px;">
                ...
                <div class="panel-footer">
                    <a href="QuestView?ID=<%#Eval("p_id") %>" target="_blank"><i class="zi zi_checkcircle"></i>查看解析</a>
                 <%--   <a href="#" class="disabled"><i class="zi zi_clouddownloadalt"></i>下载</a>--%>
                    <a href="javascript:;" <%#GetIsContain()?"style='display:none;'":"" %> class="cart_op addQid" data-type="<%#Eval("p_type") %>" data-qid="<%#Eval("p_id") %>"><i class="zi zi_pluscircle"></i>试题篮</a>
                    <a href="javascript:;" <%#GetIsContain()?"":"style='display:none;'" %> class="cart_op removeQid" data-type="<%#Eval("p_type") %>" data-qid="<%#Eval("p_id") %>"><i class="zi zi_minuscircle">试题篮(已加入试题篮)</i></a>
