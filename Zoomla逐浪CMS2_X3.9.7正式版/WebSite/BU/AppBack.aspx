...
<style type="text/css">
    .user_login{margin-top:20%;display:none;}
    .user_login li{margin-top:15px;position:relative;}
    .user_login li .zi{position:absolute;margin-left:8px;margin-top:8px;}
    .user_login li .form-control{padding-left:28px;}
</style>
...
<h3><span class="zi zi_sync"></span>请在这里完成注册绑定</h3>
<ul class="list-unstyled">
	<li>
		<i class="zi zi_useralt"></i>
		<asp:TextBox ID="UserName_T" placeholder="输入会员名" runat="server" CssClass="form-control text_300" />
	...
	<li>
		...
		<asp:TextBox ID="Email_T" placeholder="邮箱" CssClass="form-control text_300" runat="server" />
	...
	<li>
		...
		<asp:TextBox ID="UserPwd_T" placeholder="密码" runat="server" CssClass="form-control text_300" TextMode="Password" />
	...
	<li class="text-center">
		<asp:Button ID="Register_Btn" CssClass="btn btn-primary" runat="server" Text="提交信息" OnClick="Register_Click" ValidationGroup="Reg" />
	</li>
</ul>
</div>
</center>
