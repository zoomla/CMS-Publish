...
<div class="container u_form">
                           ...
                           <%-- <input type="radio" class="weui-check" name="regular_rad" id="x<%# Eval("ID") %>" value="<%#Eval("ID") %>" checked="checked">
                            ...
                            <div class="weui-cell__bd">
                                <p style="position:relative;bottom:-8px;"><%#Eval("Alias") %>
                                    (<span class="text-danger"><i class="zi zi_yensign"><%#Eval("Min","{0:F2}") %></i></span>)</p>
                            </div>
                        </label>
                </ItemTemplate>
            </asp:Repeater>
        ...
        <div class="weui-btn-area">
            <asp:Button runat="server" ID="Sure_Btn" OnClick="Sure_Btn_Click" class="btn btn-info btn-block" Text="确定充值" />
        </div>
   </div>
</asp:Content>
