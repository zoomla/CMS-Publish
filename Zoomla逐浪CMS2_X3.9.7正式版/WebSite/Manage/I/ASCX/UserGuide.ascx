...
<input type="text" ID="keyWord" class="form-control ascx_key" onkeydown="return ASCX.OnEnterSearch('<%:CustomerPageAction.customPath2+"User/UserManage.aspx?keyWord=" %>',this);" placeholder="搜索用户名或ID" />
