...
<li class="bg-primary"><span class="zi zi_forDown"></span>微信管理</li>
<li>
<p class="menu_tit laybtn"><i class="zi zi_circleDownBold"></i> 基本配置</p>
...
<li>
<p class="menu_tit laybtn"><i class="zi zi_pluscircle"></i>账户中心</p>
