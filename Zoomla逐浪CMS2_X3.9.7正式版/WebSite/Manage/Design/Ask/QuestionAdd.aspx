<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuestionAdd.aspx.cs" Inherits="ZoomLaCMS.Manage.Design.Ask.QuestionAdd" MasterPageFile="~/Manage/I/Index.Master" %>
...
<ol id="BreadNav" class="breadcrumb fixed-top">
    ...
    <li class="breadcrumb-item"><a href="QuestionList.aspx?AskID=<%:AskID %>">问题列表(<asp:Label runat="server" ID="AskTitle_T"></asp:Label>)</a></li>
    <li class="breadcrumb-item"><a href="<%=Request.RawUrl %>">问题管理</a></li>
</ol>
<div ng-app="APP" class="list_choice" ng-controller="APPCtrl">
        ...
        <div ng-switch="showByQType()">
            <div ng-switch-when="radio">
                ...
                <div style="text-align: center;" class="padding">
                    <button type="button" class="button button-positive button-outline" ng-click="addOption();"><i class="zi zi_plus"></i>添加新项</button></div>
            </div>
