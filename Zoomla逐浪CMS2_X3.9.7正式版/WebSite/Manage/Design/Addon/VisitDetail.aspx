...
<div>
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="操作">
            <ItemTemplate>
                <asp:LinkButton ID="del_btn" runat="server" CssClass="option_style" CommandName="del" CommandArgument='<%#Eval("ID") %>' OnClientClick="return confirm('确定删除这条浏览记录吗?')"><i class="zi zi_trashalt"></i>删除</asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</ZL:ExGridView>
