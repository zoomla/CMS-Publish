<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuestTieShow.aspx.cs" Inherits="ZoomLaCMS.Manage.Guest.GuestTieShow" ValidateRequest="false" MasterPageFile="~/Manage/I/Index.master" %>
...
<%=Call.SetBread(new Bread[] {
        ...
        new Bread("GuestCateMana.aspx?Type=1","贴吧版面"),
        new Bread("TieList.aspx?CateID="+CateID,"留言列表"),
        new Bread() {url="", text="贴子内容",addon="" }}
		)
    %>
	<div class="list_choice"></div>
	<div class="table-responsive sys_table">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:TextBox ID="txtTitle" CssClass="form-control m715-50" runat="server" data-show="edit" Style="display:none;"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:TextBox ID="CDate_T" runat="server" data-show="edit" Style="display:none" CssClass="form-control text_md" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <th>所得勋章</th>
        ...
        <tr>
            <th>操作</th>
            <td>
                <input type="button" id="edit_btn" onclick="EditFunc('edit');" data-show="onlyread" value="修改信息" class="btn btn-outline-info" />
                <asp:Button ID="Save_Btn" Style="display:none" CssClass="btn btn-outline-info" data-show="edit" OnClientClick="SaveTxtStyle()" runat="server" OnClick="Save_Btn_Click" Text="保存信息" />
                <input type="button" id="onlyread_btn" onclick="EditFunc('onlyread');" value="取消修改" class="btn btn-outline-danger" style="display:none;" data-show="edit" />
                <asp:Button ID="AddMedal_Btn" runat="server" CssClass="btn btn-outline-info" Text="颁发勋章" OnClick="AddMedal_Btn_Click" />
            </td>
        </tr>
    </table>
	</div>
    ...
    <ZL:ExGridView ID="Egv1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" PageSize="10" OnPageIndexChanging="Egv_PageIndexChanging" IsHoldState="false" OnRowCommand="Lnk_Click" AllowPaging="True" AllowSorting="True" OnRowEditing="Egv_RowEditing" CssClass="table table-striped table-bordered table-hover" EnableTheming="False" EnableModelValidation="True" EmptyDataText="该帖没有回复">
        <Columns>
            ...
            <asp:TemplateField HeaderText="回帖人">
                <ItemTemplate>
                    <a href="../User/UserInfo.aspx?id=<%# Eval("CUser")%>" title="点击查看用户详情"><%# GetUserName(Eval("CUser","{0}")) %></a>
                </ItemTemplate>
                <HeaderStyle />
            </asp:TemplateField>
	...
	<div class="table-responsive">
    <table class="table table-bordered" id="sleall">
        <tr>
            <td class="text-center">
                ...
                <asp:Button ID="Button1" runat="server" Text="返回" CssClass="btn btn-outline-info" OnClick="Button1_Click" />
