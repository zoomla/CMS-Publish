<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetCateOrder.aspx.cs" Inherits="ZoomLaCMS.Manage.Guest.SetCateOrder" MasterPageFile="~/Manage/I/index.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover text-center">
        ...
        <tr>
            <td colspan="5"><asp:Button ID="SaveOrder_B" OnClientClick="return SaveOrder()" CssClass="btn btn-outline-info" OnClick="SaveOrder_B_Click" runat="server" Text="保存排序" /></td>
        </tr>
    </table>
	</div>
