<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReplyList.aspx.cs" Inherits="ZoomLaCMS.Manage.WeiXin.ReplyList"  MasterPageFile="~/Manage/I/Index.master"  %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
	...
	<div class="list_choice table-responsive-md pr-1">
     <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" OnRowDataBound="EGV_RowDataBound" 
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="关键词" DataField="Filter" ItemStyle-CssClass="" />
            <asp:TemplateField HeaderText="类型" ItemStyle-CssClass="" >
                <ItemTemplate>
                    <%#GetMsgType() %>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="">
                <ItemTemplate>
                    <a href="AddReply.aspx?ID=<%#Eval("ID") %>&appid=<%=AppId %>"><i class="zi zi_pencilalt" title="修改"></i></a>
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="del2" OnClientClick="return confirm('确定要删除吗');" ><i class="zi zi_trashalt" title="删除"></i>删除</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
	...
	<div class="sysBtline">
<asp:Button runat="server" ID="BatDel_Btn" OnClick="BatDel_Btn_Click" Text="批量删除" CssClass="btn btn-outline-danger" OnClientClick="return confirm('确定要删除吗');" />
</div>
</asp:Content>
