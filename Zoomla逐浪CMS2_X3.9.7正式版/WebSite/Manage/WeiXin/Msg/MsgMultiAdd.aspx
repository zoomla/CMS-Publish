...
<%=Call.SetBread(new Bread[] {
   ...
   <%--     <button type="button" class="btn btn-outline-info" onclick="PreWxMsg()">预览效果</button>--%>
        <asp:Button runat="server" ID="Save_Btn" CssClass="btn btn-outline-info" Text="保存消息" OnClick="Save_Btn_Click" OnClientClick="return PreSave();" />
...
<%--        <asp:Button runat="server" ID="SaveNew_B" Visible="false" CssClass=btn btn-outline-info" Text="保存素材" OnClick="SaveNew_B_Click" OnClientClick="return PreSave();" />
        <asp:Button runat="server" ID="Update_Btn" CssClass="btn btn-outline-info" Visible="false" Text="保存素材" OnClientClick="return UpdateData()" OnClick="Update_Btn_Click" />--%>
		</div>
    ...
    <div id="selvedio_div" style="display:none;">
         <table class="table table-bordered table-striped">
             ...
             <tr><td colspan="2" class="text-center"><button type="button" class="btn btn-outline-info" onclick="SetVideoHtml()">确定</button> <button type="button" onclick="CloseVideoDiag()" class="btn btn-outline-info">取消</button></td></tr>
         </table>
    </div>
    <div id="seturl_div" style="display:none;">
        <table class="table table-bordered table-striped">
            ...
            <tr><td>链接地址:</td><td><input type="text" id="linkurl_t" class="form-control text_md" /></td></tr>
             <tr><td colspan="2" class="text-center"><button type="button" class="btn btn-outline-info" onclick="SetUrlHtml()">确定</button> <button type="button" onclick="urldiag.CloseModal();" class="btn btn-outline-info">取消</button></td></tr>            
        </table>
