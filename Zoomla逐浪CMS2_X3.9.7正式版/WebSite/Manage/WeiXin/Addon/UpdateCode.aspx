<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateCode.aspx.cs" Inherits="ZoomLaCMS.Manage.WeiXin.UpdateCode" MasterPageFile="~/Manage/I/Default.master" ValidateRequest="false" EnableViewStateMac="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <div id="HeadNav" runat="server">
        <table class="table table-bordered margin_b0px">
            <tr class="text-center">
                <td id="TabTitle1" runat="server" name="TabTitle1" class="titlemouseover">文本二维码
                </td>
                <td id="TabTitle2" runat="server" name="TabTitle2" class="titlemouseover">名片信息
                </td>
            </tr>
        </table>
    </div>
            ...
            <tr>
                <td>
                    <div class="input-group" style="width:399px;">
                        ...
                        <asp:DropDownList ID="Level" CssClass="form-control" runat="server" Width="80px">
                        ...
                        <asp:DropDownList ID="Version" CssClass="form-control" runat="server" Width="80px">
    ...
    <div id="crt2" runat="server">
        <table>
            <tr>
                ...
                <td>个人主页:</td>
                <td>
                    <input class="form-control" id="URL" runat="server"></td>
                <td>邮箱:</td>
                <td>
    ...
    <div id="ShowImgs" runat="server" visible="false" style="display: none;">
        <table class="table table-bordered">
            ...
            <tr>
                <td class="text-left">
                    <asp:TextBox TextMode="MultiLine" ID="TxtZoneCode" Rows="5" runat="server" class="form-control"></asp:TextBox><br />
                </td>
            </tr>
            <tr>
