                      ...
                      <asp:Repeater ID="WxApp_RPT" runat="server">
                          <ItemTemplate>
                                <li class="list-group-item wx_option" data-appid="<%#Eval("ID") %>">
                                    <a href="WxMaterial.aspx?type=news&appid=<%#Eval("ID") %>"><%#Eval("Alias") %> <span class="badge pull-right"><span class="zi zi_check"></span></span></a> 
                                </li>
                          </ItemTemplate>
                      </asp:Repeater>
                  </ul>
                ...
                <ItemTemplate>
                    <div class="col-md-2 listdata">
                        <div class="container-fluid infolist">
                            ...
                            <div class="option"><a href="javascript:;" onclick="DelMater(this,'<%#Eval("media_id") %>')"><span class="zi zi_trashalt"></span></a></div>
                        </div>
                    </div>
                </ItemTemplate>
                ...
                <ItemTemplate>
                    <div class="col-md-2 listdata">
                        <div class="container-fluid newslist" data-appid="<%#Eval("media_id") %>">
                            <div class="share_alt"><a href="<%#GetPreUrl() %>" target="_blank"><span class="zi zi_eye"></span></a>
<%--                                 <a href="MsgsSend.aspx?action=share&appid=<%=AppId %>&media_id=<%#Eval("media_id") %>" title="引用素材"><span class="zi zi_sharealt"></span></a> --%>
                            </div>
                            <asp:Literal ID="Infos_Li" runat="server" EnableViewState="false"></asp:Literal>
                            <div class="option">
                                <div><a href="MsgsSend.aspx?media_id=<%#Eval("media_id") %>&appid=<%=AppId %>" title="修改素材"><span class="zi zi_pencilalt"></span></a></div>
                                <div><a href="javascript:;" onclick="DelMater(this,'<%#Eval("media_id") %>')" title="删除素材"><span class="zi zi_trashalt"></span></a></div>
                            </div> 
                        </div>
                    </div>
                </ItemTemplate>
            ...
            <div id="Empty_Div" class="alert alert-info" style="display:none;" role="alert"><span class="zi zi_spinner zi_pulse"></span> 正在加载..</div>
        </div>
    </div>
  </div>
</div>
