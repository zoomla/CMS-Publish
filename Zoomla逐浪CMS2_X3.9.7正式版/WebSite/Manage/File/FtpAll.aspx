...
<%=Call.SetBread(new Bread[] {
    ...
    <asp:TemplateField HeaderText="操作">
      ...
      <ItemTemplate> 
          <a href='FtpConfig.aspx?DSId=<%# Eval("ID")%>'><i class="zi zi_pencilalt" title="修改"></i></a> 
          <a href="javascript:if(confirm('确定要删除?')) window.location.href='FtpAll.aspx?SId=<%# Eval("ID")%>';"><i class="zi zi_trashalt" title="删除"></i></a> 
          <%--<a href='ShowFtpFile.aspx?FId=<%# Eval("ID")%>'><i class="zi zi_magic" title="管理"></i>文件管理</a>--%>
      </ItemTemplate>
      <ItemStyle HorizontalAlign="Center" />
    </asp:TemplateField>
    </Columns>
