...
<ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="td_l">
            <ItemTemplate>
                <a class="option_style" href="/Plugins/Monitor/View.aspx?id=<%#Eval("ID") %>" target="_blank"><i class="zi zi_eye" title="预览监控"></i>进入监控</a>
                <a class="option_style" href="MonitorAdd.aspx?id=<%#Eval("ID") %>"><i class="zi zi_pencilalt" title="修改"></i></a>
