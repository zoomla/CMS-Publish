...
<div class="list_choice container-fluid table-responsive">
    ...
    <div id="addpart" class="col-12 col-md-8 col-lg-10">
        ...
        <table class="table table-striped table-bordered sys_table">
                        ...
                        <div id="ADContent" runat="server">
                            <div id="ADContent1" runat="server">
                                <table class="table table-striped table-bordered">
                                    <tr>
                                        <td class="w_6rem">图片上传:</td>
                                        <td>
                                            <div class="upload_wrap">
                                                <img id="Img_txtpic" onerror="this.style.display='none'"/>
                                                <asp:TextBox runat="server" ID="txt_txtpic" class="form-control" />
                                                <iframe src="/Common/fileupload.aspx?FieldName=txtpic" frameborder="0" scrolling="no"></iframe>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group" style="width: 560px;">
                                                ...
                                                <span class="input-group-append"><span class="input-group-text">高</span></span>
                            ...
                            <div id="ADContent4" runat="server" style="width:; height: 550px; border: 1px solid #ddd; display: none;">
            ...
            <tbody id="adv" >
                ...
                <tr>
                    <th>广告统计</th>
                    <td align="left">
					<label><asp:CheckBox ID="ChkCountView" runat="server" />
                        统计浏览数 浏览数：<asp:TextBox ID="TxtViews" MaxLength="5" CssClass="form-control text_md" runat="server" Width="50px" Text="0"></asp:TextBox></label> 
                    <label><asp:CheckBox ID="ChkCountClick" runat="server" />
                        统计点击数 点击数：<asp:TextBox ID="TxtClicks" CssClass="form-control text_md" runat="server" MaxLength="5" Width="50px" Text="0"></asp:TextBox></label>
                    </td>
                </tr>
                <tr>
                    <th>过期时间</th>
                ...
                <tr>
					...
					<div class="input-group">			  
					  ...
					  <div class="input-group-prepend">
						<span class="input-group-text" id="basic-addon1">元/天</span>
					  </div>
				</div>                        
                    </td>
                </tr>
                ...
                <table class="table table-striped table-bordered sys_table">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                <span class="input-group-prepend"><span class="input-group-text">宽</span></span>
                                <asp:TextBox ID="TxtImgWidth1" class="form-control text_md" MaxLength="5" Style="width: 80px" runat="server" placeholder="像素" />
                                <span class="input-group-prepend"><span class="input-group-text">高</span></span>
                                <asp:TextBox ID="TxtImgHeight1" class="form-control text_md" MaxLength="5" Style="width: 80px" runat="server" placeholder="像素" />
                            </div>
                        </td>
                    </tr>
                    <tr>
            ...
            <div id="Table2" runat="server" width="100%" style="display: none">
                <div class="panel panel-primary">
                    ...
                    <tr>
                        ...
                        <td style="color: red;">
                            <asp:TextBox ID="txtFlashPath1" class="form-control max20rem" runat="server"></asp:TextBox><asp:Label ID="LabFlashPath1" runat="server" Text="请选择上传路径！" Visible="False"></asp:Label>
                            <br />
