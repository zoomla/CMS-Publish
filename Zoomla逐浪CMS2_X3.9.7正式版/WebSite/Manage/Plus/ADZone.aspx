...
<div class="row sysRow list_choice">
    <table class="table table-bordered table-striped sys_table">
        ...
        <tr>
            <th><p>版位类型</p>
				<small class="text-muted">选择于此版位的广告类型</small>
			</th>
            <td>
            ...
            <td>
                <div class="input-group">
				  <div class="input-group-prepend">
					<span class="input-group-text">广告类型</span>
				  </div>
        ...
        <tr>
            <td><strong>版位状态：</strong><br />
              <small class="text-muted">活动版位才会在前台显示</small></td>
            <td>
                <asp:CheckBox ID="ChkActive" runat="server" Checked="true" Text="有效活动" /></td>
        </tr>
        <tr>
