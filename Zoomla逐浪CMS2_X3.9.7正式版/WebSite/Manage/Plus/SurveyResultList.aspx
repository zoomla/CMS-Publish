<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyResultList.aspx.cs" Inherits="ZoomLaCMS.Manage.Plus.SurveyResultList" MasterPageFile="~/Manage/I/Index.Master" %>
...
<%--        <asp:BoundField HeaderText="回答" DataField="Answer" />--%>
        ...
        <asp:BoundField HeaderText="来源" DataField="Source" ItemStyle-CssClass="" />
        <asp:TemplateField HeaderText="IP">
            <ItemTemplate>
                <%#ZoomLa.BLL.Helper.IPScaner.IPLocation(Eval("IP","")) %>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:BoundField DataField="CDate" DataFormatString="{0:yyyy年MM月dd日 HH:mm:ss}" HeaderText="创建时间" ItemStyle-CssClass=""/>
