...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
		...
		Call.GetHelp(52)+" <div class='pull-right down_ico' onclick='downtable();' style='cursor: pointer' title='导出数据表'> <i class='zi zi_download'></i> </div>"
		)
    %>
    <div class="container-fluid list_choice">
	<div class="row">
        <div class="col-12 col-sm-2">
            <div class="card NodeTree_left_ul">
