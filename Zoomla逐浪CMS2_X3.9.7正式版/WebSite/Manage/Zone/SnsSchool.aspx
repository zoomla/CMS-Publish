        ...
        <div id="sel_box" class="padding5">
            <div class="input-group pull-left" style="width: 630px">
                ...
                <span class="input-group-btn">
                    <asp:LinkButton ID="Search_Btn" runat="server" OnClick="Search_Btn_Click" CssClass="btn btn-primary"><span class="zi zi_search"></span></asp:LinkButton>
                </span>
            </div>
        ...
        <ZL:Repeater ID="RPT" runat="server" PageSize="10" PagePre="<tr><td><label class='allchk_l'><input type='checkbox' id='chkAll'/>全选</label></td><td colspan='8'><div class='text-center'>" PageEnd="</div></td></tr>" OnItemDataBound="RPT_ItemDataBound" OnItemCommand="RPT_ItemCommand">
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href="SchoolShow.aspx?id=<%#Eval("ID") %>" title="浏览"><i class="zi zi_eye"></i></a>
                        <a href="AddSchool.aspx?id=<%#Eval("ID") %>" title="修改"><i class="zi zi_pencilalt"></i></a>
                        <asp:LinkButton ID="LinkButton1" CommandName="del1" CommandArgument='<%# Eval("ID") %>' OnClientClick="return confirm('是否删除!')" ToolTip="删除" runat="server"><i class="zi zi_trashalt"></i></asp:LinkButton>
                        <a href="AddClassRoom.aspx?sid=<%#Eval("ID") %>"><i class="zi zi_plus"></i>添加班级</a>
                    </td>
                </tr>
            </ItemTemplate>
