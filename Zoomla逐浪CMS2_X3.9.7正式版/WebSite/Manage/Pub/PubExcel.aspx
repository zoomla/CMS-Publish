...
<asp:Content runat="server" ContentPlaceHolderID="head">
	...
	new Bread("",Resources.L.后台管理),
	new Bread("PubManage.aspx",Resources.L.互动模块),
	new Bread() {url="PubExcel.aspx", text=Resources.L.互动Excel配置 +"<a class='text-danger' onclick='Clear();' href='javascript:;'> ["+Resources.L.添加导出配置 +"]</a>",addon="" }}
	)
	%>
</asp:Content>
