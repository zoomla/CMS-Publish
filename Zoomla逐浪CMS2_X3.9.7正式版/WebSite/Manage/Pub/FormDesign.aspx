    ...
    <form id="form1" runat="server">
            ...
            <div class="row">
                <div id="formDesign_Div" class="col-12 col-md-6">
                    <div id="myform" style="height:850px;overflow-y:scroll;overflow-x:hidden;">
                        <div class="formtitle"><%=Resources.L.满意度调研 %></div>
                        <div class="formintro"></div>
                         <ul id="formul">
                        </ul>
                    </div>
                    <div style="text-align:center;margin-top:5px;">
                        <asp:Button runat="server" Text="<%$Resources:L,保存表单 %>" ID="SaveBtn" CssClass="btn btn-info" OnClick="SaveBtn_Click" OnClientClick="return SaveForm();"/>
                    </div>
                    <asp:HiddenField runat="server" ID="Json_Hid" />
                </div>
                <div id="tableAttr_Div" class="col-12 col-md-4">
                  <ul class="nav nav-tabs">
                     <li class="nav-item"><a class="nav-link active" href="#Tabs0" data-toggle="tab"><%=Resources.L.表单设置 %></a></li>
                     <li class="nav-item"><a class="nav-link" href="#Tabs1" data-toggle="tab"><%=Resources.L.添加组件 %></a></li>
                     <li class="nav-item"><a class="nav-link" href="#Tabs2" id="tabs2_href" data-toggle="tab"><%=Resources.L.编辑组件 %></a></li>
                  </ul>
                    <div class="tab-content">
                        <div id="Tabs0" class="tab-pane">
                            <div style="text-align:center;font-size:16px;"><%=Resources.L.表单设置 %></div>
							<div class="input-group mb-3 mt-3">
							  <div class="input-group-prepend">
								<span class="input-group-text"><%=Resources.L.标题 %></span>
							  </div>
							  <asp:TextBox runat="server" ID="Title_T" class="form-control" Text="<%$Resources:L,满意度调研 %>" onkeyup="$('.formtitle').text($(this).val());Getpy('Title_T','PubName_T'); " />
							</div>
							
							<div class="input-group mb-3 mt-3">
							  <div class="input-group-prepend">
								<span class="input-group-text"><%=Resources.L.表名 %>：ZL_Pub_</span>
							  </div>
							...
							<div class="input-group mb-3 mt-3">
							  <div class="input-group-prepend">
								<span class="input-group-text"><%=Resources.L.描述文字 %></span>
							  </div>
                        ...
                        <div id="Tabs1" class="tab-pane active">
                            <div>
                                 <p><label><%=Resources.L.表单组件 %></label></p>
                                <ul>
                                   <li class="conli" data-type="input_txt"><span><%=Resources.L.单行文本 %></span><span class="option option_input_txt"></span></li>
                                   <li class="conli" data-type="input_text"><span><%=Resources.L.多行文本 %></span><span class="option option_text"></span></li>
                                   <li class="conli" data-type="radio"><span><%=Resources.L.单选项 %></span><span class="option option_radio"></span></li>
                                   <li class="conli" data-type="checkbox"><span><%=Resources.L.多选项 %></span><span class="option option_checkbox"></span></li>
                                   <li class="conli" data-type="select"><span><%=Resources.L.下拉选项 %></span><span class="option option_select"></span></li>
                                   <li class="conli" data-type="img"><span><%=Resources.L.图片 %></span><span class="option option_img"></span></li>
                                   <li class="conli" data-type="str"><span><%=Resources.L.文字 %></span><span class="option option_input_txt"></span></li>
                                </ul>
                            </div>
                            <div style="clear:both;"></div>
                            <div>
                                <p><label><%=Resources.L.联系人组件 %></label></p>
                                <ul>
                        ...
                        <div id="Tabs2" class="tab-pane">
                            <div id="EditDiv"><!--组件属性设置区-->
                                <div id="title_div" class="edit_child_div">
                                    <p class="EditTitle"><%=Resources.L.标题 %></p>
                                    <input type="text" id="title_edit_txt" class="input large" data-sync="title"/>
                                </div>
                                <div id="intro_div" class="edit_child_div">
                                    <p class="EditTitle"><%=Resources.L.描述文字 %></p>
                                    <textarea id="intro_edit_txt" class="input large" data-sync="intro"></textarea>
                                </div>
                                <div id="required_div" class="edit_child_div">
                                    <p class="EditTitle"><%=Resources.L.必填设置 %></p>
                                    <div class="EditContent">
                                        <label><input type="checkbox" id="required_chk"/><%=Resources.L.这个是必填项 %></label>
                                    </div>
                                </div>
                                <div id="txt_size_div" class="edit_child_div">
                                    <p class="EditTitle"><%=Resources.L.组件大小 %></p>
                                    <div class="EditContent">
                                        <label><input name="txt_size" type="radio" value="small"  data-sync="txt_size"/><%=Resources.L.小尺寸 %></label>
                                        <label><input name="txt_size" type="radio" value="middle" data-sync="txt_size"/><%=Resources.L.标准尺寸 %></label>
                                        <label><input name="txt_size" type="radio" value="large"  data-sync="txt_size"/><%=Resources.L.大尺寸 %></label>
                                    </div>
                                </div>
                                <div id="txt_type_div" class="edit_child_div">
                                    <p class="EditTitle"><%=Resources.L.组件类型 %></p><div>
                                        <div class="EditContent">
                                            <label><input name="txt_type" type="radio" value="input"  data-sync="txt_type"/><%=Resources.L.单行文本 %></label>
                                            <label><input name="txt_type" type="radio" value="textarea" data-sync="txt_type"/><%=Resources.L.多行文本 %></label>
                                            <label><input name="txt_type" type="radio" value="html" data-sync="txt_type"/>HTML  <%=Resources.L.文本 %></label></div>
                                        </div>
                                </div>
                                <!--select-->
                                <div id="sel_option_div" class="edit_child_div">
                                     <p class="EditTitle"><%=Resources.L.单选选项配置 %></p>
                                     <div class="EditContent">
                                          <ul id="sel_option_ul">
                                ...
                                <div id="sel_type_div" class="edit_child_div">
                                    <p class="EditTitle"><%=Resources.L.组件类型 %></p>
                                      <div class="EditContent">
                                        <label><input type="radio" name="sel_type_Rad" value="radio"/><%=Resources.L.单选 %></label>
                                        <label><input type="radio" name="sel_type_Rad" value="checkbox"/><%=Resources.L.多选 %></label>
                                        <label><input type="radio" name="sel_type_Rad" value="select"/><%=Resources.L.下拉 %></label>
                                      </div>
                                </div>
                                <!--Img-->
                                <div id="imgsrc_div" class="edit_child_div">
                                    <p class="EditTitle"><%=Resources.L.图片链接 %></p>
                                    <div class="EditContent">
                                       <input type="text" class="input large" id="imgsrc_txt" />
                                    </div>
                                </div>
                                <div id="txtalign_div" class="edit_child_div">
                                    <p class="EditTitle"><%=Resources.L.文字对齐方式 %></p>
                                    <div class="EditContent">
                                        <label><input type="radio" name="txtalign_radio" value="left"/><%=Resources.L.左对齐 %></label>
                                        <label><input type="radio" name="txtalign_radio" value="center"/><%=Resources.L.居中 %></label>
                                        <label><input type="radio" name="txtalign_radio" value="right"/><%=Resources.L.右对齐 %></label>
                                    </div>
                                </div>
                            </div><!--EditDiv End-->
                        </div>
        ...
        <div id="tlpdiv" style="display:none;">
            <div id="input_txtTlp">
                    ...
                    <div class="removeli" title="关闭"><span class="zi zi_times removelibg"></span></div>
