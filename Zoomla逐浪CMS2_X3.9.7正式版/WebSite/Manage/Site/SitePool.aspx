<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SitePool.aspx.cs" Inherits="ZoomLaCMS.Manage.Site.SitePool" MasterPageFile="~/Manage/I/Index.master"%>
...
<!--<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>-->
    ...
    <div id="tab3">
                    ...
                    <ZL:ExGridView ID="EGV4" runat="server" DataSourceID="AppPoolData" AllowPaging="True" RowStyle-CssClass="tdbg" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="ID">
                                <ItemTemplate>
                                    <input type="checkbox" name="chk4" value="<%#Eval("Index") %>" class="mr-2" />
                                    <%#Eval("Index") %>
                                </ItemTemplate>
       ...
       <%--                         <EditItemTemplate>
                                    <asp:TextBox ID="EditAppPoolName" runat="server" Text='<%#Eval("AppPoolName") %>' Width="90%"  class="text-center" />
                                </EditItemTemplate>--%>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="状态">
                                <ItemTemplate>
                                    <%#(Eval("State") as string) == "Started" ? "<span class='text-success'>运行中</span>" : "<span class='text-danger'>已停止</span>" %>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="模式">
                                <ItemTemplate>
                                    <%#(Eval("Mode") as string) == "Classic" ? "<span class='text-success'>经典模式</span>" : "<span class='text-primary'>集成模式</span>" %>
                                </ItemTemplate>
                                <EditItemTemplate>
