<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DomTempMange.aspx.cs" Inherits="ZoomLaCMS.Manage.Site.DomTempMange" MasterPageFile="~/Manage/I/Index.master" %>
...
<ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" CssClass="table table-bordered table-striepd"
    OnRowCommand="EGV_RowCommand" OnPageIndexChanging="mimeEGV_PageIndexChanging" EnableTheming="False" EmptyDataText ="没有任何数据！" IsHoldState="false">
        <Columns>
