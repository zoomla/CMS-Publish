...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div id="site_main" class="list_choice">
        ...
        <div id="editDiv">
            <ul class="m_ul">
                <li><input type="button" value="编辑" onclick="dis('tab4');" class="btn btn-info" /></li>
            </ul>
        </div>
        <div id="tab4" class="row" style="display: none;">
            <div class="col-12 col-md-6">
                ...
                <table class="site_border  table table-striped table-bordered sys_table">
                    <tbody id="tabBody0" class="tabBody tab-pane active">
                        <tr>
                            <th class="w12rem_lg">超级管理员用户</th>
                            <td>
                                <asp:TextBox runat="server" ID="adminName" autocomplete="off" CssClass="form-control max20rem" />
                            </td>
                        </tr>
                        <tr>
                            <th class="w12rem_lg">超级管理员密码</th>
                            <td>
								<div class="input-group mb-3">
								   <asp:TextBox runat="server" ID="adminPasswd" TextMode="Password" autocomplete="off" CssClass="form-control max20rem" />
								  <div class="input-group-append">
									<asp:Button runat="server" ID="chkBtn" Text="校验用户" OnClick="chkBtn_Click" Style="margin-left: 2px;" CssClass="btn btn-outline-info" />
                                	<asp:Button runat="server" ID="logBtn" Text="保存用户" OnClick="logBtn_Click" Style="margin-left: 2px;" CssClass="btn btn-outline-info" />
								  </div>
								</div>
                            </td>
                        </tr>
                        <tr>
                            <th>预设 站 点 URL</th>
                            <td>
                                <asp:TextBox runat="server" ID="defaultIP" CssClass="form-control max20rem" /></td>
                        </tr>
                        <tr>
                            <th>模型ID</th>
                            <td>
                                <asp:TextBox runat="server" ID="modelIDT" CssClass="form-control max20rem" />&nbsp;&nbsp;<span class="text-success">注:IDC商城所绑定的模型ID</span></td>
                        </tr>
                        <tr>
                            <th>商 城 节 点</th>
                            <td>
                                <asp:TextBox runat="server" ID="nodeIDT" CssClass="form-control max20rem" />&nbsp;&nbsp;<span class="text-success">注:IDC商城所绑定的节点ID</span></td>
                        </tr>
                        <tr>
                            <th>新网代理用户</th>
                            <td>
                                <asp:TextBox runat="server" ID="newNetClientID" CssClass="form-control max20rem" />&nbsp;&nbsp;<span class="text-success">注:以agent开头的用户</span></td>
                        </tr>
                        <tr>
                            <th>新网API密码</th>
                            <td>
                                <asp:TextBox runat="server" ID="newNetApiPasswd" TextMode="Password"
                                    onkeypress="if(event.keyCode==13){EnterFunc2();}" autocomplete="off" CssClass="form-control max20rem" />&nbsp;&nbsp;<span class="text-success">注:在API设置中配置,非登录密码</span></td>
                        </tr>
                        <tr>
                            <th>DNS</th>
                            <td>
        ...
        <input type="radio" name="dnsOption" value="1" onclick="showDiv(1);" />自定义DNS</td>
                        ...
                        <tr>
                            <th>DNS文件目录</th>
                            <td>
                                <asp:TextBox runat="server" ID="dnsOutputPath" MaxLength="50" CssClass="form-control max20rem" /></td>
                        </tr>
                        <tr class="cdnsBody">
                            <th>DNS主服务器</th>
                            <td>
                                <asp:TextBox runat="server" ID="dns1" MaxLength="30" CssClass="form-control max20rem" /></td>
                        </tr>
                        <tr class="cdnsBody">
                            <th>DNS辅服务器</th>
                            <td><asp:TextBox runat="server" ID="dns2" MaxLength="30" CssClass="form-control max20rem" /></td>
                        </tr>
                    </tbody>
                    <tbody id="tabBody1" class="tabBody tab-pane padding5">
                        <tr>
                            <th class="w12rem_lg">二级域名</th>
                            <td><asp:TextBox runat="server" ID="tDomNameT" MaxLength="50" CssClass="form-control max20rem" /></td>
                        </tr>
                        <tr>
                            <th>自动创建数据库</th>
                            <td>
                                ...
                                </asp:RadioButtonList><span class="text-success">注:开启该项,允许用户创建站点时,自动生成对应数据库</span></td>
                        </tr>
                        <tr>
                            <th>数据库管理员帐号</th>
                            <td>
                                <asp:TextBox runat="server" ID="dbm_NameT" MaxLength="20" CssClass="form-control max20rem" /><br />
                                <span class="text-success">注:推荐使用SA帐号,或拥有master数据库管理的帐号</span></td>
                        </tr>
                        <tr>
                            <th>数据库管理员密码</th>
                            <td><asp:TextBox runat="server" ID="dbm_PasswdT" MaxLength="50" TextMode="Password" CssClass="form-control max20rem" /></td>
                        </tr>
                    </tbody>
                </table>
                <div class="text-center sysBtline">
                    <asp:Button runat="server" ID="saveBtn4" Text="保存配置" CssClass="btn btn-info" OnClick="saveBtn4_Click" />
                    <input type="button" value="取消" style="margin-left: 20px;" class="btn btn-outline-info" title="关闭编辑" onclick="dis('editDiv');" />
                </div>
            </div>
		<div class="tab col-12 col-md-6">
            <div >
            <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="nav-item"><a class="nav-link active" href="#Div3" aria-controls="home" role="tab" data-toggle="tab">显示</a></li>
            <li role="presentation" class="nav-item"><a class="nav-link" href="#Div4" aria-controls="profile" role="tab" data-toggle="tab">选中</a></li> 
            </ul>
            ...
            <p class="checkall0 allcheck"><label for="allChk">全选 </label><input type="checkbox" class="allChk ml-2" onclick="selectAllByName(this, 'ext100');"/></p>
            <ul id="Ul3">
            ...
            <p class="checkall1 allcheck"><label for="allChk2">全选 </label><input type="checkbox" id="Checkbox3" class="allChk ml-2" onclick="selectAllByName(this, 'ext101');"/></p>
            <ul id="Ul4">
            ...
            <div class="site_border" style="padding-left:20px;">
            <p class="checkall0 allcheck"><label for="allChk">全选</label><input type="checkbox" id="Checkbox1" class="allChk ml-2" onclick="selectAllByName(this, 'ext');"/></p>
            <ul id="Ul1">
            ...
            <p style="display: block; border-top: 1px solid #D5E0EF; width: 99%; *zoom: 1; overflow: hidden; *height: 1px; margin: 20px 0"></p>
            <p class="checkall1 allcheck"><label for="allChk2">全选</label><input type="checkbox" class="allChk ml-2" onclick="selectAllByName(this, 'ext2');"/></p>
            <ul id="Ul2">
