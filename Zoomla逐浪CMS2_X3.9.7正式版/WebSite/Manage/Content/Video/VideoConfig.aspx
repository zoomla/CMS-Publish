    ...
    <div class="video_main list_choice sys_video">    
      ...
      <h4><%=Resources.L.提示 %>!</h4>
          <p class="pl-5">
              ...
              <span runat="server" id="remind_sp"><%=Resources.L.下载提示 %></span>
                  <asp:Button runat="server" ID="getLoad" Text="<%$Resources:L,立即下载 %>" CssClass="btn btn-outline-info ml-1" OnClick="BDown_Click" />
          </p>
        ...
        <table class="table table-striped table-bordered sys_table">
            <tr>
                <th class="w12rem_lg"><%=Resources.L.视频默认目录 %></th>
                <td><asp:TextBox runat="server" ID="videoPath" CssClass="form-control max20rem" Text="/UploadFiles/video/"></asp:TextBox></td>
            </tr>
            <tr><td></td><td><asp:Button ID="SaveConfig" Text="<%$Resources:L,保存 %>" CssClass="btn btn-outline-info" runat="server" OnClick="SaveConfig_Click" /> </td></tr>
        </table>
    </div>
</asp:Content>
