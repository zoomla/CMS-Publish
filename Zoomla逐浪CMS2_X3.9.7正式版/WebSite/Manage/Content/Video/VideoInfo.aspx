...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title><%=Resources.L.视频信息 %></title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
<%=Call.SetBread(new Bread[] {
	new Bread("/{manage}/Content/ContentManage.aspx",Resources.L.内容管理),
	new Bread("",Resources.L.视频列表),
	new Bread() {url="", text=Resources.L.视频信息,addon="" }}
	)
%>
    ...
    <table class="table table-striped table-bordered table-hover sys_table">
        ...
        <tr>
            <td class="text-center" colspan="2">
                <asp:Button ID="SaveInfo_B" runat="server" Text="<%$Resources:L,保存 %>" CssClass="btn btn-info" OnClick="SaveInfo_B_Click" />
                <a href="VideoList.aspx" class="btn btn-outline-info"><%=Resources.L.返回 %></a>
            </td>
        </tr>
    </table>
	</div></div>
