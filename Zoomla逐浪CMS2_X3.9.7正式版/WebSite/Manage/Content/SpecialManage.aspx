...
<asp:Content runat="server" ContentPlaceHolderID="head">
    <title><%=Resources.L.专题列表 %></title>
	<%=Call.SetBread(new Bread[] {
		new Bread("/{manage}/Main.aspx",Resources.L.工作台),
        new Bread("/{manage}/Config/SiteInfo.aspx",Resources.L.系统设置),
        new Bread() {url="/{manage}/Content/SpecialManage.aspx", text=Resources.L.专题列表,addon="" }},
		Call.GetHelp(58)
		)
    %>
</asp:Content>
...
<div class="list_choice">
    <div id="noncate" class="divbox" style="display: none" runat="server"><font color="red"><%=Resources.L.暂时没有专题类别 %></font></div>
    <div id="catelist" runat="server">
        <table id="EGV" class="table table-striped table-bordered table-hover">
            <tr id="head_tr">
                <th scope="col">ID</th>
                <th scope="col"><%=Resources.L.专题名称 %></th>
                <th scope="col"><%=Resources.L.专题目录 %></th>
                <th scope="col"><%=Resources.L.专题描述 %></th>
                <th scope="col"><%=Resources.L.添加时间 %></th>
                <th scope="col"><%=Resources.L.操作 %></th>
            </tr>
            <tr id="gendir_tr" data-id="0">
                <td class="td_s">0</td><td><a href="javascript:;"><span class="zi zi_folderOpen"></span></a> <%=Resources.L.根 %></td><td></td><td></td><td></td>
                <td>
                    <a href='AddSpec.aspx?Action=Add&pid=0' class='option_style'><i class='zi zi_plus' title='添加'></i><%=Resources.L.子专题 %></a>
                    <a href='javascript:;' onclick='ShowOrder(0)' class='option_style' title='排序'><i class='zi zi_listol'></i><%=Resources.L.排序 %></a>
                </td>
            </tr>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>   
        ...
        var Temp = "<tr data-layer='@layer' data-pid='@pid' data-id='@id' onclick='LoadChilds(this,@id)'><td>@id</td><td>@layerhtml<img src='/Images/TreeLineImages/t.gif'><a href='SpecContent.aspx?SpecID=@id'><span class='@imgicon'></span></a> <a href='AddSpec.aspx?ID=@id'>@SpecName</a></td><td>@SpecDir</td><td>@SpecDesc</td><td>@CDate</td><td><a href='AddSpec.aspx?ID=@id' class='option_style'><i class='zi zi_pencilalt' title='修改'></i></a> <a href='AddSpec.aspx?Pid=@id' class='option_style'><i class='zi zi_plus' title='添加'></i><%=Resources.L.子专题 %></a> <a href='SpecContent.aspx?SpecID=@id' class='option_style'><i class='zi zi_alignjustify' title='内容'></i><%=Resources.L.内容 %></a> <a href='javascript:;' onclick='ShowOrder(@id)' class='option_style' title='排序'><i class='zi zi_listol'></i><%=Resources.L.排序 %></a> <a title='前台预览' href='/Special_@id/Default.aspx' target='_blank' class='option_style'><i class='zi zi_globe'></i><%=Resources.L.浏览 %></a> <a href='javascript:;' onclick='DelCofim(@id)' class='option_style'><i class='zi zi_trashalt' title='删除'></i><%=Resources.L.删除 %></a></td></tr>";
