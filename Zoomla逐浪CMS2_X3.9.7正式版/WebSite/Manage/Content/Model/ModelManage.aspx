...
<%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url="ModelManage.aspx?ModelType="+ModelType, text=bll.GetModelType(ModelType)+ Resources.L.管理 +"<a href='AddEditModel.aspx?ModelType="+ ModelType+"'>["+Resources.L.添加模型 +"]</a>",addon="" }},
		Call.GetHelp(10)
		)
%>
</asp:Content>
                ...
                <ItemTemplate>
					<div class="btn-group">
					  ...
					  <div class="dropdown-menu">
						<a href="ModelField.aspx?ModelID=<%#Eval("ModelID") %>&ModelType=<%:ModelType %>" class="dropdown-item"><i class="zi zi_columns"></i> <%=Resources.L.字段 %></a>
						...
						<a href="ModelData.aspx?ID=<%#Eval("ModelID") %>" class="dropdown-item"><i class="zi zi_database"></i> <%=Resources.L.数据 %></a>
					  </div>
					</div>
                </ItemTemplate>
            </asp:TemplateField>
