...
<%=Call.SetBread(new Bread[] {
	...
	new Bread() {url="/{manage}/Content/Collect/CollectionList.aspx", text=Resources.L.采集队列,addon="" }}
	)
%>
<div class="container-fluid pr-0">
<div class="row sysRow list_choice">
<table class="table table-bordered table-striped">
    <tr><td></td><td><%=Resources.L.项目名称 %></td><td><%=Resources.L.采集网站 %></td><td><%=Resources.L.执行时间 %></td></tr>
    ...
    <div class="sysBtline">
        <asp:Button runat="server" ID="Clear_Btn" OnClick="Clear_Btn_Click" OnClientClick="return confirm('确定要清空队列吗');" Text="<%$Resources:L,清空队列 %>" CssClass="btn btn-outline-danger" />
    </div>
</asp:Content>