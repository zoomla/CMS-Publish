...
<asp:Content runat="server" ContentPlaceHolderID="head"><title><%=Resources.L.统一检索 %></title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
<%=Call.SetBread(new Bread[] {
	new Bread("/{manage}/Main.aspx",Resources.L.工作台),
	new Bread("CollSite.aspx",Resources.L.采集检索),
	new Bread("",Resources.L.统一检索),
	new Bread() {url="/{manage}/Content/AddSites.aspx", text="<span class='text-danger'>["+ Resources.L.添加检索源+"]</span>",addon="" }}
	)
%>
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="操作">
			<ItemTemplate>
				...
				<asp:LinkButton ID="LinkButton1" runat="server" CommandName="Del2" CommandArgument='<%#Eval("ID") %>' OnClientClick="return confirm('你确定要删除吗!');" ToolTip="<%$Resources:L,删除 %>" ><i class="zi zi_trashalt" title="删除"></i><%=Resources.L.删除 %></asp:LinkButton>
			</ItemTemplate>
		</asp:TemplateField>
	</Columns>
...
<asp:Button runat="server" Text="<%$Resources:L,批量删除 %>" OnClientClick="return confirm('你确定要删除选中项吗!');" ToolTip="<%$Resources:L,批量删除 %>" CssClass="btn btn-outline-danger" OnClick="Unnamed_Click"/>
</asp:Content>
