...
<asp:Content runat="server" ContentPlaceHolderID="Content">
	<%=Call.SetBread(new Bread[] {
		...
		new Bread("/{manage}/Content/Collect/CollectionManage.aspx",Resources.L.项目管理),
        new Bread() {url="CollectionStep1.aspx", text="<span class='text-danger'>["+ Resources.L.添加采集项目+"]</span>",addon="" }},
		Call.GetHelp(95)
		)
    %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td>
                <asp:Button ID="btnDeleteAll" runat="server" OnClientClick="if(!IsSelectedId()){alert('请选择删除项');return false;}else{return confirm('你确定要将所有选择项删除吗？')}" Text="<%$Resources:L,批量删除%>" OnClick="btnDeleteAll_Click" class="btn btn-outline-danger" />
            </td>
        </tr>
    </table>
</asp:Content>
