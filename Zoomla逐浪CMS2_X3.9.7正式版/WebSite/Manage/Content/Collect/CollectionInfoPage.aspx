...
<asp:Content ContentPlaceHolderID="head" Runat="Server"><title><%=Resources.L.采集配置字段设置 %></title></asp:Content>
        ...
        <tr>
            ...
            <td class="regextd" rowspan="2">
                <div class="input-group">
                    <span class="input-group-addon"><%=Resources.L.字段名 %></span>
                ...
                <div class="input-group">
                    <span class="input-group-addon"><%=Resources.L.元素类型 %></span>
                ...
                <div class="divide"><i class="zi zi_flag"></i><%=Resources.L.内容过滤 %></div>
                <div class="margin_t5">
                ...
                <div class="divide"><i class="fflag"></i> <%=Resources.L.值处理 %></div>
                <div class="margin_t5">
                    <asp:CheckBox runat="server" ID="Ruler_FirstImg_Chk" Text="仅取第一张图片,勾选该值后将不会使用下面的逻辑" />
                </div>
                <div class="input-group">
                    <span class="input-group-addon"><%=Resources.L.开始字符串 %></span>
                    <asp:TextBox runat="server" ID="Start_T" CssClass="form-control" />
                </div>
                <div class="input-group">
                    <span class="input-group-addon"><%=Resources.L.结束字符串 %></span>
                    <asp:TextBox runat="server" ID="End_T" CssClass="form-control" />
                </div>
                <div class="divide"><i class="zi zi_flag"></i> <%=Resources.L.信息提示 %></div>
                <div><asp:Label runat="server" ID="CurLink_L" Style="color: green;"></asp:Label></div>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Button CssClass="btn btn-primary" runat="server" ID="Save_Btn" OnClick="Save_Btn_Click" Text="<%$Resources:L,保存信息 %>"  />
				<input type="button" value="关闭窗口" class="btn btn-primary" onclick="parent.Close();" />
               <asp:Button runat="server" ID="Test_Btn"  class="btn btn-info pull-right" Text="<%$Resources:L,测试获取 %>" OnClick="Test_Btn_Click" ValidationGroup="Add" />
            </td>
            <td> </td>
        </tr>
    </table>
