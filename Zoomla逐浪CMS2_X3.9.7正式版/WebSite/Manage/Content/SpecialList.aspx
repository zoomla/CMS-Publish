<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecialList.aspx.cs" Inherits="ZoomLaCMS.Manage.Content.SpecialList" MasterPageFile="~/Manage/I/Index.master" %>
<asp:Content ContentPlaceHolderID="head" runat="Server">
    ...
    <style type="text/css">
        * { font-family: 'Microsoft YaHei';}
        ...
        .zi{margin-left:3px; margin-right:3px;}
    </style>
    <script type="text/javascript">
        function ShowChild() {
