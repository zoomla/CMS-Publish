            ...
            <table class="table table-striped table-bordered table-hover sys_table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td scope="col">
                            <asp:TextBox ID="TxtSpecName" onchange="CheckSpecName()" runat="server" class="form-control max20rem" />
                    ...
                    <tr><th>专题类型</th><td>
                        <label><input type="radio" name="cate_rad" value="0" checked="checked"/>内容</label>
                        <label><input type="radio" name="cate_rad" value="1"/>商城</label>
                                     </td></tr>
                    <tr class="tdbg">
