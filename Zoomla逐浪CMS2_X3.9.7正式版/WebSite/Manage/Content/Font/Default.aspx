                ...
                <div id="sel_box" class="padding5">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <asp:LinkButton runat="server" class="btn btn-default" ID="Search_Btn" OnClick="Search_Btn_Click"><i class="zi zi_search"></i></asp:LinkButton>
                        </span>
                    </div>
                </div>
            </ol>
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="td_l">
            <ItemTemplate>
                ...
                <a style="<%#ShowDownLoad() %>" href="<%#wrBll.Dir+"down.aspx?id="+Eval("ID") %>" target="_blank" class="option_style"><i class="zi zi_download"></i>下载</a>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</ZL:ExGridView>
