...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered sys_table">
                ...
                <table>
                    ...
                    <tr>
						...
						<div class="d-flex justify-content-start">
                            <input id="BtnSelectAll" onclick="SelectAll()" type="button" class="btn btn-info mr-1" value="选定所有节点" />
        ...
        <tr class="text-center">
            <td colspan="2">
                <asp:Button ID="EBtnBacthSet" class="btn btn-info" Text="执行批处理" OnClick="EBtnBacthSet_Click" runat="server" />
