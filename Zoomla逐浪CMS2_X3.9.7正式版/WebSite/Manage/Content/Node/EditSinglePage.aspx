...
<%--                    <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mt-2" >
        <tr>
            <td align="center">&nbsp; &nbsp;
			<asp:Button ID="EBtnSubmit" class="btn btn-info" Text="保存设置" OnClientClick="return EBtnS()" OnClick="EBtnSubmit_Click" runat="server" />&nbsp; &nbsp;
            <asp:Button ID="Cencel_B" runat="server" CssClass="btn btn-outline-info" Text="返回列表" OnClick="Cencel_B_Click" />
            </td>
        </tr>
    </table>
