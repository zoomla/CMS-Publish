<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddChart2.aspx.cs" Inherits="ZoomLaCMS.Manage.Content.ECharts.AddChart2" MasterPageFile="~/Manage/I/Index.master" ValidateRequest="false"%>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
        ...
        new Bread("AddChart.aspx","创建图表"),
        new Bread() {url="/{manage}/Content/ECharts/AddChart2.aspx?Type=bar&tag=", text="图表配置",addon="" }}
		)
    %>
        ...
        <div class="row">
            <div class="container-fluid" >
                ...
                <ul class="nav nav-tabs" role="tablist" id="mytab">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="#base_tb" aria-controls="base_tb" role="tab" data-toggle="tab">基本配置</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#data_tb" aria-controls="data_tb" role="tab" data-toggle="tab">数据编辑</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#code_tb" aria-controls="code_tb" role="tab" data-toggle="tab">查看代码</a></li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active table-responsive-md" role="tabpanel"  id="base_tb">
                        <table class="table table-bordered table-striped sys_table">
                           <tr><th scope="col" class="w12rem_lg">主标题</th><td scope="col"><asp:TextBox runat="server" CssClass="form-control text_300" ID="Title_T" placeholder="请输入标题" /></td></tr>
                           <tr><th>主标题超链接</th><td><asp:TextBox runat="server" CssClass="form-control text_300" ID="Link_T" Text="www.z01.com" /></td></tr>
                           <tr><th>注释说明</th><td><asp:TextBox runat="server" CssClass="form-control text_300" TextMode="MultiLine" Height="100" ID="SubTitle_T" placeholder="注释说明" /></td></tr>
                           <tr><th>标题位置水平</th><td>
                        ...
                        <div class="text-center"><button type="button" onclick="ShowTag('data_tb')" class="btn btn-info mb-2">下一步</button></div>
                    </div>
                    <div role="tabpanel" class="tab-pane" id="data_tb">
                        <div style="width:100%; height:500px;">

                        </div>
                        <div class="text-center margin_t5"><button type="button" onclick="ShowTag('base_tb')" class="btn btn-outline-info">上一步</button> <asp:Button runat="server" ID="Button1" OnClientClick="PreSave();" OnClick="Save_Btn_Click1" CssClass="btn btn-info" Text="保存图表"/>
                            <input type="button" value="预览图表" onclick="ReCreateImg()" class="btn btn-outline-info" /></div>
                    </div>
               ...
               <div class="mt-3" style="width:100%; height:500px; position:absolute; top:-9999px; left:20px; overflow:hidden;" id="excel1"></div>
            <div class="container-fluid margin_t10" id="PreImg" style="display:none;">
                <div class="card mt-1">
                  <div class="card-header">图表预览</div>
                  <div class="card-body">
