...
<asp:Content ContentPlaceHolderID="Content" runat="Server">
	<%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url="/{manage}/Content/CreateHtmlContent.aspx", text=Resources.L.生成发布,addon="" }}
		)
    %>
  <div class="Creat_tips list_choice">
    <div class="alert alert-info alert-dismissible fade show">
      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
      <h5><%=Resources.L.提示 %>：</h5>
            ...
            <td colspan="2">
                <div class="alert alert-info">
                    <span><strong><%=Resources.L.注意 %>：</strong></span>
                     <ul>
					 <li><%=Resources.L.CreateHC_note1 %></li>
					 <li><%=Resources.L.CreateHC_note2 %></li>
					 </ul>
                </div>
            </td>
          </tr>
