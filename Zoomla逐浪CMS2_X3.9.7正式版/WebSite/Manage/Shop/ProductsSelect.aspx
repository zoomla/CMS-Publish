<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductsSelect.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.ProductsSelect" MasterPageFile="~/Manage/I/Index.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="input-group" >
            ...
            <span class="input-group-btn">
                <asp:LinkButton runat="server" ID="BtnSearch" OnClick="BtnSearch_Click" class="btn btn-info"><i class="zi zi_search" zico="搜索"></i> 搜索商品</asp:LinkButton>
                <button type="button" class="btn btn-info" onclick="suresel();"><i class="zi zi_signinalt" zico="入口标志"></i> 确定选择</button>
            </span>
        </div>
    <div class="w-100">
        ...
        <asp:Repeater ID="RPT" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td><img src=" <%#getproimg()%>" class="img_3rem" /></td>
                    <td>
