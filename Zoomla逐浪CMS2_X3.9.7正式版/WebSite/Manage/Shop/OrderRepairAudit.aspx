...
<asp:Content ContentPlaceHolderID="head" runat="Server"><title><%=Resources.L.售后管理 %></title>
<%=Call.SetBread( new Bread[] {
	new Bread("ProductManage.aspx",Resources.L.商城管理),
	new Bread("OrderList.aspx",Resources.L.订单管理),
	new Bread(){url="OrderRepairAudit.aspx", text=Resources.L.返修单审核}
}) %>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <ul class="nav nav-tabs list_choice">
        <li class="nav-item"  id="nav_-100"><a class="nav-link"  href="OrderRepairAudit.aspx"><%=Resources.L.全部 %></a></li>
        <li class="nav-item" id="nav_0"><a class="nav-link" href="OrderRepairAudit.aspx?status=0"><%=Resources.L.未审核 %></a></li>
        <li class="nav-item" id="nav_99"><a class="nav-link" href="OrderRepairAudit.aspx?status=99"><%=Resources.L.已审核 %></a></li>
    </ul>
