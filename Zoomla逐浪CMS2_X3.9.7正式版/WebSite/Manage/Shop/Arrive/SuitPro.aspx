...
<asp:Content runat="server" ContentPlaceHolderID="head"><title><%=Resources.L.套装商品 %></title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div>
        <ol class="breadcrumb fixed-top">
            ...
            <li class="breadcrumb-item"><%=Resources.L.套装商品 %> <a href="SuitProAdd.aspx">[ <%=Resources.L.添加促销组合 %> ]</a></li>
...
<%--            <asp:TemplateField HeaderText="<%$Resources:L,类型 %>">
    ...
    <asp:Button runat="server" ID="batBtn" OnClick="batBtn_Click" Text="<%$Resources:L,批量删除 %>" class="btn btn-outline-danger" OnClientClick="return confirm('确定要删除选中吗');" />
	</div>
</asp:Content>
