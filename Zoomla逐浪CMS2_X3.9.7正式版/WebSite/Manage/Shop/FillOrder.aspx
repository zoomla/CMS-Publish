...
<asp:Content runat="server" ContentPlaceHolderID="head">
	...
	new Bread(){url="", text=Resources.L.补单}
}) %>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">

<div class="userlist table-responsive-md" id="userlist" runat="server">
    <ZL:ExGridView ID="EGV"  runat="server" AutoGenerateColumns="False" PageSize="20"  OnRowCommand="EGV_RowCommand" OnPageIndexChanging="EGV_PageIndexChanging" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="<%$Resources:L,操作 %>">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" CommandName="select" CommandArgument='<%#Eval("UserID") %>' runat="server"><i class="zi zi_plus" title="<%=Resources.L.选择会员 %>"></i><%=Resources.L.选择会员 %></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
...
<div class="shoplist table-responsive" id="shoplist" runat="server" visible="false">
    <ZL:ExGridView ID="EGV1"  runat="server" AutoGenerateColumns="False" PageSize="20"  OnRowCommand="EGV1_RowCommand" OnPageIndexChanging="EGV1_PageIndexChanging" 
        IsHoldState="false" AllowPaging="True" AllowSorting="True" CssClass="table table-striped table-bordered table-hover" EnableTheming="False" EnableModelValidation="True" EmptyDataText="<%$Resources:L,暂无相关信息 %> ！！">
        <PagerStyle HorizontalAlign="Center" />
        <RowStyle HorizontalAlign="Center" />
        <Columns>
...
<div id="orderinfo" class="orderinfo border table-responsive list_choice" runat="server" visible="false">
