...
<div class="container">
    ...
    <div class="prolist">
        <table class="table table-bordered table-striped">
            <tr><td class="td_l">商品编号</td><td>商品名称</td><td>数量</td><td>商品金额</td><td>商品单价</td></tr>
            <asp:Repeater runat="server" ID="RPT" EnableViewState="false">
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <%#Eval("ProName") %>
                            <%#ZoomLa.BLL.Helper.PageHelper.Aspx_GetHtml("/cart/comp/cart_present.aspx",GetDataItem()) %>
                        </td>
                        <td><%#Eval("ProNum") %></td>
        ...
        <div class="price_div">
            ...
            <div>
                ...
                <span class="sp_r"><strong><i class="zi zi_yensign"></i><asp:Label runat="server" ID="TotalMoney_L"/></strong></span>
            </div>
        </div>
        <div class="clearfix"></div>
