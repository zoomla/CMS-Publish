...
<ol id="BreadNav" class="breadcrumb navbar-fixed-top">
    ...
    <div class="pull-right">
        <asp:LinkButton runat="server" ID="SendMail_B" title="发送邮件" OnClientClick="return confirm('确定发送邮件吗？');" OnClick="SendMail_B_Click"><i class="zi zi_envelopeOpen fa-fw"></i></asp:LinkButton>
        <asp:LinkButton runat="server" ID="DownWord_B" title="下载Word文档" OnClick="DownWord_B_Click"><i class="zi zi_word"></i></asp:LinkButton>
        <asp:LinkButton runat="server" ID="ExportExcel_B" title="导出Excel表格" OnClick="ExportExcel_B_Click"><i class="zi zi_fileExcel fa-fw" ></i></asp:LinkButton>
        <a href="javascript:;" onclick="showiserver('<%:Mid %>');"><i class="zi zi_msgchat"></i> 服务记录<%=GetiServerNum() %></a>
    </div>
</ol>
...
<div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane" id="Selled">
            <div class="panel panel-primary">
                <div class="panel-heading"><i class="zi zi_forLeft" zico="左指"></i> 退款操作</div>
...
<table class="table table-striped table-bordered table-hover">
        <tr>
            <td><i class="zi zi_fileLine"></i> 详记</td>
            <td>
       ...
       <tr>
            <td><i class="zi zi_pencilalt"></i> 内注</td>
           <td>
                <div>
