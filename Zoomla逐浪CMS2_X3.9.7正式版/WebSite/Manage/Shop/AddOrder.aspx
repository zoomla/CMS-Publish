...
<title><%=Resources.L.创建订单 %></title>
<%=Call.SetBread( new Bread[] {
	new Bread("ProductManage.aspx",Resources.L.商城管理),
	new Bread("OrderList.aspx",Resources.L.订单管理),
	new Bread(){url="AddOrder.aspx", text=Resources.L.添加订单}
}) %>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <ul class="nav nav-tabs list_choice">
        <li class="nav-item"><a class="nav-link active show" href="#Tabs0" data-toggle="tab"><%=Resources.L.订单信息 %></a></li>
        <li class="nav-item"><a class="nav-link" href="#Tabs1" data-toggle="tab"><%=Resources.L.物流信息 %></a></li>
        <li class="nav-item"><a class="nav-link" href="#Tabs2" data-toggle="tab"><%=Resources.L.商品信息 %></a></li>
    </ul>
    <div class="tab-content panel-body container-fluid pr-0 sys_table mb-5">
        <div id="Tabs0" class="tab-pane active row sysRow table-responsive-md">
            <table class="table table-striped table-bordered">
                <tr>
                    <th scope="col" class="w12rem_lg"><%=Resources.L.选择用户 %></th>
                    <td scope="col">
                        <div class="input-group">
                            <ZL:TextBox CssClass="form-control max20rem" runat="server" ID="UserID_T" AllowEmpty="false"></ZL:TextBox>
                            <span class="input-group-append">
                                <input type="button" class="btn btn-info" style="width: 101px;" value="<%=Resources.L.选择用户 %>" onclick="SelUser();" /></span>
                        </div>
                ...
                <tr>
                    <th><%=Resources.L.订单类型 %></th>
                    <td>
                        <asp:DropDownList ID="OrderType_DP" runat="server" CssClass="form-control max20rem">
                            <asp:ListItem Text="<%$Resources:L,普通订单 %>" Value="0"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,酒店 %>" Value="1"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,航班 %>" Value="2"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,旅游 %>" Value="3"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,积分 %>" Value="4"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,域名 %>" Value="5"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,Purse充值 %>" Value="6"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,云购订单 %>" Value="8"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,代购 %>" Value="10"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <th><%=Resources.L.所属店铺 %><span class="text-danger">*</span></th>
                    <td>
                        <ZL:TextBox ID="StoreID_T" runat="server" AllowEmpty="false" Text="0" CssClass="form-control max20rem"></ZL:TextBox>
						
						<small class="text-muted"><%=Resources.L.所属店铺_notice %></small>
					</td>
                </tr>
                <tr>
                    <th><%=Resources.L.应付金额 %></th>
                    <td>
						<div class="input-group">
							...
							<span class="input-group-text"><%=Resources.L.元 %></span>
							</div>
						</div>
                    </td>
                </tr>
                <tr>
                    <th><%=Resources.L.邮费 %></th>
                    <td>
						<div class="input-group">
                ...
                <tr>
                    <th><%=Resources.L.索要发票 %></th>
                    <td>
                        <input type="checkbox" runat="server" id="Invoiceneeds" class="switchChk" /></td>
                </tr>
                <tr>
                    <th><%=Resources.L.订单状态 %></th>
                    <td>
                        <asp:DropDownList ID="OrderStatus_DP" runat="server" CssClass="form-control max20rem">
                            <asp:ListItem Text="<%$Resources:L,正常 %>" Value="0"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,管理员确认 %>" Value="1"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,订单已付款 %>" Value="90"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,卖家确认发货 %>" Value="91"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,买家确认收货 %>" Value="99"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,申请退款 %>" Value="-1"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,拒绝退款 %>" Value="-2"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,确认退款 %>" Value="-3"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,拒绝订单 %>" Value="-5"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,回收站 %>" Value="-99"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <th><%=Resources.L.支付方式 %></th>
                    <td>
                        <asp:RadioButtonList runat="server" ID="PayType_Rad" RepeatDirection="Horizontal">
                            <asp:ListItem Text="<%$Resources:L,正常 %>" Selected="True" Value="0"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,需预付 %>" Value="1"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,代理商代收 %>" Value="2"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
                    <th><%=Resources.L.支付状态 %></th>
                    <td>
                        <asp:RadioButtonList runat="server" ID="Pay_Rad" RepeatDirection="Horizontal">
                            <asp:ListItem Text="<%$Resources:L,未支付 %>" Selected="True" Value="0"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,已支付 %>" Value="1"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,收款首款 %>" Value="2"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,退款中 %>" Value="-1"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,已退款 %>" Value="-2"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
                    <th><%=Resources.L.物流状态 %></th>
                    <td>
                        <asp:RadioButtonList runat="server" ID="Exp_Rad" RepeatDirection="Horizontal">
                            <asp:ListItem Text="<%$Resources:L,未发货 %>" Selected="True" Value="0"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,已发货 %>" Value="1"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,已收货 %>" Value="2"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,已退货 %>" Value="-1"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:L,确认退货 %>" Value="-2"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
                    <th><%=Resources.L.订单备注 %></th>
                    <td>
        ...
        <div id="Tabs2" class="tab-pane row sysRow table-responsive-md">
            <table class="table table-striped table-bordered">
                <tr id="pro_tr">
                    <th scope="col" class="w12rem_lg"><%=Resources.L.订单商品 %> :</th>
                    <td scope="col">
                        <input type="button" class="btn btn-outline-info" value="<%=Resources.L.关联商品 %>" onclick="OpenSelect();" />
                        <table id="pro_table" hidden class="table table-striped table-bordered" style="margin:10px auto;">
                            <tr>
                                <td>ID</td>
                                <td><%=Resources.L.商品图片 %></td>
                                <td><%=Resources.L.商品名称 %></td>
                                <td><%=Resources.L.零售价 %></td>
                                <td><%=Resources.L.数量 %></td>
    ...
    <div class="text-center Conent_fix">
        <asp:Button ID="Submit_B" runat="server" CssClass="btn btn-info" Text="<%$Resources:L,添加订单 %>" OnClientClick="return checkSubmit();" OnClick="Submit_B_Click" /></div>
