...
<table  class="table table-striped table-bordered table-hover sys_table">
                ...
                <tr>
                    <th scope="col" class="w12rem_lg">支付名称</th>
                    <td scope="col">
                        <asp:TextBox ID="DDLPayName" runat="server" class="form-control max20rem"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th>商户ID</th>
                ...
                <tr id="trMD5Key" runat="server" >
                    <th>安全校验码</th>
                    <td>
                        <asp:TextBox ID="TxtMD5Key" runat="server" class="form-control max20rem" />
                ...
                <tr>
                    <th>卖家Email</th>
                    <td>
                        <asp:TextBox ID="TxtSellerEmail" runat="server" class="form-control max20rem" />
                        <small class="text-danger">* 必填:如支付宝接口必须填写卖家Email,否则会出错</small>
                ...
                <tr>
                    ...
                    <td>
						...
						<asp:TextBox ID="TxtRate" runat="server" Text="0" class="form-control max20rem" />
						  <div class="input-group-append">
							<span class="input-group-text tips">%</span>
						  </div>
						</div>
                         <small class="text-danger">*此项如设置为10%，则商户得到90%</small>
