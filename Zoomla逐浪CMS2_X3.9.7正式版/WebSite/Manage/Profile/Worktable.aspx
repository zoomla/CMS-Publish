...
<ul>
	<li><a href="../Config/SiteInfo.aspx"><i class="zi zi_cog" zico="齿轮"></i></a><a href="../Config/SiteInfo.aspx" target="_self"><%=Resources.L.快速配置 %></a></li>
	<li><a href="../Content/Model/ModelManage.aspx?ModelType=1"><i class="zi zi_puzzlepiece" zico="拼图"></i></a><a href="../Content/ModelManage.aspx?ModelType=1" target="_self"><%=Resources.L.模型构造 %></a></li>
	<li><a href="../Content/Node/NodeManage.aspx"><i class="zi zi_university" zico="政府标志"></i></a><a href="../Content/NodeManage.aspx" target="_self"><%=Resources.L.节点规划 %></a></li>
	<li><a href="../Template/LabelManage.aspx"><i class="zi zi_tags" zico="标签组"></i></a><a href="../Template/LabelManage.aspx" target="_self"><%=Resources.L.标签调用 %></a></li>
	<li><a href="../Template/TemplateSet.aspx"><i class="zi zi_cubes" zico="立方组合"></i></a><a href="../Template/TemplateSet.aspx" target="_self"><%=Resources.L.模板列表 %></a></li>
	...
	<li><a href="../WorkFlow/OAConfig.aspx"><i class="zi zi_write"></i></a><a href="../WorkFlow/OAConfig.aspx" target="_self">OA <%=Resources.L.办公 %></a></li>
	<li><a href="../WeiXin/home.aspx"><i class="zi zi_tmWeixin"></i></a><a href="../WeiXin/home.aspx" target="_self"><%=Resources.L.微信开发 %></a></li>
	<li><a href="../Content/ECharts/AddChart.aspx"><i class="zi zi_database" zico="数据库"></i></a><a href="../Content/ECharts/AddChart.aspx" target="_self"><%=Resources.L.数据舆情 %></a></li>
	...
	<li><a href="../iServer/BiServer.aspx"><i class="zi zi_coffee" zico="咖啡"></i></a><a href="../iServer/BiServer.aspx" target="_self"><%=Resources.L.客户服务 %></a></li>		
</ul>
</div>
</div>
</div>
...
<a href="javascript:;" class="btn btn-light btn-sm" onclick="shoptabs('goods');"><i class="zi zi_shoppingbag" zico="购物袋"></i> <%=Resources.L.商品 %></a>
<a href="javascript:;" class="btn btn-light btn-sm" onclick="shoptabs('order');"><i class="zi zi_shoppingcart" zico="购物车黑"></i> <%=Resources.L.订单 %></a>
<a href="javascript:;" class="btn btn-light btn-sm" onclick="shoptabs('pay');"><i class="zi zi_dollarSign" zico="美元符号"></i> <%=Resources.L.流水 %></a>
...
<table class="table table-bordered table-striped table-sm">
	<tr><td>ID</td><td><%=Resources.L.用户名 %></td><td><%=Resources.L.下单时间 %></td><td><%=Resources.L.订单状态 %></td><td><%=Resources.L.付款状态 %></td></tr>
...
<div class="panel-body pay" style="display: none;">
	<table class="table table-bordered table-striped table-sm">
		<tr><td>ID</td><td><%=Resources.L.用户名 %></td><td><%=Resources.L.支付平台 %></td><td><%=Resources.L.交易时间 %></td><td><%=Resources.L.金额 %></td></tr>
...
<div class="card">
<div class="card-header  pb-1">
<a href="javascript:;" class="btn btn-light btn-sm" onclick="showPanel('sche');"><i class="zi zi_clock" zico="时钟"></i> <%=Resources.L.任务计划 %></a>
...
<table class="table table-bordered table-striped table-sm">
	<tr><td><%=Resources.L.任务 %> ID</td><td><%=Resources.L.任务名称 %></td><td><%=Resources.L.创建时间 %></td><td><%=Resources.L.执行计划 %></td><td><%=Resources.L.结果 %></td></tr>
...
<small class="text-muted">
<a href="../Content/Schedule/Default.aspx" class="btn btn-outline-info"><%=Resources.L.任务中心 %></a>
<a href="../Content/Schedule/AddSche.aspx" class="btn btn-outline-info"><%=Resources.L.添加任务 %></a>
<a href="../Content/Schedule/ScheLogList.aspx" class="btn btn-outline-info"><%=Resources.L.执行记录 %></a>
</small>
</div>
