<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThumbConfig.aspx.cs" Inherits="ZoomLaCMS.Manage.Config.ThumbConfig" MasterPageFile="~/Manage/I/Index.master" %>
...
<%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url="", text="缩略图配置",addon="" }},
		Call.GetHelp(6)
		)
    %>
...
<div class="row sysRow">	
	<ul class="nav nav-tabs list_choice" role="tablist">
		<li class="nav-item active"><a class="nav-link active show" href="#water_div" data-toggle="tab">水印配置</a></li>
        <li class="nav-item"><a class="nav-link" href="#thumb_div" data-toggle="tab">缩图配置</a></li>
    </ul>
    <div class="tab-content col-12 table_box">
        <div class="tab-pane active table-responsive" id="water_div">
            <table class="table table-striped table-bordered table-hover sys_table">
                <tr>
                    <th class="w12rem_lg">是否开启水印</th>
                    <td><input runat="server" type="checkbox" id="Isuse" class="switchChk"/></td>
                </tr>
                <tr>
					<th>开启用户水印</th>
					<td><input runat="server" type="checkbox" id="EnableUserWater" class="switchChk"/></td>
			   </tr>
                <tr>
                    <th>传图水印</th>
                    <td>
                ...
                <tr>
                    <th>编图水印<span class="rd_red">*</span></th>
                    <td>
                        <ul data-id="txt_waterimgs" id="ul_waterimgs" class="preview_img_ul"></ul>
                        <div class="clearfix"></div>
                        <div>
                            <input type="button" class="btn btn-light btn-sm" value="选择图片" onclick="SelPic({ 'name': 'waterimgs' });" /><br />
							<small class="text-muted">编辑内容时图片编辑时读取的水印</small>
                ...
                <tr>
                    <th><%:lang.LF("水印图片透明度") %></th>
                    <td>
						<div class="input-group">
						<asp:TextBox ID="iAlp" runat="server" CssClass="form-control max20rem"  />
						  <div class="input-group-append">
							<span class="input-group-text">%</span>
						  </div>
						</div>
						<small class="text-muted">0为完全透明，100为完全不透明</small>
                    </td>
                </tr>
                <tr>
                    <th><%:lang.LF("水印文字") %></th>
                    <td>
                        <asp:TextBox ID="waterWord" runat="server" CssClass="form-control max20rem" MaxLength="15" />
						<small class="text-muted">水印文字不宜超过15个字符</small>
                    </td>
                </tr>
                <tr>
                    <th><%:lang.LF("文字字体") %><br />
                    ...
                    <td>
                        <asp:DropDownList ID="WordType" CssClass="form-control max20rem" runat="server">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="WordStyle" CssClass="form-control max20rem" runat="server">
                ...
                <tr>
                    <th class="style3"><%:lang.LF("文字大小") %><br />
                    </th>
                    <td>
                        <asp:TextBox ID="WordSize" runat="server" CssClass="form-control max20rem" />
                    </td>
                </tr>
                <tr>
                    <th><%:lang.LF("文字颜色") %><br />
                    ...
                    <td>
						...
						<div class="input-group">
						<asp:TextBox ID="txt_dfg" CssClass="form-control max20rem" name="txt_dfg" runat="server" />
						  <div class="input-group-append">
							<img class="input-group-text" onclick="SelectColor(this,'txt_dfg');" src="/images/Rect.gif" align="absmiddle" style="border-width: 0px; cursor: pointer" />
						  </div>
						</div>
                    </td>
                </tr>
                <tr>
                    <th><%:lang.LF("坐标起点位置") %></th>
                    <td>
                        <asp:DropDownList ID="localP" runat="server" class="form-control max20rem">
            ...
            <table class="table table-striped table-bordered table-hover sys_table">
                <tr>
                    ...
                    <td>
						...
						<small class="text-muted">为0则忽略该条件</small>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="top_opbar text-center">
        <asp:Button ID="Save_Btn" runat="server" Text="保存设置" OnClick="Save_Btn_Click" class="btn btn-outline-info m-2" />
    </div>
    </div>
    </div>
