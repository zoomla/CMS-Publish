...
<asp:Content runat="server" ContentPlaceHolderID="Content">
	...
	<i class="zi zi_exclamationtriangle"></i>本操作将删除系统中的用户自定义表
	</div>
	<div class="container-fluid pr-0">
	<div class="row sysRow table-responsive-md">
    <table class="table table-striped table-bordered table-hover sys_table">
        <tr><th class="text-center" colspan="2">选择要清除测试数据的数据库类别</th></tr>
        <tr>
            <th scope="col" class="w12rem_lg"><label>内容 <input type="checkbox" class="clearchk" checked="checked" /></label></th>
            <td scope="col">
        ...
        <tr>
            <th scope="col"><label>商城 <input type="checkbox" class="clearchk" checked="checked" /></label></th>
            <td scope="col">
        ...
        <tr>
            <th scope="col"><label>社区 <input type="checkbox" class="clearchk"/></label></th>
            <td scope="col">
        ...
        <tr>
            <th scope="col"><label>能力 <input type="checkbox" class="clearchk"/></label></th>
            <td scope="col">
        ...
        <tr>
            <th scope="col"><label>用户 <input type="checkbox" class="clearchk"/></label></th>
            <td scope="col">
