...
<div class="tab-content col-12 table_box">
        <div class="tab-pane  col-12 table_box active table-responsive-md" id="Tabs0">
            <table class="table table-striped table-bordered sys_table">
                <tbody>
                    ...
                    <tr>
                        <th><strong>注册时的必填、选填项目：</strong></th>
                        <td>
                            <table>
                                <tr>
                                    <td>
                    ...
                    <tr>
                        <th>新会员注册时发送的手机验证短信内容：</th>
                        <td>
                            <asp:TextBox ID="txtMobileRegInfo" runat="server" Rows="6" TextMode="MultiLine" class="form-control m50rem_50"></asp:TextBox>
                            <small>短信内容中可用标签如下(内容不超过70个字)：<br />
                                <span>{$CheckNum}</span>：会员名称<br />
                                <span>{$SiteName}</span>：网站名称<br />
                                <span>{$SiteUrl}</span>：网站地址
                            </small>
                        </td>
                    </tr>
                </tbody>
	...
	<div class="Conent_fix"> <asp:Button runat="server" Text="保存设置" OnClick="Save_Click" class="btn btn-info" /></div>
</div>
</div>
