...
<div class=" sysRow list_choice">
    <div>
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item"><a class="nav-link" href="#tab1" data-toggle="tab"><i class="zi zi_download"></i> 文件备份</a></li>
        </ul>
                ...
                <td scope="col">
					<div class="input-group">
					  ...
					  <label class="pl-2 pt-1">
                          <span id="backup_sp" runat="server">
                              <input type="checkbox" runat="server" id="chBackup" onchange="changeDir(this)"/>根目录
                              <script>
                                  function changeDir(chk) {
                                      var text = chk.checked ? "/" : "/Temp/";
                                      $("#dir_sp").text(text);
                                  }
                              </script>
                          </span>
        ...
        <table id="tab1" class="table table-striped table-bordered table-hover tabs sys_table" style="display:none;">
            ...
            <tr class="tdbg">
                ...
                <td scope="col"><div class="input-group " >
				<div class="input-group-prepend">
							<span class="input-group-text">/Temp/</span>
						  </div>  
                        <input runat="server" id="SiteText" class="form-control max20rem" />
						<div class="input-group-append">
                        <asp:Label runat="server" class="input-group-text">.zip</asp:Label>
						</div>
						<label class="pl-2 pt-1">
                        <asp:CheckBox runat="server" ID="Zip_UploadFiles" Checked="true" /> 包含(<%=ZoomLa.Components.SiteConfig.SiteOption.UploadDir %>)上传目录
                    </label>
                    </div>					  
                </td>
            </tr>
