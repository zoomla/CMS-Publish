...
<asp:Content runat="server" ContentPlaceHolderID="Content">
	<%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url="/{manage}/Config/SearchFunc.aspx", text=Resources.L.管理导航 +"<a href='AddSearch.aspx'> ["+Resources.L.添加管理导航 +"]</a>",addon="" }}
		)
    %>
    ...
    <ul class="nav nav-tabs" id="linktype_ul">
      <li class="nav-item" data-id="-100" role="presentation"><a class="nav-link" href="SearchFunc.aspx"><%=Resources.L.所有应用 %></a></li>
    ...
    <div class="table-responsive">
        <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="False" AllowPaging="true" PageSize="20" OnPageIndexChanging="EGV_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="<%$Resources:L,属性 %>" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                      <ItemTemplate>
                         <%#ShowAttribute() %>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="<%$Resources:L,操作 %>" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                       <asp:LinkButton runat="server" CommandName="seturl" CommandArgument='<%#Eval("ID") %>'><i class="zi zi_home"></i><%=Resources.L.启动页 %></asp:LinkButton>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script runat="server">
        ...
        {
            return DataConverter.CLng(Eval("state")) == 1 ? ComRE.Icon_OK : ComRE.Icon_Error;
        }
