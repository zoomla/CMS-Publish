...
<asp:Content runat="server" ContentPlaceHolderID="head"><title>网站参数配置</title></asp:Content>
...
<table class="table table-striped table-bordered table-hover sys_table">
	<tbody>
		<tr runat="server" id="Tr5">
			...
			<td>
				<asp:DropDownList ID="languages" CssClass="form-control max20rem"  runat="server" OnSelectedIndexChanged="languages_SelectedIndexChanged" AutoPostBack="true">
                    ...
                    <asp:ListItem Text="中国 - 藏语" Value="bo-CN"></asp:ListItem>
                    <asp:ListItem Text="中国 - 维语" Value="ug-CN"></asp:ListItem>
                    <asp:ListItem Text="中国 - 壮语" Value="za-CN"></asp:ListItem>
                    <asp:ListItem Text="中国 - 彝文" Value="ii-CN"></asp:ListItem>
                    <asp:ListItem Text="中国 - 蒙古文" Value="mn-CN"></asp:ListItem>
                    <asp:ListItem Text="中国 - 朝鲜文" Value="ko-CN"></asp:ListItem>
                    <asp:ListItem Text="中国 - 哈萨克文" Value="kk-CN"></asp:ListItem>
					<asp:ListItem Text="英语 - United States English" Value="EN-US"></asp:ListItem>
					<asp:ListItem Text="法语 - Français" Value="fr-FR"></asp:ListItem>
					<asp:ListItem Text="俄语 - Русский" Value="ru-RU"></asp:ListItem>
					<asp:ListItem Text="德语 - Deutschland" Value="de-DE"></asp:ListItem>
					<asp:ListItem Text="日语 - 日本語" Value="ja-JP"></asp:ListItem>
					<asp:ListItem Text="老挝语 - ລາວ" Value="lo-LA"></asp:ListItem>
					<asp:ListItem Text="缅语 - ဗမာ" Value="my-MY"></asp:ListItem>
					<asp:ListItem Text="柬语 - ខ្មែរ" Value="KHM"></asp:ListItem>
					<asp:ListItem Text="泰语 - ไทย " Value="th-TH"></asp:ListItem>
					<asp:ListItem Text="西班牙语 - Español" Value="es-ES"></asp:ListItem>
					<asp:ListItem Text="孟加拉语 - বাংলা" Value="bn-BD"></asp:ListItem>
					<asp:ListItem Text="葡萄牙语 - Protuguês" Value="pt-BR"></asp:ListItem>
					<asp:ListItem Text="印地语 - हिंदी" Value="hi-HI"></asp:ListItem>
					<asp:ListItem Text="阿拉伯语 - العربية" Value="ar-AE"></asp:ListItem>
					<asp:ListItem Text="波斯语 - فارسی" Value="fa-IR"></asp:ListItem>
				</asp:DropDownList>
		...
		<tr>
			...
			<td>
				<div class="input-group">
					<asp:TextBox ID="CommentRule"  runat="server" CssClass="form-control max20rem" />
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="PdfDirectory" runat="server"  CssClass="form-control max20rem" />
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="GeneratedDirectory" runat="server"  CssClass="form-control max20rem" />
				<small class="text-muted"><%=Resources.L.目录名前后不要加斜杠 %>"/"</small>
			</td>
		</tr>
	</tbody>
...
<table class="table table-striped table-bordered table-hover sys_table">
	<tbody>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox runat="server" ID="SSOCookies_Domain_T" class="form-control max20rem" placeholder="请输入域名"/>
		...
		<tr>
			...
			<td>
				 <input type="checkbox" runat="server" id="EnableSiteManageCode" class="switchChk" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			<th scope="row" ><%=Resources.L.是否过滤敏感词汇 %></th>
			<td>
		...
		<tr>
			...
			<td>
				<input type="checkbox" runat="server" id="RegPageStart" class="switchChk" checked="checked" />
			</td>
		</tr>
		<tr>
...
<table class="table table-striped table-bordered table-hover sys_table">
	<tbody>
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="txtUploadDir" runat="server" CssClass="form-control max20rem" /></td>
		</tr>
		<tr>
