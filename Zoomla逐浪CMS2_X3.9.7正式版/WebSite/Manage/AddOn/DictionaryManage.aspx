...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    %>
    <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="20"  EnableTheming="False" IsHoldState="false"
        ...
        <Columns>
            ...
            <ItemTemplate>
                <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Edit1" CommandArgument='<%# Eval("DicCateID") %>'><i class="zi zi_pencilalt"></i></asp:LinkButton> 
