...
<table class="table table-bordered sys_table">
	<tr>
		<th scope="col" scope="row" class="w_6rem">短信内容</th>
		<td scope="col">
			<asp:TextBox ID="Content_T" runat="server" Rows="5" TextMode="MultiLine" class="form-control" MaxLength="70" placeholder="请填入短信内容或短信模板ID"></asp:TextBox>
	</tr>
    <tr><th>模板参数</th><td>
        <asp:TextBox runat="server" ID="Param_T" Rows="3" TextMode="MultiLine" class="form-control" placeholder="参数名:参数值,参数名2:参数值" Text=""></asp:TextBox>
        <small style="display:block;">如非模板短信或无参数,可忽略</small>
       </td></tr>
    <tr><th>CRM客户类别</th><td>
