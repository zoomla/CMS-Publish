        ...
        <div class="row padding_l_r10px">
            <div class="col-12 col-md-4">
                <div class="card Worktable_well">
                    <div class="card-header"><i class="zi zi_user"></i><span>性别统计</span></div>
            ...
            <div class="col-12 col-md-4">
                <div class="card Worktable_well">
                    <div class="card-header"><i class="zi zi_file"></i><span>年龄统计</span></div>
                    <div class="card-body WorktableHeight">
            ...
            <div class="col-12 col-md-4">
                <div class="card Worktable_well">
                    <div class="card-header"><i class="zi zi_user"></i><span>登录频率</span></div>
                    <div class="card-body WorktableHeight">
            ...
            <div class="col-12 col-md-4">
                <div class="card Worktable_well">
                    <div class="card-header"><i class="zi zi_user"></i><span>活跃指数</span></div>
                    <div class="card-body WorktableHeight">
            ...
            <div class="col-12 col-md-4">
                <div class="card Worktable_well">
                    <div class="card-header"><i class="zi zi_user"></i><span>消费指数</span></div>
                    <div class="card-body WorktableHeight">
