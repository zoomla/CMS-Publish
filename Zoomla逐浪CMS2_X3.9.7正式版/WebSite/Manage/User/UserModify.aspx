                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:Repeater runat="server" ID="Level_RPT">
                            <ItemTemplate>
                                <label class="btn btn-light" style="border: 1px solid #ddd;">
            ...
            <table class="table table-striped table-bordered sys_table">
                <tr>
                    ...
                    <td scope="col" class="text-left">
                        <asp:TextBox ID="tbTrueName" runat="server" onkeydown="return GetEnterCode('focus','tbBirthday');" class="form-control max20rem"></asp:TextBox></td>
                ...
                <tr>
                    <th>身份证号码</th>
                    <td class="text-left">
                        <asp:TextBox ID="tbIDCard" runat="server" Columns="40" onkeydown="return GetEnterCode('focus','tbHomepage');" class="form-control max20rem"></asp:TextBox></td>
                    <th>个人主页</th>
                    <td class="text-left">
                        <asp:TextBox ID="tbHomepage" runat="server" onkeydown="return GetEnterCode('focus','tbQQ');" Columns="40" class="form-control max20rem" >http://</asp:TextBox></td>
                </tr>
                <tr>
                    <th>QQ号码</th>
                    <td class="text-left">
                        <asp:TextBox ID="tbQQ" runat="server" onkeydown="return GetEnterCode('focus','tbICQ');" class="form-control max20rem"></asp:TextBox></td>
                    <th>工号</th>
                    <td  class="text-left">
                ...
                <tr>
                    <th>公司名称</th>
                    <td class="text-left">
                        <asp:TextBox ID="CompanyNameT" runat="server" class="form-control max20rem" onkeydown="return GetEnterCode('focus','CompanyDescribeT');"></asp:TextBox>
                    </td>
                    <th>公司简介</th>
                    <td class="text-left"><asp:TextBox ID="CompanyDescribeT" runat="server" onkeydown="return GetEnterCode('focus','BtnSubmit');" class="form-control max20rem"></asp:TextBox></td>
                </tr>
            </table>
        </div>
            ...
            <table class="table table-striped table-bordered sys_table">
                ...
                <tr style="display:none;">
                    ...
                    <td class="text-left" colspan="3">
                        <asp:TextBox ID="tbSign" runat="server" onkeydown="return GetEnterCode('focus','BtnSubmit');" class="form-control"  TextMode="MultiLine"
