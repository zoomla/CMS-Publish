...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-outline-info" href="AddManage.aspx?id=<%:Mid %>">重新修改</a>
                <a class="btn btn-outline-info" href="AddManage.aspx">继续添加管理员</a>
                <a class="btn btn-outline-info" href="AdminManage.aspx">返回列表</a>
            </td>
        </tr>
    </table>
</asp:Content>
