<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CSSEditor.aspx.cs" Inherits="ZoomLaCMS.Manage.Amazing.css.CSSEditor" MasterPageFile="~/Manage/I/Index.Master" %>
        ...
        <div class="tab-pane active" id="background">
            ...
            <div class="input-group" style="width: 520px;margin-right:20px;">
                ...
                <span class="input-group-btn">
                    <button type="button" title="加载格式" class="btn btn-info" onclick='$("#bkimg").val("url(\"/图片地址.jpg\")");'><i class="zi zi_code"></i></button>
                    <%--<button type="button" title="上传图片" class="btn btn-info" style="padding: 9px 12px;"><i class="zi zi_fileGraph"></i></button>--%>
                </span>
            </div>
