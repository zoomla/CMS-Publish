...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url=Request.RawUrl, text=Resources.L.样式编辑,addon="" }}
		)
    %>
    ...
    <div class="card card-info">
        <div class="card-header">
                <div class="input-group max20rem">
                    <span class="input-group-prepend"><span class="input-group-text"><%=Resources.L.风格名称 %> ：</span></span>
        ...
        <div class="card-footer text-center">
            <asp:Button ID="Button1" runat="server" Text="<%$Resources:L,保存风格 %>" OnClick="Button1_Click" class="btn btn-outline-info" />
        </div>
    </div>
</div>
