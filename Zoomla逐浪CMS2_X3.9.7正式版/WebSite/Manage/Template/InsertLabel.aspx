<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertLabel.aspx.cs" Inherits="ZoomLaCMS.Manage.Template.InsertLabel" MasterPageFile="~/Common/Master/Empty2.master" %>
...
<script type="text/javascript">
    ...
    $().ready(function(){
        ...
        parent.setdiagTitle("标签名称：<%:LName%>");
    })
</script>
</asp:Content>
