...
<asp:Content runat="server" ContentPlaceHolderID="head"><title><%=Resources.L.标签助手 %></title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
		new Bread("/{manage}/Config/SiteInfo.aspx",Resources.L.系统设置),
        new Bread("LabelManage.aspx",Resources.L.标签管理 ),							
        new Bread() {url="", text=Resources.L.标签调用,addon="" }}
		)
    %>
