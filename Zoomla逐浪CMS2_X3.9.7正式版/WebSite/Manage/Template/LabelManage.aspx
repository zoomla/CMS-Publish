...
<ol id="BreadNav" class="breadcrumb fixed-top w-100">
    ...
    <div class="float-left dropdown ml-3">
        <a class="btn btn-outline-info btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="zi zi_pluscircle" zico="加号圆标"></i> <%=Resources.L.添加标签 %></a>
...
<table class="table table-striped table-bordered table-hover">
    <tr class="gridtitle text-center">
        ...
        <th class="td_m"><%=Resources.L.标签分类 %></th>
        <th class="td_m"><%=Resources.L.标签类别 %></th>
        <th class="td_l"><%=Resources.L.创建时间 %></th>
        <th class="td_l"><%=Resources.L.修改时间 %></th>
