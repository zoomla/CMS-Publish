...
<title><%=Resources.L.编辑模板 %></title>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
		new Bread("/{manage}/Main.aspx",Resources.L.工作台),
        new Bread("TemplateSet.aspx",Resources.L.模板风格),				
        new Bread("TemplateManage.aspx",Resources.L.模板列表),				
        new Bread() {url=Request.RawUrl.ToString(), text=Resources.L.模板编辑,addon="" }}
		)
    %>
...
<tr class="title">
	<td align="left" colspan="2">
			...
			<span class="text-danger" runat="server" id="whitespace_sp" visible="false"><%=Resources.L.编辑模板_notice %></span>
	</tr>
	<tr>
		<td colspan="2">
			<div id="labeldiv">
	<ul class="nav nav-tabs top_opbar mb-0">
		<li class="nav-item"><a class="nav-link active" href="#Tabs0" data-toggle="tab"><%=Resources.L.自定标签 %></a></li>
		<li class="nav-item"><a class="nav-link"  href="#Tabs1" data-toggle="tab"><%=Resources.L.字段标签 %></a></li>
		<li class="nav-item"><a class="nav-link" href="#Tabs2" data-toggle="tab"><%=Resources.L.系统标签 %></a></li>
		<li class="nav-item"><a class="nav-link" href="#Tabs3" data-toggle="tab"><%=Resources.L.扩展函数 %></a></li>
	</ul>
	<div class="row">
	...
	<tr>
		<td colspan="2" class="text-center">
		  <asp:LinkButton ID="SaveTem_LB" runat="server" OnClick="btnSave_Click" CssClass="btn btn-info"><i class="zi zi_floderLine" aria-hidden="true"></i> <%=Resources.L.保存模板 %></asp:LinkButton>
		  <a href="<%=ReturnUrl %>" class="btn btn-outline-info"><i class="zi zi_backward" zico="快退"></i> <%=Resources.L.返回列表 %></a>
		</td>
	</tr>
</table>
	...
	<div class="modal-dialog" style="width: 800px;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<span class="modal-title"><strong id="title"><%=Resources.L.用户信息 %></strong></span>
			</div>
