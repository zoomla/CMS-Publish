...
<asp:Content runat="server" ContentPlaceHolderID="head"><title><%=Resources.L.模板管理 %></title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url="TemplateEdit.aspx?filepath="+CurDir, text="<span class='text-danger'>["+Resources.L.新建模板 +"]</span>",addon="" }}
		)
    %>
        ...
        <div class="row sysRow list_choice table-responsive-md">
            ...
            <table class="table table-striped table-bordered">
                <tr>
                    ...
                    <th><%=Resources.L.名称 %></th>
                    <th scope="col"><%=Resources.L.大小 %></th>
                    <th scope="col"><%=Resources.L.类型 %></th>
                    <th scope="col"><%=Resources.L.修改时间 %></th>
                </tr>
                            ...
                            <td class="text-center">
                                <div class="option_area dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li class="dropdown-item">
                                            <asp:LinkButton runat="server" CommandArgument='<%# Eval("Name").ToString()%>' CommandName='<%#Eval("type","") == "1" ? "DelDir":"DelFiles" %>' OnClientClick="return confirm('你确认要删除该文件夹或文件吗？')"> <i class="zi zi_trashalt" zico="垃圾箱竖条"></i> <%=Resources.L.删除 %></asp:LinkButton></li>
                                        <li class="dropdown-item">
                                            <asp:LinkButton runat="server" CommandArgument='<%# Eval("Name").ToString()%>' CommandName='<%#Eval("type","") == "1" ? "CopyDir":"CopyFiles" %>' Enabled='<%# System.Convert.ToInt32(Eval("type")) == 1 ? false:true %>'> <i class="zi zi_copy" zico="拷贝"></i> <%=Resources.L.复制 %></asp:LinkButton></li>
                                    </ul>
