...
public class Center : IHttpHandler, System.Web.SessionState.IReadOnlySessionState
{
    ...
    {
        int count = 0;
        string fields = "A.generalid,A.title,A.nodeid,A.itemid,A.inputer,A.createtime,A.topimg,B.author,B.synopsis";//全小写兼容Java
    ...
    {
        string fields = "A.generalid,A.title,A.nodeid,A.inputer,A.createtime,A.url='',A.topimg,B.content,B.synopsis";
