<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editor.aspx.cs" Inherits="ZoomLaCMS.Design.ppt.editor" EnableViewState="false" MasterPageFile="~/Design/Master/Empty2.Master" %>
...
<div id="tools">
    ...
    <div id="toolsmenu_div" class="btn-group" style="position: absolute;display:none;z-index:1000;">
        <a href="javascript:;" class="btn btn-sm btn-default" title="组件靠前" onclick="tools.up();"><i class="zi zi_stepbackward "></i></a>
        <a href="javascript:;" class="btn btn-sm btn-default" title="组件置后" onclick="tools.down();"><i class="zi zi_stepforward"></i></a>
        ...
        <a href="javascript:;" class="btn btn-sm btn-default" title="绑定行为" onclick="tools.bind();"><i class="zi zi_linkk"></i></a>
