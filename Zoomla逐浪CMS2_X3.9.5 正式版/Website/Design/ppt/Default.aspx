<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ZoomLaCMS.Design.ppt.Default" MasterPageFile="~/Design/Master/Empty2.Master" %>
...
<div id="slist_div" runat="server" visible="false">
    <div class="listbody">
        <div class="alert alert-info margin_b2px listbody_alert">
            ...
            <div class="btn-group">
                <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-expanded="false">创建场景 <i class="zi zi_caretdown"></i></button>
    ...
    <script>
        $(function(){
            //插入新建场景按钮
            var addtlp ="<li title='点击新建PPT' onclick='ShowComDiag(\"/design/ppt/diag/add.aspx?device=pc\", \"新建PPT\");'><div class='imgdiv'><i class='zi zi_plusSquare'></i></div><span><strong>创建新场景</strong></span></li>";
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="cmd_addpage">
                    <a href="javascript:;"><i class="zi zi_plus"></i></a>
                    <ul class="create_ul">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="/design/ppt/pcview.aspx?sid=<%:pageMod.ID %>" target="_blank"><i class="zi zi_laptop"></i> PC预览</a></li>
...
<div class="mbdesign" style="background-color:#fff;">
    <div class="rpane left">
        <div class="tab_head text-center">
            <button type="button" class="btn btn-sm btn-info" title="页面配置" onclick='ShowComDiag("diag/add.aspx?id=<%:pageMod.guid %>", "新建场景");'><i class="zi zi_fileLine"></i></button>
    ...
    <div class="mainpane">
        ...
        <div class="sidebar" style="left:-39px;">
            <a href="javascript:;" class="btn btn-sm btn-default cmd_addcomp" title="增加组件"><i class="zi zi_objectgroup"></i></a>
            <a href="javascript:;" class="btn btn-sm btn-default" title="上一页" onclick="scence.switch('pre');"><i class="zi zi_arrowUp"></i></a>
            <a href="javascript:;" class="btn btn-sm btn-default" title="下一页" onclick="scence.switch('next');"><i class="zi zi_circleDownLong"></i></a>
            ...
            <a href="javascript:;" class="btn btn-sm btn-default cmd_music" title="音乐"><i class="zi zi_musicBold"></i></a>
            <a href="javascript:;" class="btn btn-sm btn-default cmd_conf"><i class="zi zi_cog"></i></a>
        </div>
    </div>
</div>
<div id="diagBody">
