<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ZoomLaCMS.Design.album.Default" MasterPageFile="~/Design/Master/Empty.Master" %>
        ...
        <div style="overflow-x:auto;height:155px;" class="auto_width">
            <ul class="list-unstyled" id="photo_ul" style="white-space:nowrap;">
                <li class="photo_add" id="upfile_btn">
                    <i class="zi zi_image" style="font-size:60px;color:#ddd;"></i>
                </li>
            </ul>
        </div>
        </td></tr>
                    ...
                    <li class="music_item">
                        <label class="wrap">
                            <div style="float: left;">
                                <i class="zi zi_musicBold" style="color: #0094ff;"></i>
                            </div>
                            <div class="name"><%#ZoomLa.Common.StringHelper.SubStr(Eval("Name",""),15) %></div>
                            <div class="ischoose">
                                <i class="zi zi_check" style="color: green;"></i>
                            </div>
