<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addsite.aspx.cs" Inherits="ZoomLaCMS.Design.mobile.addsite" MasterPageFile="~/Design/Master/Empty.Master" %>
            ...
            <ul>
                <li>
                    <div class="item-content">
                        <div class="item-media"><i class="zi zi_book"></i></div>
                ...
                <li>
                    <div class="item-content">
                        <div class="item-media"><i class="zi zi_list"></i></div>
                        <div class="item-inner">
                            <div class="item-input">
                ...
                <li>
                    <div class="item-content">
                        <div class="item-media"><i class="zi zi_image"></i></div>
                        <div class="item-inner">
