            ...
            <div class="setting-row" data-group="indent">
                ...
                <div class="pos_div">
                    <div class="preset pull-left">
                        <a class="left-top" data-pos="left top"><i class="zi zi_arrowUp"></i></a>
                        <a class="top" data-pos="top"><i class="zi zi_arrowUp"></i></a>
                        <a class="right-top" data-pos="right top"><i class="zi zi_arrowUp"></i></a>
                        <a class="left" data-pos="left"><i class="zi zi_arrowLeft"></i></a>
                        <a class="center" data-pos="center"><i class="zi zi_arrowsalt"></i></a>
                        <a class="right" data-pos="right"><i class="zi zi_arrowRight"></i></a>
                        <a class="left-bottom" data-pos="left bottom"><i class="zi zi_arrowUp"></i></a>
                        <a class="bottom" data-pos="bottom"><i class="zi zi_arrowDown"></i></a>
                        <a class="right-bottom" data-pos="right bottom"><i class="zi zi_arrowUp"></i></a>
                    </div>
                    ...
                    <div class="inline_div">
                        ...
                        <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-default active" data-bind="background-repeat" data-param="repeat">
                                <input type="radio" name="options" autocomplete="off" checked><span class="zi zi_thead"></span>
                            </label>
                            <label class="btn btn-default" data-bind="background-repeat" data-param="repeat-x">
                                <input type="radio" name="options" autocomplete="off"><span class="zi zi_ellipsish"></span>
                            </label>
                            <label class="btn btn-default" data-bind="background-repeat" data-param="repeat-y">
                                <input type="radio" name="options" autocomplete="off"><span class="zi zi_ellipsisv"></span>
                            </label>
                            <label class="btn btn-default" data-bind="background-repeat" data-param="no-repeat">
                                <input type="radio" name="options" autocomplete="off"><span class="zi zi_times"></span>
                            </label>
                        </div>
                    </div>
                    <div class="inline_div">
                        ...
                        <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-default active" data-bind="background-attachment" data-param="fixed">
                                <input type="radio" name="attachment" autocomplete="off" /><span class="zi zi_unlockalt"></span>
                            </label>
                            <label class="btn btn-default" data-bind="background-attachment" data-param="scroll">
                                <input type="radio" name="attachment" autocomplete="off" /><span class="zi zi_lock"></span>
                            </label>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="margin_t5">
                            ...
                            <div class="btn-group border_style" data-toggle="buttons">
                                ...
                                <label class="btn btn-default" data-param="none">
                                    <input type="radio" name="border" autocomplete="off" /><span class="zi zi_times"></span>
                                </label>
                            </div>
                        </div>
                    </div>
