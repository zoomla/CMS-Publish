    ...
    <div class="tab-pane active" id="Tabs0">
        <table class="table table-bordered">
            <tr ng-repeat="item in list|orderBy:'order' track by $index">
                ...
                <td>
        <%--            <button type="button" class="btn btn-info" ng-click="move(item,'pre');"><i class="zi zi_circleUps"></i></button>
                    <button type="button" class="btn btn-info" ng-click="move(item,'next');"><i class="zi zi_circleDowns"></i></button>--%>
                    <button type="button" class="btn btn-info" ng-click="del(item);"><i class="zi zi_trashalt"></i></button>
                </td>
            </tr>
