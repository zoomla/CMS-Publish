<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ZoomLaCMS.Design.mbh5.Default" MasterPageFile="~/Design/Master/Empty.Master" %>
...
<a href="javascript:;" class="header view link_btn" onclick="mbh5.preview();" style="width: 80px; height: 80px; padding-top: 10px;">保存<br />
    预览</a>
<a href="javascript:;" class="header view link_btn disabled" style="top: 100px;" onclick="scence.btnclick(this);"><i class="zi zi_lock zi_2x"></i></a>
<!--Tools-->
<div id="mask_div" onclick="mask.hide(1);"></div>
<div id="mask_wait_div"><i class="zi zi_spinner zi_pulse" style="font-size: 5em; color: #fff;"></i></div>
<div id="pop_div">
    <div class="popdiag" style="display: block;">
        <a href="javascript:;" class="header back link_btn" onclick="mbh5.backToEdit();"><i class="zi zi_forLeft"></i></a>
...
<div id="toolsmenu_div" class="btn-group" style="position: absolute; display: none; transform: scale(2); z-index: 400;">
    <a href="javascript:;" class="btn btn-default" title="绑定动画" onclick="tools.animate();"><i class="zi zi_fly"></i></a>
    <a href="javascript:;" class="btn btn-default" title="修改组件" onclick="tools.edit();"><i class="zi zi_pencilalt"></i></a>
    <a href="javascript:;" class="btn btn-danger" title="移除组件" onclick="tools.del();"><i class="zi zi_trashalt"></i></a>
</div>
<div ng-app="app">
    ...
    <div ng-controller="footCtrl">
        ...
        <div class="footcmd addani" id="addani_div">
            <div class="footcmd_head">
                ...
                <div class="head_yes">
                    <a onclick="CloseDiag();" class="btn btn-default"><i class="zi zi_times"></i></a>
                </div>
            </div>
        ...
        <div class="footcmd addpage" id="addpage_div">
            <div class="footcmd_head">
                <div class="head_tab_wrap">
                    ...
                    <button type="button" class="btn btn-info opbtn" ng-click="scence.move('pre');" style="margin-left: 46px; margin-right: 5px;" ng-disabled="scence.canmove('pre')"><i class="zi zi_forLeft"></i>前移</button>
                    <button type="button" class="btn btn-info opbtn" ng-click="scence.move('next');" ng-disabled="scence.canmove('next')">后移 <i class="zi zi_forRight"></i></button>
                </div>
                <div class="head_yes">
                    <a onclick="CloseDiag();" class="btn btn-default"><i class="zi zi_times"></i></a>
                </div>
            ...
            <div class="footcmd_ul_wrap">
                ...
                <ul class="footcmd_ul">
                    <li ng-repeat="item in ele.list" ng-class="ele.isactive(item)?'active':''" ng-click="ele.sel(item);">
                        ...
                        <div ng-if="item.showdel" class="del"><div ng-click="ele.del(item,$index);" class="d_btn"><i class="zi zi_minus"></i></div></div>
                    </li>
                </ul>
            </div>
        </div>
