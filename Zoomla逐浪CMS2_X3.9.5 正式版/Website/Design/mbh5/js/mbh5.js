...
editor.app = angular.module("app", [], function ($compileProvider) { })
    ...
    .controller("footCtrl", function ($scope, $http) {
        ...
        $scope.scence.getbk = function (item) {
            ...
            //else { return ""; }
            //else { return "/UploadFiles/nopic.svg"; }
            //根据item返回pk
        }
...
//------------------------------上传
tools.up = { $up: $('<input id="pic_up" type="file" onchange="tools.up.change();" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp" style="display:none;">') };
