            ...
            <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"  EnableTheming="False" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_l">
                            <ItemTemplate>
                                <a href='<%#Domain+"Content?Gid="+Eval("GeneralID") %>' target="_blank" title="预览" class="option_style"><i class="zi zi_eye"></i></a>
                                <a href="AddContent.aspx?GeneralID=<%#Eval("GeneralID")+"&SiteID="+SiteID %>" class="option_style" title="修改"><i class="zi zi_pencilalt"></i></a>
                                <asp:LinkButton runat="server" CssClass="option_style" CommandName="del2" CommandArgument='<%# Eval("GeneralID") %>' 
                                    OnClientClick="return confirm('你确定将该数据删除到回收站吗？')"><i class="zi zi_trashalt"></i>删除</asp:LinkButton>
