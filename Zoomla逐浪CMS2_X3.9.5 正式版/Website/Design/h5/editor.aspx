<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editor.aspx.cs" Inherits="ZoomLaCMS.Design.h5.editor" EnableViewState="false" MasterPageFile="~/Design/Master/Empty.Master" %>
...
<div id="tools">
    ...
    <div id="context-menu">
        <ul id="context-ul" class="dropdown-menu" role="menu" style="font-size:28px;width:260px;">
            ...
            <li class="divider"></li>
            <li data-cmd="animate"><a tabindex="-1"><i class="zi zi_fly"></i> 动画</a></li>
            <li class="divider"></li>
            <li data-cmd="common"><a tabindex="-1"><i class="zi zi_thead"></i> 通用</a></li>
