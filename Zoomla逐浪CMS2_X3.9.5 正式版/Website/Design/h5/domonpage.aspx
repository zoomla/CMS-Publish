...
<table class="table table-bordered table-striped" ng-controller="appCtrl">
    ...
    <tr ng-repeat="item in list">
        ...
        <td>
            <a href="javascript:;" title="动画" ng-click="editani(item.id);" class="btn btn-sm btn-info"><i class="zi zi_fly"></i></a>
            <a href="javascript:;" title="修改" ng-click="edit(item);" class="btn btn-sm btn-info"><i class="zi zi_pencilalt"></i></a>
<%--            <a href="javascript::" title="删除" ng-click="del(item.id);" class="btn btn-sm btn-info"><i class="zi zi_trashalt"></i></a>--%>
        </td>
    </tr>
</table>
</asp:Content>
