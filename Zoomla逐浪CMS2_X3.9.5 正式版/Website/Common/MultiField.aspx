...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div ng-app="APP" ng-controller="ZLCtrl" style="width:490px;">
        <div ng-repeat="item in list track by $index" class="input-group mb-1">
            <span class="input-group-prepend"><span class="input-group-text">属性</span></span>
            <input type="text" class="form-control text_md" ng-model="item.name" disabled="disabled"/>
            <span class="input-group-prepend"><span class="input-group-text">值</span></span>
