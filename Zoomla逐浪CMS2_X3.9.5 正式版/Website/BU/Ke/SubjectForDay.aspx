...
<asp:Content runat="server" ContentPlaceHolderID="Content">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-7">
          <ul class="nav navbar-nav dailyplan_nav">
            ...
            <li class="active"><a href="SubjectForDay.aspx<%=Request.Url.Query %>"><span class="zi zi_squareHandCorrect"></span> 日</a></li>
          </ul>
            <ul class="nav navbar-nav dailyplan_nav pull-right">
                <li><a href="/home"><span class="zi zi_spinner zi_pulse float-left"></span> <span class="loginout_str">能力中心</span></a></li>
    ...
    <div class="container-fluid">
        <div class="col-md-2">
            ...
            <div class="panel-heading">日程列表[<a href="SubjectForDay.aspx?type=-1">所有日程</a>] <span class="pull-right"><a href="javascript:;" title="添加日程" onclick="ShowTypeDiag()"><span class="zi zi_plus"></span></a></span></div>
        ...
        <div class="col-md-7">
            <table class="table table-bordered" id="DateTable">
                <thead id="DateTitle" runat="server">
                    <tr>
                        <td class="text-center td_m"><asp:LinkButton runat="server" CssClass="btn btn-primary" OnClick="PreDay_Btn_Click"><i class="zi zi_circleLeftLong"></i></asp:LinkButton></td>
                        <asp:Literal ID="HeadTip_Li" runat="server" EnableViewState="false"></asp:Literal>
                        <td class="text-center td_m"><asp:LinkButton runat="server" CssClass="btn btn-primary" OnClick="NextDay_Btn_Click"><i class="zi zi_circleRightLong"></i></asp:LinkButton></td>
                    </tr>
                    <tr>
