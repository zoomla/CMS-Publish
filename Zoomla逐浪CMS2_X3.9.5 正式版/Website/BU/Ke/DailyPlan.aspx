      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-7">
          <ul class="nav navbar-nav dailyplan_nav">
            <li class="active"><a href="DailyPlan.aspx<%=Request.Url.Query %>"><span class="zi zi_calendar"></span> 月</a></li>
            <li><a href="SubjectForWeek.aspx<%=Request.Url.Query %>"><span class="zi zi_squarePlus"></span> 周</a></li>
...
<div class="row">
    <div class="col-md-7 offset-md-3 offset-lg-2 platcontainer" style="margin-top:0px;">
  ...
  <thead>
    <tr>
      <td colspan="7" class="text-center">
          ...
          <asp:LinkButton runat="server" CssClass="btn btn-outline-info" OnClick="PreMonth_Btn_Click" ToolTip="上一月"><i class="zi zi_pathLeft"></i></asp:LinkButton>
          ...
          <asp:LinkButton runat="server" CssClass="btn btn-outline-info" OnClick="NextMonth_Btn_Click" ToolTip="下一月"><i class="zi zi_pathRight"></i></asp:LinkButton></td>
    </tr>
    <tr>
      <td>周一</td>
      <td>周二</td>
...
<div class="mb-2">
    <div class="card">
    <div class="card-header">日程列表[<a href="DailyPlan.aspx?type=-1">所有日程</a>]<span class="pull-right"><a href="javascript:;" title="添加日程" onclick="ShowTypeDiag()"><span class="zi zi_plus"></span></a></span></div>
        ...
        <div class="card-body empty_div" runat="server" visible="false" id="EmptySub_Div">
            <p>没有相关日程!</p>
        </div>
    </div>
</div>
<div class="mt-2">
    <div class="card">
    <div class="card-header"><asp:Literal ID="TopSubName_Li" runat="server"></asp:Literal>日程</div>
        ...
        <div class="card-body empty_div" runat="server" visible="false" id="listempty_div">
            <p>您还没有日程!</p>
        </div>
    </div>
</div>
