                                ...
                                <tbody style="border:none;" id="suit_wrap_<%#Eval("ID") %>">
                                    ...
                                    <td class="pronum_td hidden-xs" colspan="2">
                                        <div class="input-group td_m">
                                            <span class="input-group-addon" onclick="cart.suit.setnum('<%#Eval("ID") %>','+');"><span class="zi zi_minus"></span></span>
                                            ...
                                            <span class="input-group-addon" onclick="cart.suit.setnum('<%#Eval("ID") %>','-');"><span class="zi zi_plus"></span></span>
                                        </div>
                                    </td>
                                ...
                                <tr data-id="<%#Eval("ID") %>" class="cart_item">
                                    ...
                                    <td class="pronum_td hidden-xs">
                                        <div class="input-group margin_t20 td_m">
                                            <span class="input-group-addon" onclick="cart.setnum('<%#Eval("ID") %>','+');"><span class="zi zi_minus"></span></span>
                                            ...
                                            <span class="input-group-addon" onclick="cart.setnum('<%#Eval("ID") %>','-');"><span class="zi zi_plus"></span></span>
                                        </div>
                                    </td>
...
<script>
    ...
    cart.setnum = function (id, num) {
        ...
        cart.updatePrice(id);
        if (Convert.ToInt($("#PI_NeedPay_T").val()) < 0) {
            alert("已超出最大退货范围");
        }
    }
