    ...
    <ZL:ExGridView runat="server" ID="EGV" CssClass="table table-bordered table-hover" AutoGenerateColumns="false" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                 <ItemTemplate>
        <%--             <asp:LinkButton runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="receive"><i class="zi zi_envelopeOpen"></i> 接收邮件</asp:LinkButton>--%>
                     <a href="javascript:;" onclick="ShowEdit(<%#Eval("ID") %>);"><i class="zi zi_pencilalt"></i> 修改</a>
                     <asp:LinkButton runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="del2"><i class="zi zi_trashalt"></i> 删除</asp:LinkButton>
                 </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
