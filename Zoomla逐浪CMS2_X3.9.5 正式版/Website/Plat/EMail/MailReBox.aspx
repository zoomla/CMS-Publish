...
<div class="platcontainer container email">
    <div class="d-flex">
		...
		<div class="email_op ml-auto">
            ...
            <a href="MailWrite.aspx"><i class="zi zi_pencilalt"></i> 新邮件</a>
            <a href="MailConfig.aspx"><i class="zi zi_cog"></i> 邮件设置</a>
            <a href="Default.aspx" title="返回"><i class="zi zi_doubleLeft zi_3x"></i></a>
        </div>
    </div>
