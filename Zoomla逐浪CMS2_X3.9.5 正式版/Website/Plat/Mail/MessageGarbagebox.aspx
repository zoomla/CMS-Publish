...
<%--    <div class="container-fluid">
    ...
    <div class="btn-group d-flex flex-wrap mt-1 mb-2"> <a class="btn btn-info" href="MessageSend.aspx">写邮件</a> <a class="btn btn-info" href="Default.aspx">收件箱</a> <a class="btn btn-info" href="MessageOutbox.aspx">发件箱</a> <a class="btn btn-info" href="MessageDraftbox.aspx">草稿箱</a> <a class="btn btn-info" href="MessageGarbagebox.aspx">垃圾箱</a> <a class="btn btn-info" href="Mobile.aspx">手机短信</a> </div>
    <div class="us_seta mt-1">
      <div id="site_main">
         <div class="input-group">
              <asp:TextBox runat="server" ID="searchText" placeholder="请输入需要查询的信息" CssClass="form-control max20rem" />
      ...
      <asp:Button ID="Button3" runat="server" Text="批量删除" OnClick="Button2_Click" class="btn btn-outline-danger" OnClientClick="return confirm('确定要彻底删除选定邮件吗!!');"/>
      <asp:Button id="Button4" runat="server" Text="批量还原" OnClick="Button4_Click" class="btn btn-outline-info" />
    </div>
  </div>
</asp:Content>
