...
<div style="margin-top: 10px; margin-bottom: 10px;"><span>文件路径：</span><span><a href="<%=ZoomLa.BLL.SafeSC.RawUrl %>">公司文库</a>></span>
...
<input type="button" data-toggle="modal" data-target="#dir_div" value="新建文件夹" class="btn btn-outline-info"/>
</div>
<table class="table table-bordered table-striped sys_table mt-2">
<thead>
  <tr>
	<th>名称</th>
	<th>大小</th>
	...
	<ItemTemplate>
	  <tr id="file_tr_<%#Eval("ID") %>" onmouseover="$(this).find('.hoverDiv').show();" onmouseout="$(this).find('.hoverDiv').hide();">
		<td><div style="position:relative;bottom:-10px;display:inline-block;"> <%#GroupPic.GetExtNameMini(GetExt()) %> </div>
		  ...
		  <%#GetOP() %> <a><span class='zi zi_syncalt' title='重命名' onclick="ShowReName(<%#Eval("ID") %>);"></span></a> <a><span class='zi zi_trashalt' title='删除' onclick="PostDel(<%#Eval("ID")+",'"+Eval("FileName")+"'" %>);"></span></a> </span></td>
...
<div class="modal bd-example-modal-lg" id="article_div" style="position:fixed;top:35px;z-index:5;">
<div class="modal-dialog modal-lg">
  <div class="modal-content">
	...
	<div class="modal-footer" style="text-align:center;">
        ...
        <input type="button" class="btn btn-outline-info" value="关闭" onclick="$('#article_div').hide();">
	</div>
  </div>
</div>
</div>
...
<div class="modal-dialog">
  <div class="modal-content">
	<div class="modal-header">
	  <span class="modal-title"><i class="zi zi_folders"></i> 新建文件夹</span>
	  <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
	</div>
      <div class="modal-body" style="padding-bottom:50px;">
          <div class="input-group">
              <span class="input-group-prepend"><span class="input-group-text">文件夹名</span></span>
              <asp:TextBox runat="server" ID="DirName_T" CssClass="form-control max20rem"></asp:TextBox>
              <span class="nput-group-append">
...
<div class="modal fade bd-example-modal-lg" id="preview_div" style="position:fixed;top:5%;"><!--Auth Not Limit-->
<div class="modal-dialog modal-lg">
  <div class="modal-content">
	<div class="modal-header">
	  <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
...
<asp:Button runat="server" ID="ArtSave_Btn" class="btn btn-outline-info" Text="保存" OnClick="ArtSave_Btn_Click" style="display:none;"/>
</asp:Content>
...
<script>
var api = "<%:ZoomLa.BLL.SafeSC.RawUrl%>";
$(function () {
