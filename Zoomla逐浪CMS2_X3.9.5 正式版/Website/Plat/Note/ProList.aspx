...
<div class="child_head"><span class="child_head_span1"></span> <span class="child_head_span2">我的项目 <a href="note.aspx" class="margin_l5" target="_blank" title="创建项目"><i class="zi zi_plus zi_2x"></i></a></span></div>
...
<ZL:ExRepeater ID="ProList_RPT" runat="server" OnItemCommand="ProList_RPT_ItemCommand" PageSize="8" PagePre="<div class='clearfix'></div><div class='text-center margin_t5'>" PageEnd="</div>">
	<ItemTemplate>
		<li class="pre_li col-lg-3 col-md-3 col-sm-6 col-xs-12">
			...
			<div class="pro_tools">
				<a href="<%#GetViewUrl() %>" target="_blank"><i class="zi zi_eye"></i> 查看</a>
				<a href="<%#GetNoteUrl(Convert.ToInt32(Eval("ID"))) %>" target="_blank" title="编辑项目"><i class="zi zi_magic"></i> 编辑</a>
				<asp:LinkButton ID="Del_Link" CommandName="Del" OnClientClick="return confirm('是否确定删除!')" CommandArgument='<%#Eval("ID") %>' runat="server" ToolTip="删除"><i class="zi zi_trashalt"></i> 删除</asp:LinkButton>
			</div>
		</li>
	</ItemTemplate>
