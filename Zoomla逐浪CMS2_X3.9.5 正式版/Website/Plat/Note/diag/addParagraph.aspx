                ...
                <ul class="list-inline parag_img_list">
                    <li>
                        <a href="javascript:;">
                            ...
                            <span class="parag_sel_span parag_active" data-val="t1"><i class="zi zi_check"></i></span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:;">
                            <img src="/plat/note/res/ps2.gif" />
                            <span class="parag_sel_span" data-val="t2"><i class="zi zi_check"></i></span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:;">
                            <img src="/plat/note/res/ps3.gif" />
                            <span class="parag_sel_span" data-val="t3"><i class="zi zi_check"></i></span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:;">
                            <img src="/plat/note/res/ps4.gif" />
                            <span class="parag_sel_span" data-val="t4"><i class="zi zi_check"></i></span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:;">
                            <img src="/plat/note/res/ps5.gif" />
                            <span class="parag_sel_span" data-val="t5"><i class="zi zi_check"></i></span>
                        </a>
                    </li>
                </ul>
            </div>
