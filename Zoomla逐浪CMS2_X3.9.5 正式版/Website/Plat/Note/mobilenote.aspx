...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div ng-app="app">
        <div ng-controller="NoteCtrl">
            <div class="mnote_head">
                <div class="col-sm-2 col-xs-2 mnote_head_back"><a href="mobilelist.aspx"><i class="zi zi_doubleLeft"></i></a></div>
            ...
            <div class="mnote_top">
                <div class="mnote_top_c">
                    <div class="mnote_top_t" ng-style="{'background':'url({{comMod.topimg}}) center no-repeat','background-size':'cover'}">
                        <div ng-if="comMod.topimg==''" class="mnote_top_ti"><i class="zi zi_image"></i>
                            <br />
                            背景图片</div>
                    </div>
            ...
            <div class="mnote_content">
                <div class="con_item" ng-repeat="item in comMod.comlist |orderBy: 'orderID'" ng-switch="item.type">
                    ...
                    <div class="remove_div"><a href="javascript:;" ng-click="note.delcom(item)" title="移除"><i class="zi zi_trashalt"></i></a></div>
                </div>
            </div>
            <div class="mnote_tools" id="mnote_tools">
                <ul>
                    <li><a ng-click="note.preMobilecom('img');"><i class="zi zi_image"></i>媒体</a></li>
                    <li><a href="javascript:;" style="color: #ddd;"><i class="zi zi_cameraretro"></i>照相机</a></li>
                    <li><a ng-click="note.preMobilecom('text');"><i class="zi zi_alignleft"></i>文本</a></li>
                    <li><a ng-click="note.preMobilecom('para');"><i class="zi zi_textheight"></i>段落</a></li>
                    <li><a href="javascript:;" style="color: #ddd;"><i class="zi zi_ellipsish"></i>更多</a></li>
    ...
    <div class="hidden">
        <input type="file" id="img_top_up" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"
 onchange="settopimg(this)" />
        <input type="file" id="img_up" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"
