...
<div class="replyrow" id="msgitem-<%#Eval("ID") %>">
  ...
  <div class="reply_body">
    ...
    <div class="replybottom grayremind">
        ...
        <%#Convert.ToInt32(Eval("CUser"))==UserID?"<span class='zi zi_trashalt' title='删除' onclick=\"PostDelMsg("+Eval("ID")+");\"></span>":"" %>
        <span class="zi zi_commentdots" title="回复" onclick="DisReplyOP(<%#Eval("Pid") %>,<%#Eval("ID") %>,'<%#GetUName() %>');"></span>
  </div>
