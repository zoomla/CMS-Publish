    ...
    <div style="background-color: #fff;min-height:600px;min-width:400px;">
        <div class="headdiv">
            <div class="col-xs-4 col-sm-4">
                <a href="/Plat/Default.aspx" style="color: #fff;"><i class="zi zi_doubleRight"></i>取消</a>
            </div>
        ...
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <div><i class="zi zi_mapmarkeralt"></i><span id="add_final_sp"></span></div>
          </div>
...
<asp:Content runat="server" ContentPlaceHolderID="Script">
  ...
  <script src="//api.map.baidu.com/api?v=2.0&ak=A8nKkhhnf81lQGCFFH3k8l2A"></script>
  <script>
      $(function () {
      ...
      function displayPOI(point) {
          var liTlp = '<li class="addli" data-toggle="modal" data-target="#myModal"><div class="col-xs-10 col-sm-10"><div><strong>@address @title</strong></div><div style="color: gray;">标签：@Gi</div></div>'
                + '<div class="col-xs-2 col-sm-2"><div class="chkdiv"><i class="zi zi_check"></i></div>'
