...
<div class="row">
  <div>
    ...
    <asp:LinkButton runat="server" CssClass="btn btn-primary one" Style="width: 100%; padding-top: 15px; padding-bottom: 15px; margin-top: 10px;" OnClientClick="return CheckEmpy()" OnClick="SaveContent_Click"> <span class="zi zi_globe" style="font-size:1.2em;margin-right:5px;"></span>分享</asp:LinkButton>
  </div>
</div>
<div id="upfile_div" style="display: none;">
  <input data-id="1" type="file" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"
 class="upfile" />
  <input data-id="2" type="file" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"
 class="upfile" />
  <input data-id="3" type="file" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"
 class="upfile" />
