...
//    });
    ...
    var manage = { select: "manage", list: [], $db: $("#manage_hid"), $body: $("#manage_body"), tlp: '<tr id="tr_@UserID"><td>@UserID</td><td>@UserName</td><td><a href="javascript:;" onclick="manage.del(@UserID);" title="删除"><i class="zi zi_times"></a></td></tr>' };
    var member = { select: "member", list: [], $db: $("#member_hid"), $body: $("#member_body"), tlp: '<tr id="tr_@UserID"><td>@UserID</td><td>@UserName</td><td><a href="javascript:;" onclick="member.del(@UserID);" title="删除"><i class="zi zi_times"></a></td></tr>' };
