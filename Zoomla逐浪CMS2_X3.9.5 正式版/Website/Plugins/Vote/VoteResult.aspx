                ...
                <ItemTemplate>
                    <div class="item" id="item_<%#Eval("ID") %>">
                        ...
                        <div class="chart_wrap text-center" <%#ShowChartWrap() %>>
                            ...
                            <button type="button" class="btn btn-xs btn-info" onclick="showchart('<%#Eval("ID") %>','circle')"><i class="zi zi_dotcircle"></i>圆环</button>
                            <button type="button" class="btn btn-xs btn-info" onclick="showchart('<%#Eval("ID") %>','bar')"><i class="zi zi_hockeypuck"></i>柱状</button>
                            <button type="button" class="btn btn-xs btn-info" onclick="showchart('<%#Eval("ID") %>','line')"><i class="zi zi_square"></i>条形</button>
                            <button type="button" class="btn btn-xs btn-danger" onclick="hidechart('<%#Eval("ID") %>')"><i class="zi zi_timescircle"></i>关闭</button>
