<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CutPic_User.aspx.cs" Inherits="ZoomLaCMS.Plugins.PicEdit.CutPic_User" MasterPageFile="~/Common/Master/Empty2.master" %>
    ...
    <div class="cutbox">
            ...
            <div id="imgFunc">
                <div class="col-xs-2" id="imgSave">
                    <asp:LinkButton runat="server" ID="Save_Btn" CssClass="btn btn-primary margin_t5" OnClientClick="return PreSave();" OnClick="Save_Btn_Click"><i class="zi zi_floderLine" zico="文件夹细线"></i>保存</asp:LinkButton>
                </div>
                <div class="col-xs-10" id="imgEdit">
                    <ul class="nav nav-tabs pull-right cut-option" role="tablist">
                        <li class="active"><a href="#imgCut" role="tab" data-toggle="tab"><i class="zi zi_cuts" zico="剪刀"></i>裁剪</a></li>
                        <li><a href="#imgSmall" role="tab" data-toggle="tab"><i class="zi zi_table" zico="平板桌面"></i>缩放</a></li>
                        <li><a href="#imgMark" role="tab" data-toggle="tab"><i class="zi zi_unlink" zico="无法链接"></i>水印</a></li>
                        <li><a href="#imgWord" role="tab" data-toggle="tab"><i class="zi zi_fonts" zico="字体"></i>文字</a></li>
                        <li><a href="javascript:;" onclick="RotateFunc(90);" role="tab" data-toggle="tab"><i class="zi zi_undo" zico="取消箭头"></i>左旋转</a></li>
                        <li><a href="javascript:;" onclick="RotateFunc(-90);" role="tab" data-toggle="tab"><i class="zi zi_redo" zico="重做箭头"></i>右旋转</a></li>
                    <%--<li><a href="#imgQua" role="tab" data-toggle="tab"><i class="zi zi_diamond"></i>品质</a></li>
                        <li><a href="#imgWord" role="tab" data-toggle="tab"><i class="zi zi_reply"></i></a></li>
                        <li><a href="#imgWord" role="tab" data-toggle="tab"><i class="zi zi_sharealt"></i></a></li>--%>
                    </ul>
                </div>
