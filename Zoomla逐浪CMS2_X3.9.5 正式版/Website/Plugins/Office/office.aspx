<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="office.aspx.cs" Inherits="ZoomLaCMS.Plugins.Office.office" MasterPageFile="~/Office/OAMain.master"%>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-bordered table-striped">
        <tr>
            <td>
                <div>
                    <asp:DropDownList runat="server" ID="Head_DP" DataValueField="WordPath" DataTextField="ModelName" CssClass="form-control pull-left w12rem_lg" onchange="AddRedHead();"></asp:DropDownList>
                    <asp:DropDownList runat="server" ID="Sign_DP" DataTextField="SignName" DataValueField="ID" CssClass="form-control pull-left w12rem_lg" onchange="AddSign();" Enabled="false"></asp:DropDownList>
...
<script>
    ...
    function AddRedHead() {
        ...
        if (url == "") return;
        if (url.indexOf("-") > 0) {
            url = "<%=ZoomLa.Components.SiteConfig.SiteInfo.SiteUrl%>/Plugins/Office/OfficeAction.ashx?guid=" + url + "&action=db_getword";
        }
        else {
            url = WordPathDeal(url);//旧版加载word路径
        }
        document.all.WebOffice1.SetFieldValue("mark_1", "", "::ADDMARK::");			// 添加书签
