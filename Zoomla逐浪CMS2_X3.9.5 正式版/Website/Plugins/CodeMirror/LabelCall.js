...
function GetCustom(obj) {
    var stlp = '<div outtype="@LabelType" code="@LabelName" onclick="cit(this)" class="list-group-item spanfixdivchechk text-left" draggable="true"><a onclick=\'opentitle(\"LabelSql.aspx?LabelName=@LabelN2\",\"修改标签\");\' href="javascript:;" title="修改标签"><span class="zi zi_squareCorrect"></span></a><span outtype="@LabelType" code="@LabelName">@LabelName</span></div>';
