...
<div class="container ZfontC_word" id="editorPage" onselect="return false;">
	<div class="contaimer">
	<div class="row">
        <div class="card ZfontC_tool col-12 col-md-3">
                <div class="card-header"><i class="zi zi_inbox"></i> 笔触</div>
                <div class="card-body btns">
                    <ul class="list-unstyled">
                        <li data-style="1" class="pen_style active"><i class="zi zi_paintbrush"></i> 圆润</li>
                        <li data-style="2" class="pen_style"><i class="zi zi_paintbrush"></i> 毛笔</li>
                        <li data-style="4" class="pen_style"><i class="zi zi_paintbrush"></i> 喷溅</li>
                        <li data-style="0" class="pen_style"><i class="zi zi_pencilalt"></i> 粉笔</li> 
                        <li data-style="3" class="pen_style"><i class="zi zi_pencilalt"></i> 蜡笔</li>
                    </ul>
                    <div class="size">
                ...
                <div runat="server" id="normal_wrap" class="text-center">
                    ...
                    <div class="text-center" style="margin-top: 50px;">
                        <a class="btn btn-lg btn-success" href="http://v.ziti163.com" target="_blank">
                            <i class="zi zi_flag zi_2x pull-left"></i>点击访问在线<br>
                            字库制作程序</a>
                    </div>
                </div>
            </div>
...
<script>
    ...
    editor.toggle = function (btn) {
        ...
        if (editor.bkfont) {
            $(btn).html('<i class="zi zi_eye"></i>');
            $wrap.hide();
            $(".hbword").show();
        }
        else {
            $(btn).html('<i class="zi zi_eyeslash"></i>');
            $wrap.show();
            $(".hbword").hide();
        }
    }
