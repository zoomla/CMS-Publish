...
<div class="container">
<h1><i class="zi zi_paintbrush"></i> 自由的字库创作之旅</h1>
...
<a href="wordlist.aspx?id=<%#Eval("ID") %>" class="btn btn-info"><i class="zi zi_pencilalt"></i> 继续书写</a>
</div>
</div>
...
<a href="create.aspx" class="btn btn-danger btn-lg" style="width:30%;"><i class="zi zi_edit"></i> 创建字体</a>
</div>
</asp:Content>
