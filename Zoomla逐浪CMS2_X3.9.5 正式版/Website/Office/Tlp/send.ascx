        ...
        <td colspan="2">
			<div class="input-group mb-3">
			  <div class="input-group-prepend">
				<span class="mr-1 table_red" id="basic-addon1">编号：</span>
			  </div>
			  <asp:TextBox runat="server" ID="No_T" disabled="disabled" CssClass="form-control max20rem" />
			  <asp:DropDownList CssClass="form-control max20rem" runat="server" ID="bhxx"></asp:DropDownList>
			</div>
			
			<div class="input-group mb-3">
			<div class="input-group-prepend">
				<span class="mr-1 table_red" id="basic-addon1">号</span>
			  </div>
		   <div class="input-group-prepend">
			...
			<div class="input-group mb-3">
			  <div class="input-group-prepend">
				<span class="mr-1 table_red" id="basic-addon1">等级</span>
			  </div>
			...
			<div class="input-group mb-3">
			  <div class="input-group-prepend">
				<span class="mr-1 table_red" id="basic-addon1">密级</span>
			  </div>
