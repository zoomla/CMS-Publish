...
<div class="container" ng-app="APP" ng-controller="ZLCtrl">
    <div class="class_box">
        <div class="sort_box">
            <button type="button" class="btn btn-default" title="上移" ng-click="up('province');"><i class="zi zi_arrowUp" zico="指上长箭头"></i></button>
            <button type="button" class="btn btn-default" title="下移" ng-click="down('province');"><i class="zi zi_arrowDown" zico="指下长箭头"></i></button>
            <button type="button" class="btn btn-default" title="删除" ng-click="del('province');"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i></button>
        </div>
    ...
    <div class="class_box">
        <div class="sort_box">
            <button type="button" class="btn btn-default" title="上移" ng-click="up('city');"><i class="zi zi_arrowUp" zico="指上长箭头"></i></button>
            <button type="button" class="btn btn-default" title="下移" ng-click="down('city');"><i class="zi zi_arrowDown" zico="指下长箭头"></i></button>
            <button type="button" class="btn btn-default" title="删除" ng-click="del('city');"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i></button>
        </div>
    ...
    <div class="class_box">
        <div class="sort_box">
            <button type="button" class="btn btn-default" title="上移" ng-click="up('county');"><i class="zi zi_arrowUp" zico="指上长箭头"></i></button>
            <button type="button" class="btn btn-default" title="下移" ng-click="down('county');"><i class="zi zi_arrowDown" zico="指下长箭头"></i></button>
            <button type="button" class="btn btn-default" title="删除" ng-click="del('county');"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i></button>
        </div>
    ...
    <div class="mb-1 text-center">
        ...
        <div class="mb-1">
            ...
            <input type="button" class="btn btn-outline-info" ng-click="save();" value="保存至数据文件"/>
        </div>
    </div>
