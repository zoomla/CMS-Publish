...
var addTlp = "<li><table class='table table-bordered'>"
        + "<tr><td rowspan='2' class='r_green_mid min'>" + guestName + "<span class='num'>@num</span></td><td><input type='text' class='form-control text_300 required' name='name_t_@num' placeholder='姓名' /><span class='btn btn-default zi zi_minus margin_l5' onclick='RemoveUser(this);'></span></td></tr>"
