...
**/
/*
转换前的时间：2016-09-10 09:20:00  转换后：1 year ago
	<script type="text/javascript">
		timeago().render(document.querySelectorAll('.need_to_be_rendered1'));
		timeago().render(document.querySelectorAll('.need_to_be_rendered2'), 'zh_CN');
		var datetime = new Date();
		timeago().render(document.querySelectorAll('.need_to_be_rendered3'), 'zh_CN');
	</script>
*/
/* jshint expr: true */
