...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="container">
        <div class="panel panel-primary">
          <div class="panel-heading"><span class="zi zi_plane"></span><span class="margin_l5">商品信息</span></div>
  ...
  <%--  <div><strong>保险数量:</strong><asp:TextBox runat="server" ID="Safenum_T" CssClass="form-control" /></div>--%>
    <div class="panel panel-primary">
        <div class="panel-heading"><span class="zi zi_user"></span><span class="margin_l5">客人信息</span></div>
        <div class="panel-body">
            <ul id="user_ul">
        <li>
            <table class='table table-bordered'>
