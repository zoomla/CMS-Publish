...
<div class="card">
  <div class="card-header"><i class="zi zi_exclamationCircle" aria-hidden="true"></i> 错误请求-原因可能是： </div>
  <div class="card-body text-center">
	<h5 class="card-title"></h5>
	<p class="card-text"><asp:Literal ID="LtrSuccessMessage" runat="server"></asp:Literal></p>
	<div class="card-text"><asp:HyperLink ID="LnkReturnUrl" runat="server" class="btn btn-info"><i class="zi zi_arrowLeft"></i> <-返回上一页 </asp:HyperLink></div>
</div>
</div>
</div>
