...
<li class="nav-item"><a href="#tabs1" class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">PWA移动参数</a></li>
</ul>
...
<div class="tab-pane active" id="tabs0">
  <table class="table table-bordered table-hover sys_table">
	...
	<th scope="row">后台名称</th>
	  <td>
          <div class="input-group">
              <asp:TextBox ID="LogoPlatName_T" runat="server" placeholder="初始值" class="form-control max20rem" />
              <div class="input-group-append">
	...
	<th scope="row">标签引用</th>
	  <td><div class="input-group text_405">
		  <asp:TextBox runat="server" ID="QuoteLabel_T" class="form-control" Text="{$PWAMainfirst/}"/>
			<div class="input-group-append">
			<span class="btn btn-info " id="QuoteLabel_Btn"><i class="zi zi_copy" aria-hidden="true"></i></span>
		  </div>
	  </div>
	  </td>
	</tr>
