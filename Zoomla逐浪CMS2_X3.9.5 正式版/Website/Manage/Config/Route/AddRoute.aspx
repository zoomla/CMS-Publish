    ...
    <table class="table table-bordered">
        <tr>
          ...
          <td><asp:DropDownList runat="server" ID="SType_DP" CssClass="form-control text_300">
              <asp:ListItem Value="1">CMS_MVC站点路由</asp:ListItem>
        ...
        <tr>
          <td>指向</td>
          <td>
              <asp:TextBox runat="server" ID="Url_T"  CssClass="form-control text_300" data-enter="2" />
              <div class="rd_green">指向页面:/Ask/Default  (/{area}/{controller}/{action})</div>
           <%-- <div class="rd_green">指向目录:/Ask/Bar/*.aspx</div>
            <div class="rd_green">指向页面:/Class_1/Default.aspx</div>--%>
          </td>
        </tr>
        <tr runat="server" visible="false"><td>关联用户</td><td>
            <asp:TextBox runat="server" ID="UserID_T" CssClass="form-control text_300" /> <button type="button" onclick="user.sel()" class="btn btn-primary">选择用户</button>
