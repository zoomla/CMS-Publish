...
<div id="template" runat="server" class="template table-responsive-md">
                        ...
                        <li>
                            <div class="Template_box">
                                ...
                                <div>
                                    ...
                                    <span class="cdate" title="创建时间"><%#Eval("CDate","{0:yyyy/M/d HH:mm}") %><a class="temp_pre" href='/design/h5/preview.aspx?id=<%#Eval("Guid") %>' title="浏览场景" target="_blank"><i class="zi zi_globe"></i></a></span>
                                </div>
                                ...
                                <span <%=Status ==-1 ? "hidden":"" %>>
                                    <ul class="list_unstyled">
                                        ...
                                        <li class="temp_del">
                                            <a class="precode" href="javascript:;" data-guid='<%#Eval("Guid") %>' target="_blank"><i class="zi zi_qrcode"></i></a>
                                        </li>
                                        <li class="temp_del">
                                            <asp:LinkButton runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="del" OnClientClick="return confirm('你确定要删除吗');"><i class="zi zi_trash-alt"></i></asp:LinkButton>
                                        </li>
                                    </ul>
                                </span>
                                <span <%=Status ==-2 ? "":"hidden" %>>
                                    <ul class="list_unstyled">
                                        ...
                                        <li class="temp_del">
                                            <asp:LinkButton runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="del2" OnClientClick="return confirm('数据删除后不可恢复，确定要删除吗？');"><i class="zi zi_trashalt"></i></asp:LinkButton>
                                        </li>
                                    </ul>
                                </span>
                            </div>
