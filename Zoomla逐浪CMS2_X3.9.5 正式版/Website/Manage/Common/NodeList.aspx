...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    <script>
        ...
        function ShowChild(obj) {
            $obj = $(obj);
            if ($obj.prev().find('span').hasClass('zi_folders')) {
                $obj.next().show();
                $obj.prev().find('span').removeClass('zi_folders').addClass('zi_folderOpen');
            } else {
                $obj.next().hide();
                $obj.prev().find('span').removeClass('zi_folderOpen').addClass('zi_folders');
            }
        }
    </script>
</asp:Content>
