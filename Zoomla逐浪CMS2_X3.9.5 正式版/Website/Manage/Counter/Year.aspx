        ...
        <div class="col-12 col-md-4 col-lg-2 padding0">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><i class="zi zi_calendar"></i> <%:CDate.Year %>年统计</h3>
                </div>
                <ul class="list-group card-body">
                    <asp:Repeater ID="CountRPT" runat="server">
                        <ItemTemplate>
                            <li class="list-group-item"><i class="zi zi_calendar"></i><%#Eval("Month")%>月(<a href="Month.aspx?cdate=<%#GetMonthDate() %>"><span class="zi zi_eye"></span>查看</a>)<span class="badge" title="访问量"><%#Eval("NUM") %></span></li>
                        </ItemTemplate>
                    </asp:Repeater>
                </ul>
            </div>
