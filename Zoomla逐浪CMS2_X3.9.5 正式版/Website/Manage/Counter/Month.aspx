        ...
        <div class="col-12 col-md-4 col-lg-2">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><i class="zi zi_calendar"></i> <%:CDate.Month %>月统计</h3>
                </div>
                <ul class="card-body">
                    <asp:Repeater ID="CountRPT" runat="server">
                        <ItemTemplate>
                            <li class="list-group-item"><i class="zi zi_calendar"></i><%#Eval("DAY")%>日(<%#GetDayOfWeek() %>)<span class="badge" title="访问量"><%#Eval("NUM") %></span></li>
                        </ItemTemplate>
                    </asp:Repeater>
                </ul>
            </div>
