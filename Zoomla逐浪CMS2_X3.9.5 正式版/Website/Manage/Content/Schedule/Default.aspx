<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ZoomLaCMS.Manage.Content.Schedule.Default" MasterPageFile="~/Manage/I/Safe.master" %>
...
<ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a  href="AddSche.aspx?id=<%#Eval("ID") %>"><i class="zi zi_pencil" title="修改"></i></a>
                    ...
                    <a  href="ScheLogList.aspx?TaskID=<%#Eval("ID") %>"><i class="zi zi_filealt"></i>日志</a>
                    <asp:LinkButton runat="server"  CommandName="execNow" CommandArgument='<%#Eval("ID") %>' OnClientClick="return confirm('将强行执行（忽略系统计划和预先规则），是否继续？');"><i class="zi zi_hourglassstart"></i>强制执行</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
<div class="sysBtline">
    ...
    <a href='TaskList.aspx' class="btn btn-outline-info"><i class="zi zi_eye"></i> 查看运行中的任务队列</a>
</div>
</div>
</asp:Content>
