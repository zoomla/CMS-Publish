...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="manage_content">
            ...
            <div class="tab-content">
                    ...
                    <table id="mainTable" class="table table-bordered table_padding0 addcontent_modeltale">
                        <tr>
                            ...
                            <td class="col-sm-11 col-xs-11">
                                ...
                                <button type="button" class="btn btn-info btn-sm" onclick="ShowTitle()"><i class="zi zi_info"></i>标题属性</button>
                                ...
                                <asp:RequiredFieldValidator ID="RFV1" runat="server" ControlToValidate="txtTitle" ErrorMessage="标题不能为空" ForeColor="Red" Display="Dynamic" />
                        ...
                        <tr id="CreateHTML" runat="server">
                            <td class="fd_td_l"><asp:Label ID="Label1" runat="server" Text="生成"></asp:Label></td>
                            <td><asp:CheckBox ID="quickmake" runat="server" Checked="false" Text="是否立即生成" /></td>
                        </tr>
                    </table>
                ...
                <div class="tab-pane fade" id="InfoAttr">
                    <table class="table table-bordered table_padding0">
                        ...
                        <tr>
                            <td class="fd_td_l">
                                <asp:Label ID="gx_time" runat="server" Text="更新时间"></asp:Label></td>
                            <td>
               ...
               <%--         <tr>
                        ...
                        <tr>
                            <td class="fd_td_l">
                                <asp:Label ID="hits_txt" runat="server" Text="点击统计"></asp:Label></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="IsComm_Radio" runat="server" CssClass="pull-left" RepeatColumns="2">
                                    <asp:ListItem Value="1" Selected="True" Text="是"></asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="Makepdf" runat="server" Text="启用" /></td>
                        </tr>
                    </table>
                ...
                <div class="tab-pane fade" id="Process">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="EliteLevel" runat="server" Text="推荐" /></td>
                        </tr>
                        <tr id="contentsk" runat="server">
                            <td class="fd_td_l"><asp:Label ID="zht_txt" runat="server" Text="状态"></asp:Label></td>
                            <td><asp:RadioButtonList ID="ddlFlow" runat="server" RepeatColumns="5"></asp:RadioButtonList></td>
                        </tr>
                    </table>
                </div>
        ...
        <div id="pushcon_div" class="alert alert-info">
            <div>保存时自动推送<a href="javascript:$('#pushcon_div').hide();;" title="隐藏"><span class="zi zi_expandarrowsalt"></span></a></div>
