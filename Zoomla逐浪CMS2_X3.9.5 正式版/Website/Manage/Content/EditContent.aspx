...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="Content">
    <div class="manage_content">
                    ...
                    <table class="table table-bordered table_padding0 addcontent_modeltale">
                        <tr>
                            ...
                            <td class="col-sm-11 col-xs-11">
                                ...
                                <a href="javascript:;" id="Button3" onclick="ShowTitle()" class="btn btn-info btn-sm"><i class="zi zi_info" zico="信息表示"></i>标题属性</a>
                                <button type="button" class="btn btn-info btn-sm" onclick="ShowContentList()"><i class="zi zi_link" zico="链接标识"></i>关联内容</button>
                                <button type="button" class="btn btn-info btn-sm" onclick="ShowSys();"><i class="zi zi_list" zico="列表"></i></button>
                ...
                <div class="tab-pane fade" id="InfoAttr">
                    <table class="table table-bordered table_padding0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtInputer" CssClass="form-control text_md" runat="server" disabled="disabled"></asp:TextBox></td>
                        </tr>
                        <tr>
                        ...
                        <tr id="outpdf">
                            ...
                            <td>
                                <asp:LinkButton runat="server" ID="downPdfHref" ToolTip="点击下载" OnClick="downPdfBtn_Click" Visible="false" CssClass="btn btn-xs btn-info"><i class="zi zi_download" zico="下载"></i></asp:LinkButton>
                                <asp:LinkButton runat="server" ID="delPdfHref" ToolTip="删除" OnClick="delPdfBtn_Click" OnClientClick="return confirm('确定要删除吗!')" Visible="false" CssClass="btn btn-xs btn-info"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i></asp:LinkButton></td>
                        </tr>
                        <tr id="outword">
                            <td class="fd_td_l">
                            ...
                            <td>
                                <asp:LinkButton runat="server" ID="downWordHref" ToolTip="点击下载" OnClick="downWordBtn_Click" Visible="false" CssClass="btn btn-xs btn-info"><i class="zi zi_download" zico="下载"></i></i></asp:LinkButton>
                                <asp:LinkButton runat="server" ID="delWordHref" ToolTip="删除" OnClick="delWordBtn_Click" OnClientClick="return confirm('确定要删除吗!')" Visible="false" CssClass="btn btn-xs btn-info"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i></asp:LinkButton></td>
                        </tr>
                    </table>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0);" onclick="crhelper.add()" id="cradd_a" class="btn btn-primary disabled"><i class="zi zi_plus" zico="加号黑"></i>添加授权</a>
                                <a href="javascript:void(0);" onclick="crhelper.del()" id="crdel_a" class="btn btn-danger disabled"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i></i>暂停授权</a>
                                <a href="javascript:void(0);" onclick="crhelper.readd()" id="crreadd_a" class="btn btn-info disabled"><i class="zi zi_redoalt"></i>重新授权</a>
                            </td>
                        </tr>
                    </table>
        ...
        <div class="Conent_fix">
            ...
            <a href="javascript:;" id="toTop" onclick="Control.Scroll.ToTop();"><i class="zi zi_upload" zico="上传黑"></i>Top</a>
        ...
        <div id="pushcon_div" class="alert alert-info">
            <div>保存时自动推送<a href="javascript:$('#pushcon_div').hide();;" title='隐藏'><span class="zi zi_expandarrowsalt" zico="移动箭头"></span></a></div>
