...
<%=Call.SetBread(new Bread[] {
	...
	new Bread() {url="", text="批量添加内容到专题",addon= "" }}
	)
%>
...
<div class="row sysRow list_choice table-responsive-md">
    <table class="table table-striped table-bordered table-hover">
        <tr align="center">
            <th colspan="2" class="text-center">批量添加内容到专题</th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="bqright">
                ...
                <br />
                <br />
                <input id="Button2" onclick="SelectAll()" type="button" class="btn btn-outline-info" style="width: 137px;" value="  选定所有专题  " />
                <input id="Button3" onclick="UnSelectAll()" type="button" class="btn btn-outline-danger" style="width: 146px;" value="取消选定所有专题" />
            </td>
        </tr>
        <tr>
