              ...
              <div class="panel-body">
                  <table class="table table-bordered">
                      ...
                      <td class="td_m">来源视频:</td><td>
                       ...
                       <tbody>
                          <tr><td colspan="2" class="titletd"><i class="zi zi_tag"></i>视频合并(用于加入广告等)</td></tr>
                          <tr><td>选项:</td><td>
                      ...
                      <tbody>
                          <tr><td colspan="2" class="titletd"><i class="zi zi_tag"></i>视频水印</td></tr>
                          <tr><td>水印图片:</td><td>
                      ...
                      <tbody>
                            <tr><td colspan="2" class="titletd"><i class="zi zi_tag"></i>视频截图</td></tr>
                           <tr><td>截图时间</td><td>
                      ...
                      <tbody>
                          <tr><td colspan="2" class="titletd"><i class="zi zi_tag"></i>移除视频</td></tr>
                          <tr><td>选项:</td><td>
