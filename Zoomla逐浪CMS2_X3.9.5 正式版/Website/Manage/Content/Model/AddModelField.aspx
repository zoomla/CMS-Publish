...
<tbody id="DivTextType" runat="server" class="mfield_body">
    ...
    <tr><th><strong>扩展选项：</strong></th><td>
        ...
        <asp:CheckBox runat="server" ID="Text_SelIcon_Chk" Text="zio图标" /></td></tr>
</tbody>
<!--  多行文本(不支持Html)-->
...
<tr>
	<td></td><td>
		<asp:Button ID="Save_Btn" runat="server" Text="添加字段" CssClass="btn btn-info" OnClientClick="return mfield.check()" OnClick="Save_Btn_Click" />
