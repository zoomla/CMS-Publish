<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContentShow.aspx.cs" Inherits="ZoomLaCMS.Manage.Content.ContentShow"  MasterPageFile="~/Manage/I/Index.master"%>
    ...
    <div class="list_choice">
        <table class="table table-striped table-bordered sys_table">
            <tbody>
                ...
                <tr><th>所属模型</th><td><asp:Label runat="server" ID="ModelName_L"></asp:Label></td></tr>
                <tr><th>内容ID</th>
