    ...
    <ZL:ExGridView ID="Egv" runat="server" AutoGenerateColumns="False" DataKeyNames="RoomID" PageSize="10" OnPageIndexChanging="Egv_PageIndexChanging" OnRowCommand="Egv_RowCommand" IsHoldState="false" AllowPaging="True" AllowSorting="True" CssClass="table table-striped table-bordered table-hover" EnableTheming="False" EnableModelValidation="True" EmptyDataText="没有内容">
        <Columns>
            ...
            <asp:TemplateField HeaderText="相关操作">
                <ItemTemplate>
                    <a href="ClassShow.aspx?cid=<%#Eval("RoomID") %>" title="预览"><span class="zi zi_eye"></span></a>
                    <a href="AddClassRoom.aspx?menu=edit&id=<%#Eval("RoomID") %>" title="修改"><span class="zi zi_pencilalt"></span></a>
                    <asp:LinkButton ID="LinkButton2" CommandArgument='<%# Eval("RoomID") %>' CommandName="del" OnClientClick="return confirm('是否删除!')" ToolTip="删除" runat="server"><span class="zi zi_trashalt"></span></asp:LinkButton>
                    <a href="StudentList.aspx?cid=<%#Eval("RoomID") %>&stutype=1" class="option_style"><i class="zi zi_child"></i>学生列表</a>
                    <a href="StudentList.aspx?cid=<%#Eval("RoomID") %>&stutype=2" class="option_style"><i class="zi zi_user"></i>教师列表</a>
                    <a href="StudentList.aspx?cid=<%#Eval("RoomID") %>&stutype=3" class="option_style"><i class="zi zi_users"></i>家长列表</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
