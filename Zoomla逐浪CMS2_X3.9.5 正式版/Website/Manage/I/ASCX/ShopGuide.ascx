...
<div class="input-group-append">
    <button class="input-group-text" type="button" onclick="ASCX.Search('<%:CustomerPageAction.customPath2+"Shop/ProductManage.aspx?keyWord=" %>','keyWord');"><i class="zi zi_search"></i></button>
</div>
</div>
<div class="left_ul">
<ul>
