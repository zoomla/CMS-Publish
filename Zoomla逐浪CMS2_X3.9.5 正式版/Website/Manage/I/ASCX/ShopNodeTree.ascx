...
<div class="menu_tit pl-2"><i class="zi zi_forDown"></i> 商品管理</div>
<div id="nodeNav">
...
<div class="input-group-append">
    <button type="button" id="searchBtn" class="input-group-text" onclick="ASCX.Search('<%:CustomerPageAction.customPath2+"Shop/ProductManage.aspx?stype=id_proname&keyWord=" %>','keyWord');"> <i class="zi zi_search"></i></button>
</div>
</div>
<div class="tvNavDiv">
