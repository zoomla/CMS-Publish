...
<li class="pl-0"><p class="menu_tit laybtn below"><i class="zi zi_forDown"></i> <%=Resources.L.舆情管理 %></p>
...
<li class="pl-0"><p class="menu_tit laybtn below"><i class="zi zi_forDown"></i> <%=Resources.L.数据管理 %></p>
<ul id="menu9_10_ul2">
