...
<ZL:ExGridView ID="EGV" RowStyle-HorizontalAlign="Center" DataKeyNames="CateID" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="10"
	...
	<Columns> 
		...
		<asp:TemplateField HeaderText="操作">         
			<ItemTemplate>
				<asp:LinkButton runat="server" CommandName="Edit" CommandArgument='<%# Eval("CateID") %>'><i class="zi zi_squareCorrect" title="修改"></i></asp:LinkButton>
				<asp:LinkButton runat="server" CommandName="DicList" CommandArgument='<%# Eval("CateID") %>'><i class="zi zi_listul" title="列表"></i>一级选项列表</asp:LinkButton>
			</ItemTemplate>
			<ItemStyle  CssClass="tdbg" HorizontalAlign="Center" />
		</asp:TemplateField>
	</Columns>              
