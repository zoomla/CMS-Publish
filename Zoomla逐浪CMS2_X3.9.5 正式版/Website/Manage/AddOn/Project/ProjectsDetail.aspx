<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectsDetail.aspx.cs" Inherits="ZoomLaCMS.Manage.AddOn.Project.ProjectsDetail" MasterPageFile="~/Manage/I/Index.master" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="Server">
	<%=Call.SetBread(new Bread[] {
        ...
        new Bread() {url="", text="查看项目",addon="" }}
		)
    %>
    <div class="list_choice">
        <ul class="nav nav-tabs">
            <li class="nav-item"><a class="nav-link active" href="#tabs0" data-toggle="tab">项目进度</a></li>
            <li class="nav-item"><a class="nav-link" href="#tabs1" data-toggle="tab">项目详情</a></li>
            <li class="nav-item"><a class="nav-link" href="#tabs2" data-toggle="tab">交流互动</a></li>
        </ul> 
    ...
    <div class="tab-content panel-body padding0">
            ...
            <div>
                    ...
                    <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" OnRowDataBound="EGV_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LkBtnEdit" runat="server" CommandArgument='<%#Eval("ID")%>' CommandName="Edit" CssClass="option_style"><i class="zi zi_squareCorrect" title="编辑"></i></asp:LinkButton>
                ...
                <div>
                    <asp:Button ID="btnDeleteAll" runat="server" Style="width: 110px;" OnClientClick="if(!IsSelectedId()){alert('请选择删除项');return false;}else{return confirm('你确定要将所有选择项删除吗？')}"
                        Text="批量删除" class="C_input" OnClick="btnDeleteAll_Click" CssClass="btn btn-primary" Visible="false" />
                    <asp:Button ID="Button2" runat="server" Text="导入流程" CssClass="btn btn-outline-info" OnClientClick="OpenProcess();return false;" />
                </div>
            </div>
        </div>
        <div class="tab-pane" id="tabs1">
            <table border="0" cellpadding="2" cellspacing="1" class="border" width="100%">
                ...
                <tr>
                    <td></td>
                    <td> <asp:Button ID="Button1" runat="server" Text="修改信息" CssClass="btn btn-outline-info" OnClick="Button1_Click" /></td>
                </tr>
            </table>
        </div>
        <div class="tab-pane" id="tabs2">
            ...
            <table>
                <tr>
                    <td>
                        <asp:Button ID="BtnDelComment" runat="server" CssClass="btn btn-outline-info" OnClientClick="return confirm('你确定删除吗？')" Text="批量删除" class="C_input" OnClick="BtnDelComment_Click" />
