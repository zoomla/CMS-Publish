<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Addproject.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.Addproject" MasterPageFile="~/Manage/I/index.master"%>
...
<table width="100%" border="0" cellpadding="2" cellspacing="0" class="border" id="TABLE1">
                ...
                <td align="right">
					...
					<div class="input-group mb-3">
					  ...
					  <div class="input-group-append">
						<asp:Button ID="BtnSearch" class="btn btn-outline-secondary" runat="server" Text="查找" OnClick="BtnSearch_Click" />
					  </div>
					</div>
                ...
                <td valign="top" colspan="2">
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                        <tr class="tdbgleft">
                            ...
                            <td align="center"><strong>礼品图片</strong></td>
                            <td align="center"><strong>礼品名称</strong></td>
                            <td align="center"><strong>礼品零售价</strong></td>
                        </tr>
                        <ZL:ExRepeater ID="Pagetable" runat="server" PagePre="<tr><td colspan='5' class='text-center'><input type='checkbox' id='CheckAll' />" PageEnd="</td></tr>">
                            <ItemTemplate>
                                <tr class="tdbg">
                                    ...
                                    <td align="center"><%#Eval("Proname") %><input type="hidden" id="Pronames<%#Eval("ID") %>" value="<%#Eval("Proname") %>" />
                                    </td>
            ...
            <tr>
                <td colspan="2" align="center">
                    <asp:Button ID="Button1" class="btn btn-outline-info m-2" runat="server" Text="添加礼品" OnClientClick="GetCheckvalue();return false;" />
                    <asp:Button ID="Button2" class="btn btn-outline-danger m-2" runat="server" Text="取消添加" OnClientClick="window.close();return false;" /></td>
            </tr>
        </table>
</asp:Content>
