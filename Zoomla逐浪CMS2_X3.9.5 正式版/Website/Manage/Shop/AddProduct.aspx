                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:;" title="捆绑销售" id="bind_btn" onclick="showbind();" class="btn btn-default"><i class="zi zi_link"></i></a>
                            <a href="javascript:;" title="取消捆绑" id="cbind_btn" onclick="clearbind();" class="btn btn-default"><i class="zi zi_minus"></i></a>
                                ...
                                <tbody id="child_tb">
                                    <tr class="childtr">
                                        <td>
                                            ...
                                            <a href="javascript:;" class="btn btn-default addchild"><i class="zi zi_plus"></i></a>
                                            <a href="javascript:;" class="btn btn-default delchild"><i class="zi zi_minus"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <td>
                            <div class="input-group text_300">
                                ...
                                <span class="input-group-btn">
                                    <input type="button" value="选择" class="btn btn-info" onclick="producer.sel();" />
                                </span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="input-group text_300">
                                ...
                                <span class="input-group-btn">
                                    <input type="button" value="选择" class="btn btn-info" onclick="trademark.sel();" />
                                </span>
                            </div>
                        </td>
                    </tr>
...
<div class="text-center Conent_fix">
    ...
    <a href="ProductManage.aspx?<%:"NodeID="+NodeID+"&StoreID="+UserShop_DP.SelectedValue%>" class="btn btn-primary">返回列表<i class="zi zi_arrowUp"></i></a>
</div>
