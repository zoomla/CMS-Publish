...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div id="BreadDiv" class="container-fluid mysite">
       ...
       <div id="site_main">
        ...
        <div>
            <div class="top_opbar">
                <a href="<%="SiteFileManage.aspx?siteName="+Server.UrlEncode(Request.QueryString["siteName"])+"&index="+Server.HtmlEncode(Request.QueryString["index"]) %>"><i class="zi zi_home" style="font-size:16px; margin-right:2px;"></i>返回根目录</a>
                <a href="javascript:history.go(-1);"><i class="zi zi_circleLeftBold" style="font-size:16px; margin-right:2px;"></i>返回上一目录</a>
                    ...
                    <ItemTemplate>
                        <tr class="tdbg"  style="height:30px;text-align:center;" onmouseover="this.className='tdbgmouseover';" onmouseout="this.className='tdbg';" >
                            ...
                            <input type='checkbox' name='chk' onclick="this.value=$(this).parent().parent().find('[name=path]').val()">
                             <%# System.Convert.ToInt32(Eval("type")) == 1 ? "<i class='zi zi_folders'></i><a href='SiteFileManage.aspx?siteName="
      ...
      <ul>
        <li id="open"><i class="zi zi_folderOpen"></i> 打开文件夹</li>
        <li id="refresh"<i class="zi zi_replyall" zico="回复组"></i> 重命名</li>
        <li id="delete"><i class="zi zi_trash"></i> 删除</li>
      </ul>
    </div>
            <script type="text/javascript">
                var oldstr;
                        ...
                        bindings:
                        {
                            ...
                            'rename': function (t) {
                                ...
                                newstr = "<input type='text' name='renameT' onkeypress='if(event.keyCode==13){renameF(this);}'/>" +
                                    "<a href='javascript:;' onclick='renameF(this);' ><i class='zi zi_checksquare'></i></a> " +
                                    "<a href='javascript:;' style='margin-left:2px;' onclick='cancelF(this);' name='cancelA'><i class='zi zi_times'></i></a>";
