...
<asp:Content runat="server" ContentPlaceHolderID="Content">
  ...
  <span class="input-group-btn">
    ...
    <div class="card" style="float:left;" id="addDiv" runat="server" visible="false">
        <div class="card-header"><h3 class="panel-title">DNS映射</h3></div>
        <div class="card-body">
            <table class="table table-bordered table-hover">
                <tbody>
                    <tr><td style="width: 80px;" >用户名：</td><td>
                        <asp:TextBox runat="server" ID="userNameT" class="form-control max20rem" disabled="disabled"/>
