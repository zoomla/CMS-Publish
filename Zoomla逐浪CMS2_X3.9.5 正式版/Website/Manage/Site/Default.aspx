<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ZoomLaCMS.Manage.Site.Default"   MasterPageFile="~/Manage/I/Index.master"%>
...
<%=Call.SetBread(new Bread[] {
	...
	new Bread() {url="Default.aspx", text="站群管理",addon="" }}
	)
%>
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item" id="tabs0" onclick="ShowTab(false)"><a class="nav-link" href="#tab5" data-toggle="tab">全部站点</a></li>
    ...
    <div id="tab3" class="table-responsive-md">
        <ZL:ExGridView ID="EGV" runat="server" DataSourceID="WSData" AllowPaging="True" RowStyle-CssClass="tdbg" AutoGenerateColumns="False" PageSize="20"
            ...
            <ItemStyle CssClass="site_ico"></ItemStyle>
             ...
             <asp:TemplateField HeaderText="端口" SortExpression="SitePort">
                 <ItemTemplate>
                  ...
                  <ItemStyle HorizontalAlign="Left" />
                 <EditItemTemplate>
                     <asp:TextBox runat="server" ID="EditPort" Text='<%#Eval("SitePort") %>'  class="text-center"/>
                 </EditItemTemplate>
             </asp:TemplateField>
             <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="site_a">
                 ...
                 <EditItemTemplate>
                     <asp:LinkButton ID="Save" runat="server" CommandName="Save" CommandArgument='<%# Container.DisplayIndex+":"+Eval("SiteID") %>'><i class="zi zi_redoalt" zico="重做标识"></i></asp:LinkButton>
                     <asp:LinkButton ID="Cancel" runat="server" CommandName="Cancel" CommandArgument='<%# Container.DisplayIndex %>' ><i class="zi zi_expandarrowsalt"></i></asp:LinkButton>
                 </EditItemTemplate>
             </asp:TemplateField>       
         </Columns>
