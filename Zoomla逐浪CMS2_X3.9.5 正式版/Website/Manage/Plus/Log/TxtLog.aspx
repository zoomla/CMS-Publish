<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TxtLog.aspx.cs" Inherits="ZoomLaCMS.Manage.Plus.TxtLog"MasterPageFile="~/Manage/I/Index.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div id="egvdiv"  runat="server">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Name") %>' CommandName="view"><i class="zi zi_eye" title="查看"></i></asp:LinkButton>
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Name") %>' CommandName="del2" OnClientClick="return confirm('确定删除?');"><i class="zi zi_trashalt" title="删除"></i></asp:LinkButton>
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Name") %>' CommandName="down"><i class="zi zi_download" title="下载"></i>下载</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
    ...
    <div id="viewdiv" runat="server" visible="false">
        <div class="top_opbar pl-2">
            <a href="<%#Request.RawUrl %>" class="btn btn-outline-info">返回列表</a>
            <asp:Button runat="server" ID="DownLog_Btn" Text="下载日志" CssClass="btn btn-outline-info" OnClick="DownLog_Btn_Click" />
