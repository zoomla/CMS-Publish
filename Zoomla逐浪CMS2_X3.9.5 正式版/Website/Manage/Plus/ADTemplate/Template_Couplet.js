...
function CoupletZoneAD_WriteAD(ShowAD,DivName,Left){
  ...
  document.write("<div id='" + DivName + "' style='position:absolute; z-index:1; max-width:" + this.ZoneWidth + "px;height:" + this.ZoneHeight + "px;left:" + Left + "px;top:" + this.Top + "px'>" + AD_Content(ShowAD) + "");
  if(this.ShowCloseAD){
