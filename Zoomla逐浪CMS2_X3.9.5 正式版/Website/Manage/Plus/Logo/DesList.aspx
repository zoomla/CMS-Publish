    ...
    <div id="BreadDiv" class="container-fluid mysite">
        <div class="row">
            <ol id="BreadNav" class="breadcrumb navbar-fixed-top w-100">
                ...
                <li class="breadcrumb-item"><a href='<%=Request.RawUrl %>'>用户设计</a>  [<a href="/Plugins/Third/Logo/" target="_blank"><i class="zi zi_pencilalt"></i> 前往设计</a>]</li>
...
<ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="">
            <ItemTemplate>
<%--                <a href="/Plugins/Third/Logo/Third.aspx?id=<%#Eval("ID") %>&mode=admin" title="预览" target="_blank"><i class="zi zi_eye"></i></a>--%>
                <a href="Design.aspx?ID=<%#Eval("ID") %>"><i class="zi zi_pencilalt"></i></a>
