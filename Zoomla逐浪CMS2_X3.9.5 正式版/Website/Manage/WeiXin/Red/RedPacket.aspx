 ...
 <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a class="option_style" href="RedPacketAdd.aspx?id=<%#Eval("ID") %>&appid=<%#Eval("APPID") %>"><i class="zi zi_pencilalt"></i></a>
                    <a href="RedPacketFlow.aspx?MainID=<%#Eval("ID") %>" class="option_style"><i class="zi zi_list"></i>查看详情</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
