<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleAuthList.aspx.cs" Inherits="ZoomLaCMS.Manage.User.RoleAuthList"  MasterPageFile="~/Manage/I/Index.master" %>
...
<ol id="BreadNav" class="breadcrumb fixed-top">
    ...
    <li class="breadcrumb-item"><a href="<%= CustomerPageAction.customPath2 %>User/AdminManage.aspx">管理员管理</a></li>
    <li class="breadcrumb-item"><a href="RoleManage.aspx">角色管理</a></li>
    <li class="breadcrumb-item">权限管理 [<asp:Label runat="server" ID="RoleName_L"></asp:Label>]</li>
</ol>
<div class="container-fluid pr-0">
<div class="row sysRow list_choice w-100 table-responsive-md">
<div class="w-100" ng-app="app" ng-controller="appCtrl" style="margin-bottom:80px;">
...
<div class="sysBtline">
    ...
    <a href="RoleManage.aspx" class="btn btn-outline-info">返回列表</a>
</div>
</asp:Content>
...
<script type="text/javascript">
    ...
    angular.module("app", []).controller("appCtrl", function ($scope) {
        ...
        $scope.auth.list = [
            { n: "模型", pre: "model", list: [],icon:"zi zi_cubes" },
            ...
            { n: "用户", pre: "user", list: [], icon: "zi zi_user" },
            { n: "扩展", pre: "extend", list: [], icon: "zi zi_desktop" },
            { n: "系统", pre: "system", list: [], icon: "zi zi_tmWindows" },
            { n: "办公", pre: "office", list: [], icon: "zi zi_envelope" },
            { n: "移动", pre: "portable", list: [], icon: "zi zi_coffee" },
            { n: "站群", pre: "sites", list: [], icon: "zi zi_database" },
