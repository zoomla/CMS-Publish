...
<div id="Form_Div" runat="server" class="col-lg-6 offset-lg-3 userform">
  <div class="panel-heading"><h1>申请测试帐号</h1><small class="text-muted">请填写下方申请表单以便官方为您提供周全服务！</small><span class="pull-right"><a href="Login?hasAccount=1" class="hascount"><i class="zi zi_infocircle" zico="信息圆标"></i> 已有帐号</a></span><div class="clearfix"></div></div>
  <div class="">
...
<h1><i class="zi zi_checkcircle" zico="圆打勾"></i> 成功</h1>
<div class="p-5">已经成功提交申请,系统审核后会以电子邮件通知您！</div>
<div><a href="Login?hasAccount=1" class="btn btn-primary" style="color:#fff;"><i class="zi zi_backward" zico="快退"></i> 返回登录</a>
  <a href="/" class="btn btn-info" style="color:#fff;"><i class="zi zi_home" zico="家"></i> 回到首页</a>
</div>
</div>
</div>
</div>
...
//	$("body").addClass("cms2login");
	...
	var showResult = function ($input, css, msg) {
		var okTlp = '<i class="zi zi_check"></i>';
		var errTlp = '<i class="zi zi_expandarrowsalt"></i>';
		var sub = document.getElementById("Submit_B");
		var $tr = $input.closest("tr");
		$tr.find(".zi_check,.zi_expandarrowsalt").remove();
