    ...
    <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a  href="AddComp.aspx?id=<%#Eval("ID") %>"><i class="zi zi_pencilalt" title="修改"></i></a>
                    <a  href="MemberList.aspx?compid=<%#Eval("id") %>"><i class="zi zi_users"></i> 成员</a>
                    <a href="WordTlp.aspx?ID=<%#Eval("ID") %>" ><i class="zi zi_list"></i>报表</a>
