...
(function() {    
    ...
    MarkerTool.CUR_IMG = "//api.map.baidu.com/library/MarkerTool/1.2/src/images/transparent.cur"; //鼠标透明样式，发布时候修改为绝对路径
    MarkerTool.ICON_IMG = "//api.map.baidu.com/library/MarkerTool/1.2/src/images/us_mk_icon.png"; //图标样式，发布时候修改为绝对路径
