...
//免费下载：www.z01.com
//https://github.com/zoomla/ZoomlaFont
var timestamp = 0;
var mouseSpeed = 0;
var isReset = false;
function Point(x, y) {
...
var hwrite =
{
    ...
    ontouchstart: function (e) {
        ...
        var db = ref.db;
        db.moveFlag = true;
        db.pos_start = ref.getTouchPos(e);
    },
    ...
    init: function (id) {
        ...
        ref.db.canvas.ontouchstart = ref.ontouchstart;
        ref.db.canvas.ontouchend = ref.ontouchend;
        ref.db.canvas.ontouchmove = ref.ontouchmove;
    ...
    getTouchPos: function (e) {
        var canvas = hwrite.db.canvas;
        var bound = canvas.getBoundingClientRect();
        var x = e.touches[0].clientX - bound.left;
        var y = e.touches[0].clientY - bound.top;
