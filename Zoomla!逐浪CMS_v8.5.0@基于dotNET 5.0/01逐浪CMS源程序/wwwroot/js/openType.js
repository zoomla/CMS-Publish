...
var openWinMode =
{
    setBlank: function (N) {
        ...
        var ProductUrl = /Product\/ProductUI\/i;
        var NewsUrl = /NewsUI\/i;
        var BaiduUrl = /http:\/\/www\.baidu\.com/i;
        var IsDefault = false;
        if (location.href.toLowerCase() == buildWWW("default").toLowerCase()
