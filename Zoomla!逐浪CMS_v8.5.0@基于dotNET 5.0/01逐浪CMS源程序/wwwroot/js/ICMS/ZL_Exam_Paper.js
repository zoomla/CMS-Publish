...
var litlp = "<li><div class='input-group' style='width:100%'><span class='btn btn-light input-group-addon' style='margin-bottom:5px;'>@op</span><textarea class='ueoption_t' data-id='@op_t' id='@op_t' style='width: 100%; height: 80px; ' value='@val'></textarea></div></li>";
//生成指定数目的选项
