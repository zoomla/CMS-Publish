...
function ShowForWard(id) {
    ...
    //$("#Forward_Btn").click();
    var myModal = new bootstrap.Modal(document.getElementById('forward_div'));
    myModal.show();
}
//话题相关
function ShowDiv(id) {
...
//        title: "<i class=\"zi zi_useralt\"></i> 用户信息<a class=\"close_a float-right\" title=\"关闭\"><i class='zi zi_times'></i></a>",
//        content: function () {
...
//                + "<input type=\"button\" class=\"btn btn-sm btn-outline-info ms-1\"  value=\"AT他\" onclick=\"AddAT('" + datas.UserName + "', '" + datas.UserID + "');\" />"
//                + "</li>"
...
//                //+ "<button type='' onclick=\"$('.uinfo').popover('hide');\"  class='btn btn-danger btn-sm'>关闭</button>";
