...
Dialog.prototype = {
    ShowModal: function () {
        ...
        var header = "<button type='button' class='close' data-dismiss='modal'><span class='zi zi_timescircle'>Close</span></button>@Opion<span class='modal-title'><strong id='title'>@Title</strong></span>";
        var body = "";
        var Opion = "";
        var foot = "";
        switch (this.Type) {
            ...
            case 1:
                ...
                Opion = "<button type='button' id='BigOpion' title='全屏' class='close' style='width:30px;'><i class='zi zi_arrowsalt'></i></button>";
                break;
        }
