                ...
                if (swatches instanceof Array) {
                    ...
                    for (var i = 0; i < swatches.length; i++) {
                        ...
                        if (color.isValid()) {
                            ...
                            var button = $('<div class="btn btn-primary cp-swatch"></div>');
                    ...
                    //不显示透明
                   // elements.swatches.prepend($('<li></li>').append($('<div class="btn btn-primary cp-swatch"></div>').append($('<span></span>').css('background-color', 'rgb(0,0,0,0)'))));
                }
