...
info.editTlp += '<td style="width:150px;"><a href="javascript:;" class="btn btn-outline-secondary" onclick="info.upRow(this)"><i class="zi zi_arrowUp"></i></a> <a href="javascript:;" class="btn btn-outline-secondary" onclick="info.downRow(this)"><i class="zi zi_arrowDown"></i></a> <a class="btn btn-outline-secondary" title="移除" onclick="info.delRow(this);"><i class="zi zi_times"></i></a></td></tr>';
