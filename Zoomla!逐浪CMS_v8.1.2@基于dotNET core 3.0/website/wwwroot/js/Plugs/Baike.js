...
info.editTlp += '<td style="width:150px;"><a href="javascript:;" class="btn btn-primary" onclick="info.upRow(this)"><i class="fa fa-arrow-up"></i></a> <a href="javascript:;" class="btn btn-primary" onclick="info.downRow(this)"><i class="fa fa-arrow-down"></i></a> <a class="btn btn-danger" title="移除" onclick="info.delRow(this);"><i class="zi zi_remove"></i></a></td></tr>';
